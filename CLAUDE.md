...
**Админаас оруулсан контент апп дээр гарахгүй байсныг зассан (2026-08-08).**
Хоёр тусдаа шалтгаан байсан:
1. **Ноорог-анхдагч.** IELTS форм, Сорилын форм (`isPublished`-ыг ОГТ
   илгээдэггүй → entity default `false`), мөн "AI-аар үүсгэх" (үргэлж ноорог)
   гурвуулаа ноорог үүсгэдэг байсан ба апп зөвхөн `isPublished=true` татдаг.
   Одоо гурвуулаа **анхдагчаар нийтэлнэ**; AI цонхонд "Шууд нийтлэх" checkbox
   нэмэгдсэн (тайлбал ноорог + анхааруулга). CSV/JSON импорт ноорог хэвээр.
2. **`category`-гүй контент.** Апп бие даасан quiz-ийг зөвхөн `category`-гаар
   татдаг. Админы **Сорил** хуудас `category` огт бичдэггүй байсан тул тэнд
   үүсгэсэн бүх сорил хаана ч гарах боломжгүй байв (Сорил табын 6 карт нь
   үгийн сангийн тоглоом — админы quiz-ийг уншдаггүй). Одоо тэдгээр нь
   `category: 'soril'` бичдэг болж, Сорил табад **"Шинэ сорилууд"** хэсэг
   нэмэгдэв (`/quiz/:id` runner). Мөн аппд дэлгэцтэй мөртлөө админд оруулах
   газаргүй байсан **`fill` (Нөхөх)** ба **`grammar` (Дүрэм)** таб Дасгал
   хуудсанд нэмэгдсэн (өмнө `/skill/fill`, `/skill/grammar` үүрд хоосон байв).
- ⚠️ **Prod migration `BackfillSorilQuizCategory1787100000000`** — өмнө нь Сорил
  хуудсаар үүсгэсэн бүх мөр `category = NULL` тул зөвхөн шинэ форм засварлаад
  болохгүй (нийтэлсэн ч апп татахгүй). Migration нь `category IS NULL AND
  lesson_id IS NULL` мөрүүдэд `'soril'` онооно. Railway дээр
  **`DB_MIGRATIONS_RUN=true` эсэхийг шалгаж байж deploy хий.** Ажиллаагүй ч
  админ тухайн сорилыг нээгээд хадгалахад category нь нөхөгдөнө (fallback).
- ⚠️ **Дүрэм:** шинэ `category` нэмэх бүрд аппын уншигч талыг нь мөн нэм.
  Одоогийн `category` ↔ дэлгэцийн хүснэгт → `API.md` §5.
- ⚠️ **Boju:** `mobile/app/(tabs)/soril.tsx` хөндөгдсөн (дундын файл).
- ⚠️ **Deploy дараалал:** админы засварууд (нийтлэх анхдагч, `fill`/`grammar`
  таб) Vercel дээр шууд ажиллана; Сорил табын "Шинэ сорилууд" хэсэг нь
  **аппын шинэ bundle** шаардана (OTA эсвэл Expo Go reload). Хооронд нь
  админ `soril` сорил үүсгэвэл хуучин апп дээр гарахгүй.

**Түвшин сонгосон нь нөлөөгүй байсныг зассан (2026-08-09).** Хичээлийн газрын
зураг дээрх арал нээгдэх нь **зөвхөн од**-оор шийдэгддэг байв
(`getLevelUnlocks`), тиймээс "B2" гэж сонгосон хүн ч зөвхөн A1 нээлттэй газрын
зурагт бууж, өөрийн түвшинд хүрэхийн тулд 18 од цуглуулах шаардлагатай байсан
— түвшинг асуугаад дараа нь үл тоох нь огт асуухаас дор. Одоо **зарласан
түвшин хүртэлх бүх арал шууд нээлттэй**; түүнээс дээшх нь одны хаалгаараа
хэвээр. `users.level` хоосон бол зан төлөв хуучинтай яг ижил.
(7 тест: `src/xp/level-unlocks.spec.ts`.)

**Хэлц үг / Унших материал апп дээр гарахгүй байсныг зассан (2026-08-09).**
Дахин "ноорог-анхдагч": админы **Хэлц үг** ба **Унших** формууд
`isPublished: false`-оор үүсгэдэг байсан бөгөөд апп зөвхөн `isPublished=true`
татдаг тул тэнд оруулсан бүх зүйл үл үзэгдэх байв. 2026-08-08-нд Дасгал/Сорил/
IELTS-д зассан яг тэр алдаа — энэ хоёр орхигдсон. Одоо **гарын авлагын форм
нийтэлнэ, багц CSV/JSON импорт ноорог хэвээр** (шалгаад нийтэлнэ) гэсэн дүрэм
бүх хуудсанд нэгдсэн.
- ⚠️ **Өмнө нь оруулсан хэлц үг/унших материал ноорог хэвээр үлдсэн.** Автомат
  backfill ХИЙГЭЭГҮЙ: AI бөглөлт/медиа үүсгэлт мөрийг шинэчилдэг тул "алдаанаас
  болж ноорог" ба "зориуд нийтлээгүй" хоёрыг найдвартай ялгах боломжгүй.
  Админаас **бүгдийг сонгоод → Нийтлэх** дарж нэг удаа зас.

**«Ноорог» төлөв админаас бүрмөсөн хасагдав (2026-08-10).** Дээрх хоёр бичлэг
(08-08 · 08-09) нь нэг л алдааг хуудас тус бүр дээр нөхөж байсан тул **үндсийг
нь тасаллаа: Хадгалах = шууд нийтлэх.** Гарын авлагын форм, **CSV/JSON импорт**,
AI-аар үүсгэх гурвуулан `isPublished: true` бичнэ (Хичээл · Дасгал · Сорил ·
IELTS · Унших · Хэлц · хичээлийн тест) — тиймээс дээрх "багц импорт ноорог
хэвээр" гэсэн дүрэм **хүчингүй**.
- Үлдсэн цорын ганц төлөв нь **нуух** — нийтлэгдсэн зүйлийг устгалгүй аппаас
  түр авах (мөрийн 👁 товч / «Аппаас нуух»). Шошго нь «Ноорог» биш **«Нуугдсан»**.
- ⚠️ **Хуучин ноорог мөрүүд DB-д хэвээр** (backfill хийгээгүй). Хуудас бүрийн
  дээр шар анхааруулга + **«Бүгдийг нийтлэх»** товч гарна. Хичээл/Унших/Хэлц нь
  сервер талаас хуудаслагддаг тул тоо нь тухайн хуудсынх.
- **Дүрэм:** нийтлэх төлөвийн UI-г хуудсанд бичихгүй —
  `admin/src/components/Publish.tsx` (`HiddenBadge` · `VisibilityButton` ·
  `UnpublishedBanner`) ашиглана. Шинэ контентын хуудас нэмэхэд `isPublished`
  checkbox **бүү нэм**.
- Мөн: импортын цонхонд «AI-аар үүсгэх» товч (буулгасан текстээ шууд AI-д өгнө),
  AI үүсгэх явцын % + шат, `lib/errors.ts` → `friendlyError()` ойлгомжтой
  алдааны мэдэгдэл (`ErrorBox` · дундын `JobProgress`). Дэлгэрэнгүй → `ROADMAP.md`.

**AI Buddy НЭЭГДЭВ (2026-08-17).** `AI_BUDDY_ENABLED` анхдагчаар `true` болов
(`.env.example` + guard-ийн тайлбар). Апп `GET /ai/buddy/availability`-г уншдаг
тул **апп шинэчлэх шаардлагагүй** — дараагийн нээлтэд "Тун удахгүй" дэлгэц
жинхэнэ buddy таб болно.
- ⚠️ **Prod дээр гарын авлагын алхам:** Railway-гийн env-д `AI_BUDDY_ENABLED=true`
  гэж **өөрөө нэмнэ**. `.env.example` бол зөвхөн баримт — deploy түүнийг уншдаггүй.
  `ELEVENLABS_API_KEY` / `ANTHROPIC_API_KEY` prod дээр **зөв** эсэхийг мөн шалга.
- ⚠️ **Түлхүүр буруу байхад чимээгүй унадаг.** Локал дээр туршихад буруу
  Anthropic түлхүүртэй turn нь алдаа биш **201** буцааж, "Sorry, I got stuck for
  a second" гэсэн ерөнхий хариу өгсөн (ElevenLabs байхгүй тул `audio_url: null`).
  Өөрөөр хэлбэл эвдэрсэн buddy нь ажиллаж байгаа мэт харагдана — flag-ийг
  асаасны дараа нэг turn биечлэн туршиж, `reply_text` жинхэнэ хариу мөн эсэх,
  `audio_url` дүүрсэн эсэхийг хар. Шалтгаан нь серверийн логт л гарна
  (`LLM failed: 401` / `TTS failed: …`).
- ⚠️ **`PAYMENTS_ENABLED` хаалттай хэвээр** — өөрөөр хэлбэл turn бүрийн зардлыг
  эзэн өөрөө үүрнэ (2026-08-08-ны "хоёуланг хамт асаа" зөвлөмжийг зориудаар
  зөрчсөн). Цорын ганц таг нь Redis `ai:limits:default` дахь багцын limit, үнэгүй
  багцынх хамгийн сул. Олноор нээхийн өмнө үнэгүй багцын өдрийн turn хязгаарыг
  чангал; зардал хэтэрвэл `AI_BUDDY_ENABLED=false` = шууд kill switch.
- Guard нь **fail-closed** хэвээр (яг `'true'` л нээнэ) — үүнийг truthy шалгалт
  болгож сулруулж болохгүй.
...
**Store-ийн бодлогод нийцүүлэх засварууд (2026-08-27).** `docs/`-ийн бодлогын
checklist-ийг бөглөх явцад гарсан бодит цоорхойнуудыг зассан:
- **AI хариуг мэдээлэх (report) нэмэгдэв** — Google Play-ийн Generative AI
  бодлого нь AI үүсгэсэн контентыг апп дотроос мэдээлэх боломжийг ШААРДДАГ,
  тэр нь огт байхгүй байсан. Одоо buddy-гийн хариу бүрийн доор 🏳 товч
  (`BuddyChatSheet` → `MessageBubble`), баталгаажуулах Alert, дараа нь
  `POST /ai/buddy/feedback { rating: 'report' }`. Server нь `safety_events`-д
  `user_report` (severity `high`) мөр үүсгэдэг тул загварын өөрийн flag-тай нэг
  админы audit log-д цугларна. **Migration шаардлагагүй** (`event_type` нь
  чөлөөт varchar).
  - ⚠️ **Дүрэм:** мессежийн `id` нь заавал **серверийн UUID** байх ёстой.
    `chat.tsx` өмнө нь `${Date.now()}a` гэж локал id үүсгэдэг байсныг
    `res.message_id` болгов — эс бөгөөс мэдээлэх товч 404 авна. Локал id-тай
    (алдааны) бөмбөлөг дээр товч **харагдахгүй** (`UUID_RE` шалгалт).
  - ⚠️ **Boju:** `mobile/app/(tabs)/chat.tsx` ба `BuddyChatSheet.tsx`
    хөндөгдсөн (дундын файл). `BuddyChatSheet` одоо `onReport` prop **шаардана**.
- **Support суваг ажилладаг болов** — Тохиргооны "Тусламж/FAQ" ба "Санал хүсэлт"
  хоёр `soon` stub байсныг нийтлэгдсэн support хуудас руу чиглүүлэв
  (`LEGAL_URLS.support`). Холбоо барих хаяг нь **вэб хуудсан дээр** байдаг тул
  аппд давхардуулаагүй — солиход шинэ build хэрэггүй. ("Үнэлгээ өгөх" нь `soon`
  хэвээр — апп store дээр гараагүй тул линк хийвэл мухар болно.)
- **Хувилбарын дугаар** Тохиргоонд гараар бичигдсэн `'1.0.0'` байсныг
  `expo-application`-аас уншдаг болгов (+ build number). Өмнө нь `app.json`
  ахихад мартагдаж, дэмжлэгийн яриа буруу build дээр явах эрсдэлтэй байв.
- **`.env.example`-ээс үхмэл хувьсагч хасав** — `ELEVENLABS_*` (adapter аль
  хэдийн устсан) ба `AI_BUDDY_LOG_RAW_AUDIO` / `AI_BUDDY_AUDIO_RETENTION_DAYS`
  (кодоос **огт уншигддаггүй** атлаа нууцлалын хяналт мэт харагддаг байсан —
  нууцлалын шалгалтад байхгүй хяналтыг байгаа мэт харуулах нь хамгийн муу).
  Түүхий аудио үнэндээ дискэнд **хэзээ ч** бичигддэггүй.
  - ⚠️ **Railway дээр гараар:** `ELEVENLABS_API_KEY`, `ELEVENLABS_MODEL`,
...
шилжилт нь зөвхөн env-ээр явна, тиймээс `.env`-гүй хүн юу ч мэдэхгүй. Gemini TTS
adapter **устгаагүй**, `TTS_PROVIDER=gemini`-ээр шууд буцна.
- **Шинэ `src/common/gemini/gemini-text.ts`** — `dictionary/gemini-text.ts`-ээс
  зөөв (`words.service` → `ai-gateway.service` тойрог импортоос зайлсхийхийн
  тулд). `geminiRetryDelayMs` мөн энд нэгдсэн (өмнө `words.service`-д).
  `system` · `contents` · `model` · `maxAttempts` сонголт нэмэгдсэн.
- **`GEMINI_LLM_MODEL`** нь `GEMINI_MODEL`-ээс **тусдаа**: толь бичигт чанар,
  buddy-д хурд хэрэгтэй. Adapter нь **`thinkingBudget: 0`** (2.5-flash-ийн
  thinking нь JSON contract дээр секунд нэмдэг) ба **retry cap = 2** (дундын
  туслахын 5×30 сек нь turn дээр гамшиг). Хоёуланг нь бүү ав.
- ⚠️ **Azure HD (Dragon) voice `koreacentral`-д БАЙХГҮЙ.** Tyler / Ava /
  Andrew / Emma2 DragonHD дөрвүүлэн `Unsupported voice … 1007`. Сонговол
  synthesis ~3 сек унаж байж fallback руу шилжинэ = turn бүрд 3 сек. Админы
  жагсаалтаас хассан. **`en-US-AvaMultilingualNeural` = 19 viseme, ~1.0 сек.**
- ⚠️ **`buddy.voiceId` нь env-ийг дардаг.** Админы dropdown өмнө нь зөвхөн
  Gemini нэр (`Kore`…) санал болгодог байсан тул үлдэгдэл байвал Azure унаад
  чимээгүй `JennyNeural` руу буудаг байв (turn бүр 2 synthesis, буруу дуу,
  алдаа мэдэгдэхгүй). `AzureTtsAdapter.resolveVoice()` locale угтвараар шүүнэ.
  Prod дээр шалга: `SELECT slug, voice_id FROM ai_buddies WHERE voice_id IS NOT NULL;`
- **Дуут cache түлхүүр** одоо **шийдэгдсэн** voice-оор (өмнө `'default'` тул
  бүх buddy нэг мөр хуваалцаж, env-ийн voice солиход хуучин клип үүрд гардаг).
  `test-voice` нь cache-ийг унших **ба бичихийг** алгасна.
- **Өртөг:** `providers/llm-pricing.ts` шинэ. Хуучин томьёо (`promptTokens *
  0.0008`) нь бодит үнээс **~1000 дахин бага** байсан — `ai_usages`-ийн ХУУЧИН
  мөрүүд алдаатай хэвээр, шинэ нь зөв.
- Migration ШААРДЛАГАГҮЙ; **аппын шинэ bundle ч хэрэггүй** (`TurnResponse`
  гэрээ хөндөгдөөгүй, mobile viseme логик хэвээр).
- ⚠️ **Railway дээр гараар:** `LLM_PROVIDER=gemini` · `GEMINI_LLM_MODEL` ·
  `TTS_PROVIDER=azure` · `AZURE_SPEECH_KEY` · `AZURE_SPEECH_REGION`.
- 10–20 сек latency нь **энэ шилжилтээр засагдаагүй** — тусдаа фаз
  (`SparkXP_AI_Buddy_Latency_Fix_Plan_MN.docx` → P0 telemetry).

**AI Buddy латенси: telemetry + урсгалт хариу (2026-08-28).** Voice turn нь
10–20 сек хүлээлгэдэг байсныг хоёр фазаар авч үзэв.

**Phase 1 — хэмжилт.** `TurnTimer` нь `turn_id` + шат бүрийг тусад нь бичдэг
болов; клиент `t0` (ярихаа болив) илгээж, `t7` (дуу сонсогдов)-г
`POST /ai/buddy/turns/client-latency`-ээр буцаана. p50/p95 → `scripts/buddy-latency.sql`.
- **Baseline (10 бодит turn): E2E 8565 · STT 3242 · LLM 2565 · TTS 1857 ·
  R2 515 · persist 12 мс.**
- ⚠️ Хэмжилтээс өмнөх ХОЁР таамаг **буруу** байсан: R2 upload нь 2.5с биш
  **515мс**, аудионы дараах DB бичилтүүд нь **12мс**. Гол зардал нь гурван
  провайдерын дуудлага. Дараагийн хүн эдгээрийг дахин "optimize" хийх гэж цаг
  бүү үр.

**Phase 2 — урсгал.** `reply_text`-ийг бүтэн JSON ирэхээс өмнө гаргаж аваад
хэсэглэн ярина (`streaming-reply.ts`), Azure TTS цуваа дараалалд, аудио нь
серверийн санах ойгоос шууд үйлчилнэ.
- **Үр дүн: first-audio p50 8565 → 5468 мс (−36%), p95 6469.** Эхний аудио нь
  бүтэн хариунаас p50 **788мс өмнө** эхэлдэг.
- ⚠️ **Гэрээний талбарын дараалал нь АЮУЛГҮЙ БАЙДЛЫН зүйл.** `safety` ба
  `emotion` нь `reply_text`-ээс **өмнө** ирэх ёстой — эс бөгөөс хүүхэд
  шалгагдаагүй өгүүлбэр сонсоно. `buddy-contract.ts`-ийн анхааруулга ба
  `streaming-reply.spec.ts`-ийн дарааллын тестийг үз.
- **Транспорт:** RN-ийн `fetch` хариуг хэсэгчлэн уншиж чаддаггүй (Expo Go,
  SDK 54) тул SSE ажиллахгүй. Оронд нь **клиент turn id-г өөрөө үүсгээд**
  (`streamId`) turn-ийн хүсэлттэй **зэрэг** `GET …/turns/:id/chunk/:i`
  урт-хүлээлт хийнэ. `TurnResponse` гэрээ **хэвээр** — хуучин апп зүгээр л
  streamId илгээхгүй бөгөөд өнөөдрийнхтэй ижил ажиллана.
- R2 upload нь тоглуулалтын урьдчилсан нөхцөл **биш** болов (ард талд кэш
  дүүргэнэ). Barge-in: `POST …/turns/:id/cancel` → LLM урсгал, TTS дараалал,
  аудионы дараалал гурвуулан зогсоно (шалгасан: 53мс дотор).
- ⚠️ **Аудио санах ойд** байдаг (`BuddyTurnStreamService`, TTL 3 мин). Олон
  instance-тай болвол наалдамхай session эсвэл Redis хэрэгтэй болно.

**Үлдсэн (Phase 3 — тусдаа):** STT нь одоо давамгайлсан зардал (p50 2713мс,
first-audio-гийн 50%). `gemini-2.5-flash-lite` = 404, `gemini-flash-latest` =
503. Azure STT нь TTS-тэй ижил түлхүүрээр `ConnectionFailure 1006` өгсөн —
оношлоогүй. **P50 ≤ 3 сек нь STT-г шийдэхгүйгээр боломжгүй.**

**Phase 3 — STT латенси (2026-08-28).** STT нь Phase 2-ын дараа хамгийн том
зардал байсан (p50 2811мс). Загварыг **`gemini-2.5-flash` →
`gemini-3.5-flash-lite`** болгов (`GeminiSttAdapter.DEFAULT_MODEL`).
- **Үр дүн:** STT p50 2811 → **1865мс**; E2E first-audio p50 5468 → **4026мс**.
  Baseline-аас (Phase 1) нийт **8565 → 4026мс (−53%)**.
- ⚠️ **`thinkingConfig`-ийг 2.5 цуврал л хүлээж авна** — шинэ flash-lite
  загварууд хүсэлтийг бүхэлд нь **400**-аар татгалздаг, өөрөөр хэлбэл дуу
  хоолой бүрмөсөн унана. Adapter нь загварын угтвараар шийдээд, 400 дээр нэг
  удаа түүнгүйгээр дахин оролдоно. Загвар солихдоо энэ хоёрыг бүү ав.
- **Задаргаа (Phase 3A):** encode (base64+JSON) **0–1мс**, хариу унших
  **1–5мс**, TTFB **2469–2826мс**. Cold/warm ялгаагүй. Өөрөөр хэлбэл транспорт,
  холболт, буферлэлт дээр **оптимизацлах зүйл алга** — бүхэлдээ провайдерын
  боловсруулалт. Энэ замыг дахин ухаж цаг бүү үр.
- **VAD/endpointing байхгүй** — апп нь дарж-ярих (hold-to-talk), t0 = товч
  суллах агшин. Тиймээс "чимээгүйг хүлээх" саатал огт байхгүй; Phase 3B-д
  оптимизацлах зүйл олдсонгүй.
- **Нарийвчлал:** WER 0.02 (2.5-flash-тэй ижил). Сурагчийн алдаа хадгалагдана
  ("we was", "very like", "don't know … very good"). Prompt-ыг чангатгах нь
  ялгаа өгөөгүй тул хэвээр.

**Azure STT — ЗОРИУДААР АВААГҮЙ (2026-08-28).** Хурдан ч энэ нөөц дээр хоёр
хаалт бий, тоогоор баталсан:
- `1006`-ийн шалтгаан: **зөвхөн SDK-гийн WebSocket зам**. Token endpoint 200,
  STT REST endpoint 200 — эрх, бүс, түлхүүр бүгд зөв. Node 26-гийн дотоод
  WebSocket (HTTP/2) сэжигтэй. REST зам бүрэн ажиллана.
- **REST short-audio нь зөвхөн WAV** — m4a/mp3-д `RecognitionStatus: Success`
  буцаагаад **DisplayText хоосон** өгнө (чимээгүй бүтэлгүйтэл). Апп нь m4a бичдэг.
- **Fast Transcription API** (`speechtotext/transcriptions:transcribe`) m4a-г
  шууд иднэ, p50 **412мс** — тухайн үед **2 хүсэлтийн дараа 429** авч, cold
  start **11 секунд** гэж тэмдэглэсэн. ⚠️ **Энэ хоёр тоог Phase 5A няцаасан**
  (доор үз): жинхэнэ хаалт нь F0 багцын **20 хүсэлт / 60 сек**.
- Авах бол: Azure дээр quota нэмэгдүүлэх → Fast Transcription. Quota-гүйгээр бүү
  ор.

**Phase 4 — Azure TTS холболтыг дахин ашиглах (2026-08-28).** Зорилт нь
STT→first-speakable завсрыг багасгах байсан; хэмжилт LLM талд бараг юу ч
байхгүйг харуулж, харин **TTS-ийн холболт үүсгэлт** дээр том алдагдал илрэв.
- **`AzureTtsAdapter` одоо synthesizer-ийг pool-д хадгална.** `SpeechSynthesizer`
  бүр өөрийн WebSocket нээдэг ба урсгалт turn нь тэр handshake-ийг **хэсэг
  тутамд** төлж байв. Хэмжилт: эхний аудио хүртэл **p50 799мс → 159мс**
  (тусгаарласан), production-д `tts_first_chunk_provider` **849 → 298мс**.
- **E2E first-audio p50 4026 → 3583мс** (p90 5551→4896, p95 5671→5211).
- ⚠️ **Нэг instance дээр зэрэг хоёр синтез явуулж БОЛОХГҮЙ** — `synthesizing`
  ба `visemeReceived` нь instance-ийн талбар тул хоёр turn-ийн viseme
  хольцолдоно. Тиймээс pool: ашиглах хугацаанд жагсаалтаас гаргаж, дуусмагц
  буцаана. Унасан холболтыг pool руу БҮҮ буцаа (TTL 4 мин, voice бүрд 4).
- Мөн: унасан үед **эхлээд ижил voice дээр** дахин оролдоно (өмнө нь шууд
  `JennyNeural` руу буудаг байсан тул холболтын гэмтлийг "voice муу" гэж
  оношилж, дуу хоолойг байнга доошлуулах эрсдэлтэй байв).

**Phase 4-ийн СӨРӨГ үр дүнгүүд** (дахин бүү шалга — тоогоор хаагдсан):
- **Prompt/түүхийн хэмжээ TTFT-д нөлөөгүй.** System prompt 637 токен. Түүхийг
  бүрэн хассан ч TTFT **муудсан** (877→930мс). Богиносгосон prompt ч мөн адил.
  TTFT ≈ 1.1 сек нь энэ загварын шал.
- **Эхний өгүүлбэрийг эрт таслах нь хожил өгөхгүй**: хариунууд нэг өгүүлбэр тул
  `firstSentence_p50` (1571мс) нь `replyComplete_p50` (1560мс)-тэй ижил.
  `MIN_CHUNK_CHARS`-ыг багасгах шаардлагагүй.
- **JSON mode унтраах** (`responseMimeType` хасах) n=40 дээр ердөө −82мс,
  дуу чимээний хүрээнд. Хийгээгүй.
- **Аюулгүй байдлын талбарыг богиносгох** (`safety:{flagged}` → `flagged`)
  −298мс өгсөн ч 1/40 буруу JSON гаргасан. Хүүхдийн апп дээр аюулгүй байдлын
  гэрээг 0.3 секундээр солихгүй. Хийгээгүй.

**Аюулгүй байдлын баталгаа (урсгалт зам дээр шалгасан):** тэмдэглэгдсэн 2 кейст
**нэг ч аудио хэсэг яриагүй** (`spokenChunks: []`), харин чиглүүлэлт нь энгийн
замаар дуутай хүрсэн. WER 0.015 (11/13 яг таарсан).

**Phase 5A — Azure Fast Transcription-ийн F0 хязгаар хэмжигдэв (2026-08-29).**
Дээрх "2 хүсэлтийн дараа 429" гэсэн ажиглалт **буруу** байсныг тоогоор залруулав.
Жинхэнэ хаалт нь **F0 үнийн багцын 20 хүсэлт / 60 секунд**:
- 1–20 дахь хүсэлт бүгд **200**, warm латенси **285–300мс**.
- **21 дэх хүсэлт 429** (эхлэснээс 7.6 сек хойш), толгойд **`retry-after: 54`**.
- Azure-ийн мессеж шууд хэлж байна: *"exceeded call rate limit of your current
  SpeechServices **F0** pricing tier … To increase your rate limit switch to a
  **paid tier**."* Өөрөөр хэлбэл энэ нь **бидний аппын concurrency биш, багцын
  үнийн түвшний rate limit**.
- Сэргэлт: 429-ийн дараа 5 сек тутам шалгахад **55.6 сек**-т 200 болсон —
  `retry-after` үнэн зөв тул түүнийг дагах нь зөв.
- **Дүгнэлт: F0 нь бидний хүлээгдэж буй voice-turn ачаалалд ТОХИРОХГҮЙ.**
  Turn бүр 1 STT дуудлага гэвэл 20 хүсэлт/мин = зэрэг ~20 turn/мин; ганц ангийн
  хичээл ч үүнийг халина.
- ⚠️ **Дараагийн алхам нь S0 (paid) дээр хэмжих.** S0-ийн гүйцэтгэлийн талаар
  **бодитоор benchmark хийхээс өмнө ямар ч дүгнэлт бүү хий** — F0-гийн
  285–300мс S0 дээр давтагдана гэсэн баталгаа алга, rate limit нь ч өөр.
- ⚠️ **Production-ий зам хөндөгдөөгүй хэвээр: Gemini STT → Gemini LLM →
  Azure TTS.** Phase 5 бол зөвхөн хэмжилт, шилжилт БИШ.
- Түүхий лог: session scratchpad → `phase5-preserved/a1.out`.

**Phase 5B — cold start нь idle-ийн уртаас ХАМААРДАГГҮЙ (2026-08-29).**
Azure Fast Transcription-ий "хүйтэн эхлэл" хэр үнэтэй, удаан хэвтэхэд муудах уу
гэдгийг хэмжив. Хариулт: **муудахгүй.**

| idle | горим | 1-р POST | 2-р POST |
| --- | --- | --- | --- |
| — (warm baseline) | keepalive | p50 **528–539** | — |
| 2 мин | cold-connection | 1172 | 413 |
| 5 мин | cold-connection | 1163 | 939 |
| 5 мин | TLS prewarm | 1005 (TLS 677) | 285 |
| **15 мин** | cold-connection | **943** | 726 |

- ⚠️ **"Cold start 11 секунд" гэсэн хуучин тэмдэглэл эцэслэн НЯЦААГДЛАА.**
  15 минут хэвтсэний дараах эхний хүсэлт 943мс — 2 болон 5 минутынхаас ч бага.
  Торгууль нь ~0.9–1.2 сек орчим **тогтмол**, idle-ийн уртаас хамаарахгүй.
  Тиймээс "хэрэглэгч ховордвол STT удаашрана" гэж төлөвлөх шаардлагагүй.
- **TLS prewarm бараг хожил өгөхгүй** (1163 → 1005мс). Өөрөөр хэлбэл эхний
  хүсэлтийн зардал нь зөвхөн TLS биш; урьдчилж дулаацуулах инженерчлэл хийх
  үндэслэл алга. (n=1 тул чиглэл л, батламж биш.)
- **Warm-ийн ГУРВАН өөр түвшин бий — үүнийг хольж болохгүй:**
  keepalive-тай дараалсан burst **285–300мс** · 1 сек завсартай **500–650мс** ·
  холболт шинээр **943–1172мс**. Production-д turn хоорондоо задгай тул
  **285–300мс бол хамгийн сайн тохиолдол; хүчин чадлын төлөвлөлтөд түүнийг бүү ав.**
- Түүхий лог: session scratchpad → `b15.out` · `phase5-preserved/b.out`.

**Phase 5C — concurrency: Azure F0 дээр алдаа ГАРААГҮЙ (2026-08-29).**
16 хүсэлт/60сек-ийн gate тавьж, 5A-гийн rate limit-д хэзээ ч хүрэхгүй болгосон
→ гарсан ямар ч алдаа нь concurrency-ийнх байх нөхцөл бүрдсэн. **78 хүсэлтэд
нэг ч алдаа гараагүй** (0 × 429, 0 × 5xx, 0 × network):

| C | n | амжилт | 429 | p50 | p90 | p95 | burst wall |
| --- | --- | --- | --- | --- | --- | --- | --- |
| 1 | 12 | 100% | 0% | 286 | 534 | 804 | 287 |
| 2 | 16 | 100% | 0% | 549 | 1050 | 1068 | 649 |
| 5 | 20 | 100% | 0% | 1010 | 1351 | 1411 | 1315 |
| 10 | 30 | 100% | 0% | 1277 | 2238 | 2644 | 1388 |

- **Хариу: 5A-гийн бүх бүтэлгүйтэл нь rate-limit-ийнх.** Concurrency өөрөө
  10 хүртэл ямар ч алдаа үүсгэхгүй — зөвхөн латенси өснө.

**Phase 5D — ХАМГИЙН ЧУХАЛ ОЛДВОР: цуваашилт нь провайдерынх БИШ, бидний
HTTP client-ийнх (2026-08-29).** 5C-д хүсэлтүүд төгс шаталсан
(`[271, 547, 830, 1104, 1383]` — алхам нь яг нэг хүсэлтийн хугацаа). Үүнийг
провайдерынх гэж бүү дүгн: **тусдаа процессуудаар** (нийтлэг pool-ыг тойрч)
давтахад шат бүрмөсөн алга болов.

| | нэг процесс (өнөөгийн prod зан төлөв) | тусдаа процесс |
| --- | --- | --- |
| Azure C=10 | p50 1277 · **wall 1388** | p50 1499 · max 1516 |
| Gemini C=5 | p50 4780 · **wall 7694** | p50 1901 · max 1990 |
| Gemini C=10 | p50 9405 · **wall 17648** | p50 **2280** · max 3454 |

- ⚠️ **Gemini нэг процесс дотор БҮРЭН цуваашина.** 10 зэрэг turn = **17.6 сек**
  ханын хугацаа. Тусдаа процессуудад мөн 10 нь ~2.3 сек. Өөрөөр хэлбэл
  **клиентийн pool дээр p50 ~7.1 секунд алдаж байна** — Azure руу шилжих
  (~1.2 сек) гэдгээс **зургаа дахин том** зүйл, бас провайдераас хамааралгүй.
- **`backend/src/`-д `setGlobalDispatcher` / `Agent` / `maxSockets` огт
  байхгүй** — бүх adapter нүцгэн global `fetch` дуудна. Тиймээс дээрх нэг
  процессын тоо нь production-ий бодит зан төлөв мөн.
- ⚠️ **Механизм нь хараахан ТОГТООГДООГҮЙ** (undici-гийн pool яагаад Azure-т
  2-3 дахь burst дээр зэрэгцээ болоод Gemini-д хэзээ ч болоогүй нь тодорхойгүй).
  Засвар санал болгохын өмнө үүнийг тогтоо — таамгаар `connections` тохируулах
  нь дахин таамаг дээр оптимизацлах болно.
- ⚠️ **Энэ бол ганц процессын хэмжилт.** Prod дээр Railway хэдэн instance/
  worker ажиллуулж байгаагаас хамаарч бодит нөлөө өөр байж болно.

**Phase 5E — Azure vs Gemini + E2E тооцоо (2026-08-29).** Ижил 5 бичлэг (m4a),
ижил өдөр:

| | p50 | p90 | p95 | WER |
| --- | --- | --- | --- | --- |
| Gemini `3.5-flash-lite` (prod) | 1451 | 2542 | 2604 | 0.026 |
| Azure Fast Transcription (C=1) | **286** | 534 | 804 | — |

- **E2E first-audio ТООЦОО** (Phase 4 суурь p50 3583 · p90 4896 · p95 5211):
  p50 → **~2418мс**, p90 → ~2888мс, p95 → ~3411мс. Production-ий telemetry-ийн
  STT p50 (1865мс) дээр тооцвол p50 → **~2004мс**.
  ⚠️ **Энэ бол ТООЦОО, хэмжилт БИШ** — bench нь fixture аудио дээр, provider
  дуудлагыг тусад нь хэмжсэн.
- ⚠️ **Хуучин `gemini5d.out`-ийн аймшигтай сүүл (p90 9127 · p95 16823)
  ДАВТАГДСАНГҮЙ** (өнөөдөр p90 2542 · p95 2604). Тэр нь провайдерын түр зуурын
  түгжрэл байсан — Gemini-гийн тогтвортой шинж биш, түүн дээр аргумент бүү бай.
- **Шийдвэр: STT провайдер ӨӨРЧЛӨГДӨӨГҮЙ.** Prod зам хэвээр
  **Gemini STT → Gemini LLM → Azure TTS**. Azure Fast нь F0 дээр 20/60сек тул
  production-д тавих боломжгүй; S0 дээр хэмжих нь дараагийн алхам.
- **Дараалал (санал):** (1) client pool-ийн механизмыг тогтоох — хамгийн том
  бөгөөд провайдераас хамааралгүй хожил; (2) дараа нь S0 дээр Azure-ийг хэмжих.
- Түүхий лог: scratchpad → `c.out` · `gc.out` · `procpar.out` · `gprocpar.out` · `g.out`.

**Buddy дуу хоолой: "I can't help with audio transcription" алдаа зассан
(2026-08-29).** Хэрэглэгч "Do you like music?" гэж асуухад buddy
*"I can't help with audio transcription. Let's practice speaking instead!"*
гэж хариулж, дараагийн turn-үүд ч мөн адил гажиж байв.

- **Шалтгаан: Gemini STT нь яриагүй аудио дээр хоосон биш, ӨӨРИЙН PROMPT-ООО
  буцаадаг.** Хэмжсэн: чимээгүй бичлэг → `"Transcribe the speech in this audio
  verbatim."`; эвдэрсэн бичлэг → `"The quick brown fox jumps over the lazy dog."`
- `GeminiSttAdapter.run()` тэр текстийг **`confidence: 1`**-тэй transcript болгож
  дамжуулдаг байсан тул `buddy.service.ts`-ийн цорын ганц хамгаалалт
  (`confidence < sttMinConfidence || !transcript`) **хэзээ ч ажиллах
  боломжгүй** байв — итгэл үргэлж 1, текст хоосон биш.
- Улмаар цуурайтсан prompt нь LLM-д **хэрэглэгчийн үг** болж очиж, LLM
  хөрвүүлэх хүсэлтээс татгалздаг. Тэр татгалзал `messages.raw_text`-д
  хадгалагдаж, дараагийн turn бүрийн түүхэнд дахин тоглогддог тул
  **session бүхэлдээ хордоно** (2 дахь дэлгэц: "I can't do that, but…").
- **Засвар (хамгийн бага):** `isTranscribePromptEcho()` —
  `gemini-stt.adapter.ts`. Цуурайг илрүүлээд `{ text: '', confidence: 0 }`
  буцаана → аль хэдийн байгаа хамгаалалт ажиллаж, хэрэглэгчээс эелдэгээр дахин
  хэлэхийг гуйна (LLM/TTS хүртэл очихгүй, төлбөр тооцогдохгүй). Провайдер,
  safety, гэрээ **юу ч хөндөөгүй**. Тест: `gemini-stt.adapter.spec.ts`.
- ⚠️ **Хуурамч эерэгээс хамгаалалт:** цуурай гэж үзэхийн тулд дор хаяж **4 үг**
  шаардана — "transcribe this" гэх мэт богино жинхэнэ хариу тасрахгүй.
- ⚠️ **Эвдэрсэн аудионы хийсвэрлэл (pangram) энэ засвараар баригдахгүй** —
...
- ⚠️ `app.json`-ы `backgroundColor`/`dark` хосыг солих бүрд `theme.ts`-ийн
  `colors.splash`-г мөн сольж өг (JS нь plugin-ы native тохиргоог уншиж чадахгүй).
- ⚠️ Splash бол **native тохиргоо** — OTA-гаар ХЭЗЭЭ Ч хүрэхгүй, шинэ build
  шаардана (build 15).
- **Шинэчлэл (2026-09-24, Choi):** splash зураг нь одоо **`assets/splash-logo.png`**
  = icon-ыг дугуй булантай tile болгож **тунгалаг** канвасын голд (50%) тавьсан.
  Шалтгаан: бүтэн дөрвөлжин icon нь (a) градиент нь цул дэвсгэртэй таарахгүй
  хүрээ үүсгэдэг, (b) Android 12+ splash icon-ыг **дугуйгаар тайрдаг** тул
  чих тасардаг байв. Tile-ийн хамгийн алс булан = канвасын 0.308 (< 1/3 маск).
  `imageWidth` 200 → **240**. Splash-ын дараа **`BrandLoader`**
  (`src/components/BrandLoader.tsx`) — ижил дэвсгэр, ижил байрлалд үнэг
  «амьсгалж», SparkXP лого + гүйдэг зурвас; фонт ачаалах ба session сэргээх
  хоёр үед хоёуланд нь гарна (өмнө нь ягаан дээр ягаан spinner → theme өнгөтэй
  spinner гэсэн 2 үсрэлт байв). ⚠️ `BrandLoader`-ийн `LOGO_SIZE` = `imageWidth`.
...
хооронд promise дээр ганц ч handler байхгүй** — тэр завсарт унавал Node
`unhandledRejection` зарлаж, v15-аас хойших анхдагч нь `throw`, өөрөөр хэлбэл
**бүхэл API процесс унана**, зөвхөн тэр turn биш. Завсар нь turn-ийн урт
(LLM + TTS = секундууд) тул `ai_usages`-ийн ганц INSERT унахад сервер уначихна.
- **Заавал `deferredWrite()` (`buddy.service.ts`) ашигла** — handler-ийг promise
  үүссэн агшинд залгаад, алдааг join дээр яг хэвээрээ шиднэ. Нүцгэн
  `const p = …; await p` хэлбэрийг эгзэгтэй замд **бүү бич**.
- ⚠️ **`process.on('unhandledRejection')`-оор тест бичиж БОЛОХГҮЙ** — Jest-ийн
  sandbox `process` нь listener-ийг жинхэнэ Node-д бүртгүүлдэггүй тул тийм тест
  алдаа байсан ч **ногоон** гарна. Оронд нь "handler синхроноор залгагдсан уу"
  гэдгийг шалга (`buddy-durability.spec.ts` → `deferredWrite` suite).
- ⚠️ Durability тест бичихдээ pipeline-ыг **шууд бүү унага** — тэгвэл join нь
...
| 16 | 09-21 | `63922e2` (PR #272) | `51c74c9f` | `5d970b7a` ✅ | Buddy дуут дэлгэцийн номын сангийн орчин |
...
(AI Buddy гүйцэтгэл: аватарын диск кэш, микрофоны зөвшөөрөл, эгзэгтэй замаас
8 round trip, STT тасалгуур, TTS prewarm).
- ⚠️ **Fingerprint нь build 13-тай ЯГ ТААРСАН** (`6633f8fb…`) — өөрөөр хэлбэл
  энэ бүх ажил **JS-only** байсан ба OTA-гаар хүргэж болох байсан. Эзэн
  зориудаар шинэ build сонгосон. **Дүрэм хэвээр:** native build-ийн өмнө
  `eas fingerprint:compare --build-id <сүүлийн>` ажиллуул; таарвал 30+ минутын
  build биш `ota:deploy` хийх нь зөв.
- Build 13 (09-12) дээр тестлэгдээгүй, зөвхөн энд шалгагдах зүйлс: аватар
  **хоёр дахь нээлтэд** дахин татагдахгүй байгаа эсэх (гол амлалт), микрофоны
  зөвшөөрөл дэлгэц нээгдэхэд асуугдаж эхний өгүүлбэр алдагдахгүй байгаа эсэх.

**TestFlight build 13 гарлаа (2026-09-12).** `1.0.0 (13)`, commit `e60a140`,
EAS build `24bba1b4`. Өмнөх build нь **08-27-ны build 12** байсан тул түүнээс
хойшхи БҮХ ажил энэ build-д анх удаа тестерүүдэд хүрч байна:
- AI Buddy — Azure HD viseme уруул синк, урсгалт аудио, латенси Phase 1–5
  (10–20 сек → **3.8–6.0 сек**), Gemini LLM/STT, STT prompt-echo засвар,
  ярианы дэлгэц бүтэн дэлгэц, AI хариу мэдээлэх 🏳 товч.
- Багш — даалгаврыг олон ангид зэрэг оноох, даалгаврын сан, CEFR шүүлт.
- Админ/контент — Word импортын уян хатан задлалт, сурагчийн ахицын дэлгэц.
- Мөн **Expo SDK 54 хэвээр** (SDK 57 туршилт `e09ebf2`-оор буцаагдсан —
  Expo Go дээр эхлэнгүүтээ унаж байсан).
- ⚠️ **Expo Go-д хэзээ ч тестлэгдээгүй, зөвхөн энд шалгагдах зүйлс:** splash,
  Google/Apple нэвтрэлт (native SDK), микрофон/STT, push token.
- Дүрэм: `eas submit` нь **серверийн ажил** — локал CLI-г таслах нь илгээлтийг
...
- Шинэ хүснэгтүүд (`dictionary_entries`, `user_dictionary_saves`) prod-д
  migration `CreateDictionaryEntries1786500000000`-оор орно.
- ⚠️ **Deploy дараалал:** mobile-ын шинэчлэлт backend-тэй **хамт эсвэл өмнө**
  гарах ёстой. Эс бөгөөс хуучин апп `POST /:word/save` рүү 404 авна (аз болоход
  `catch`-д баригдаж чимээгүй уначих тул апп унахгүй, зүгээр л ⭐ асахгүй).
...
`''` гэж хатуу тавьдаг байв).
- `GET /dictionary/search/:word` одоо `{ word, **translation**, senses, cached }`
  буцаана. `translation` = үгийн 1–3 хамгийн түгээмэл утга `; `-ээр (ж:
  "гүйх; ажиллуулах; урсах"), `dictionary_entries.translation` баганад
  **хадгалагдана** — Gemini-гээс senses-тэй **нэг дуудлагаар** ирнэ.
- ⚠️ **Нэрийн давхцал:** `DictionaryEntry.translation` = **үгийн** утга;
  `WordSense.translation` = тухайн **жишээ өгүүлбэрийн** орчуулга. Хоёул хэвээр.
- **Хуучин мөрүүд** (`translation IS NULL`) дахин AI үүсгэхгүй — дараагийн хайлтад
  богино-gloss замаас (`words` банк → `translations` cache) нэг удаа авч бичнэ.
- Админы "Толь" хуудсанд "Орчуулга" багана + засах талбар нэмэгдэв
  (`PATCH /dictionary/admin/entries/:id` нь `translation`-ийг хүлээж авна;
  хоосон илгээвэл цэвэрлээд дараагийн хайлтад автоматаар нөхөгдөнө).
- Gemini-ийн `responseSchema` массиваас **объект** болов. Schema-г API татгалзвал
  (400) `gemini-text.ts` нэг удаа **schema-гүйгээр** дахин оролддог — задлагч нь
  хуучин хэлбэрүүдийг ч хүлээж авдаг тул онцлог унахгүй.
- Дэлгэрэнгүй: `docs/superpowers/specs/2026-08-05-dictionary-word-translation-design.md`
- ⚠️ Prod migration: `AddDictionaryEntryTranslation1786700000000` (багана нэмэх).

**Админ хичээлийн талбар ↔ апп зөрүү зассан (2026-08-04).** Админаас оруулдаг
талбарууд ба апп дээр уншигддаг талбарууд зөрж байсныг бүхэлд нь нийцүүлэв:
- **Оруулсан зураг одоо апп дээр гарна.** Өмнө нь хичээлийн дэлгэц зөвхөн
  `content.videoUrl`-ийг уншиж, видеогүй бол багцалсан `home-banner.webp`-ийг
  үзүүлдэг байсан тул байршуулсан зураг хаана ч харагддаггүй байв. Одоо
  `thumbnailUrl ?? content.imageUrl`-ийг харуулна. Хуучин мөрүүдийн
  `content.imageUrl → thumbnail_url` backfill migration-д орсон.
- **`position` талбар админд нэмэгдэв** (хоосон = тухайн түвшний ард автоматаар).
  Байсан бүх 0 утга migration-аар 1-ээс эхлэн дугаарлагдана (гараар эрэмбэлсэн
  хичээл байрандаа үлдэнэ). **Дүрэм: `position` 1-ээс эхэлнэ, 0 = эрэмбэлээгүй.**
  `GET /lessons` ба `getContinue` хоёр одоо ижил эрэмбэтэй (`position, createdAt ASC`).
- **Түвшний зам дээрх ✓** одоо шинэ `GET /lessons/completed`-ийн **id-гаар**
  тавигдана (өмнө "эхний N" гэж тоолдог байсан тул буруу хичээл дээр буудаг байв).
- **"Хичээлийн агуулга" (topic) сонголт устгав** — хаана ч уншигддаггүй үхмэл
  дата байсан. Хадгалагдсан `content.topic` утга DB-д хэвээр.
- **Хичээлд үг хавсаргах боломж** — админы хичээл засах цонхонд "Үгс" самбар
  (`LessonWords.tsx`) нэмэгдэж, `PATCH /words/bulk` нь `changes.lessonId`
  (`null` = салгах) хүлээж авдаг болов. Апп хичээлийн доор "Хичээлийн үгс"
  жагсаалтыг үгтэй үед л харуулна.
- **Ноорог/Нийтлэх** checkbox хичээлд нэмэгдэв (өмнө үргэлж `isPublished: true`
  илгээдэг байсан), тайлбарт 1000 тэмдэгтийн тоолуур, `content` jsonb-г дардаг
  байсныг **merge** болгов.
- **Дасгал (Exercises) ноорог болж үүсдэг байсныг зассан** — админы дасгалын
  форм `isPublished: false` анхдагчтай байсан тул шинээр үүсгэсэн дасгал апп
  дээр огт гарахгүй байв (апп зөвхөн `isPublished=true` татдаг). Одоо анхдагч нь
  **нийтэлсэн**. CSV/JSON импорт нь ноорог хэвээр (шалгаад нийтэлнэ) — цонхонд
  анхааруулга нэмэв.
- Хичээлийн дугаар `00` гэж гардаг байсан (`position ?? 1` нь 0 дээр ажиллахгүй)
  — одоо эрэмбэлээгүй хичээл дугаарын оронд ур чадварын дүрсээ харуулна.
- **Жагсаалтын эрэмбэ 2 янз болов** — `GET /lessons` анхдагчаар **сурагчийн
  эрэмбэ** (`level → position → createdAt`), админ нь `?sort=newest` (шинэ
  хичээл дээд талд гарна; эс бөгөөс шинэ хичээл түвшнийхээ ард орж 3-р хуудсанд
  алга болно). `gamification.progressByLevel` мөн зөвхөн **нийтэлсэн top-level**
  хичээлийг тоолдог болсон тул толгойн `done/total` ба замын ✓ зөрөхгүй.
- ⚠️ **Prod:** `BackfillLessonOrderAndThumbnail1786600000000` migration
  ажиллана (зөвхөн дата, схем өөрчлөхгүй). Railway дээр `DB_MIGRATIONS_RUN=true`
  байгаа эсэхийг шалгаж байж deploy хий — үгүй бол backfill ажиллахгүй.
...
- `app/_layout.tsx`-ийн фонт ачаалах үеийн View нь `#0B0716`-г шууд бичсэн
  ...
  солибол `theme.ts`-ийн `colors.splash`-г мөн сольж өг (JS нь plugin-ы native
