...
**⚠️ PROD ДЭЭР ЗӨРҮҮ БАЙНА (энэ алдааг олох явцад илэрсэн, ЗАСААГҮЙ).**
Дээрх turn-үүд **prod** руу явсан (`mobile/.env` → Railway), харин Phase 1–5-ийн
бүх ажил **commit хийгдээгүй** тул prod нь `main`-ийн хуучин кодыг ажиллуулж
байна. Үүнээс:
- **`LLM_PROVIDER=gemini` prod дээр ажиллахгүй.** Commit хийгдсэн
  `providers.config.ts`-ийн LLM factory-д **`case 'gemini'` БАЙХГҮЙ** тул
  `default:` руу унаж **Anthropic** сонгогдоно. Env тавьсан ч чимээгүй үл тоомсорлоно.
- **`TTS_PROVIDER` prod-д тавиагүй** → Gemini TTS (viseme/lip-sync ажиллахгүй).
  Энэ нь 2026-08-27-нд тэмдэглэгдсэн хэвээр.
- Апп нь `/ai/buddy/rt/*` ба `turns/:id/chunk/:i` руу ханддаг ч **prod-д
  байхгүй**. Аз болоход `realtimeUsable()` алдаа дээр `false` болдог тул апп
  хуучин зам руу аюулгүй буцдаг — гэхдээ **Phase 2-ын урсгал prod дээр огт
  ажиллахгүй** гэсэн үг (10–14 сек latency-г тайлбарлана).
- **Дүгнэлт: prod-ийн "No audio" ба удаан latency нь энэ STT алдаанаас ТУСДАА**
  бөгөөд `boju` branch-ийг deploy хийх + Railway-гийн env-ийг тааруулснаар л
  шийдэгдэнэ.
