...
> тоглоом. Дахин бүү нэм.

**✅ ЭЦСИЙН ХЭЛБЭР — сорил нь УР ЧАДВАРЫН жагсаалтдаа нийлнэ (2026-08-12).**

⚠️ **Энэ хэсэгт 4 удаа буруу хийж, Choi 4 удаа буцаасан.** Дахин бүү өөрчил;
буцаасан хувилбаруудыг доор шалтгаантай нь бичив.

| # | Оролдлого | Choi-гийн хариу |
| --- | --- | --- |
| 1 | Сонголтын цонх (`SheetModal`) | ❌ «сонин» |
| 2 | Таб дотор бүлэглэж жагсаах | ❌ 60 сорил = 60 мөр, **доошоо сунжирна** |
| 3 | «Нэмэлт сорилууд» ганц мөр → нэг дэлгэц | ❌ «яагаад тусдаа юм гаргав?» |
| 4 | Карт → `/soril/<type>` дэлгэц (тоглоом + жагсаалт) | ❌ «илүү screen хэрэггүй» |
| 5 | **Ур чадварын жагсаалтдаа нийлүүлэх** | ✅ |

**Одоогийн урсгал (ЗӨВ):**
- **Сорилын таб огт өөрчлөгдөөгүй** — 6 карт, дарвал шууд тоглоом. Нэмэлт мөр ч,
  дунд дэлгэц ч алга.
- Админы Сорил хуудсаар үүсгэсэн контент нь **өөрийн ур чадварын жагсаалтад**
  ордог: `quizType: 'listening'` → `/skill/listening`, `grammar` → `/skill/grammar`,
  `fill` → `/skill/fill`. Тэнд Дасгал хуудасны контенттой **нэг жагсаалт** болно.
- **Бүлгийн нэр = сэдэв, байхгүй бол ТҮВШИН** (`A1` · `B2` …). Сорил хуудсаар
  үүсгэсэн контентод `topic` байдаггүй тул урьд нь бүгд «Бусад» (дараа нь
  «Сорил») гэсэн ганц овоонд унаж, 10+ дасгал ялгаагүй нэг бүлэг болдог байв.
  Түвшин нь мөр бүрд байдаг ба сурагчид шууд утга учиртай.
  ⚠️ Улмаас нэг дэлгэц дээр **хоёр тэнхлэг** зэрэгцэж болно (сэдэв + түвшин) —
  админ Сорилын мөрдөө сэдэв бичиж эхэлбэл түвшингийн бүлэг өөрөө алга болно.
- 🧪 Баталсан: `/skill/listening` 2+10=12 · `/skill/grammar` 1+10=11 ·
  `/skill/fill` 2+10=12 мөр.

- ⚠️ **`word_guess` · `speed` · `matching`** төрлийн сорилд **тохирох ур чадварын
  дэлгэц байхгүй** (тэдгээр нь үгийн сангийн тоглоомууд) тул аппад **хаана ч
  гарахгүй**. Админд эдгээр төрлөөр сорил үүсгэх нь утгагүй — Сонсох · Дүрэм ·
  Дүүргэх гурвын аль нэгээр үүсгэнэ.
- **Дүрэм:** шинэ контент гарах газар хэрэгтэй бол **байгаа жагсаалтад нь
  нийлүүл** — шинэ дэлгэц, дунд алхам, нэмэлт мөр бүү нэм.

#### ✅ Choi — IELTS-ийн 4 модульд жор нэмэгдэв (2026-08-12) · ДАВХАРДУУЛАХГҮЙ

Choi: «IELTS хэсэгт Magoosh-оос дасгал бэлдэж оруулмаар байна, холбож болох уу?»
→ ⛔ **Болохгүй.** Magoosh-ийн дасгал бол тэдний өмч; татаж арилжааны апп-д
оруулах нь зохиогчийн эрхийн зөрчил, нээлттэй API ч байхгүй (зөвхөн scraping).

**Гэхдээ жинхэнэ шалтгаан нь өөр байсан:** кодоос харахад **IELTS-д ангиллын
жор ОГТ байгаагүй** — `recipeFor('ielts_*')` нь `null` буцааж, ерөнхий prompt
рүү унадаг байв. Дүрэм · Сонсгол · Нөхөх · Бичих бүгд өөрийн чанга жортой тул
чанартай гардаг; IELTS л орхигдсон байсан учир сул гардаг байлаа.

**Засвар:** IELTS шалгалтын **нийтэд зарласан формат** (хэсгийн урт, асуултын
төрөл, Task/Part бүтэц — зохиогчийн эрхэд хамаарахгүй) жор болж бичигдэв:

| Модуль | Формат |
| --- | --- |
| `ielts_reading` | 250–350 үгт Academic бичвэр + түүнээс гарах 4 сонголтот асуулт |
| `ielts_listening` | 6–10 мөрт яриа/монолог (Section 1–4 хэв маяг), нэрээр эхэлсэн |
| `ielts_writing` | Task 2 үгчлэл + 40 мин/250 үг заавар + band 7–8 жишиг хариулт |
| `ielts_speaking` | Part 2 cue card («You should say:») + 1 мин бэлтгэл + жишиг хариулт |

- ⚠️ **`ielts_listening` одоо сонсголын ангилалд тооцогдоно** (`LISTENING_CATEGORIES`).
  Үүнгүйгээр AI-гаар үүсгэсэн IELTS сонсгол **дуугүй үлдэж** хариулах боломжгүй
  байв — апп зөвхөн `category === 'listening'`-ийг уншдаг байсан. Одоо бичвэрийг
  нь дуугаар уншиж, чанарын шалгагч ч бичвэр шаардана. Бодит бичлэг (`audioUrl`)
  байвал урьдын адил тоглуулагч гарна.
- 🐛 **Speaking ОГТ үүсдэггүй байсныг зассан** — `maxTokensFor` нь асуулт тутамд
  360 токен өгдөг байсан нь IELTS-ийн 200–400 үгт жишиг хариултад хүрэлцэхгүй,
  гаралт таслагдаж «AI хариу хэт урт болж таслагдлаа» гэж уначихдаг байв.
  `open_response`-д 1400/асуулт болов; `modelAnswer` уртын хязгаар 1200 → 3000.
- 🐛 **`bandNote` үргэлж хоосон ирдэг байсныг зассан** — `buildSchema` нь
  `properties`-ээ `REQUIRED_BY_TYPE`-аас барьдаг тул тэнд байхгүй талбарыг
  загвар буцаах ч аргагүй байв. Шинэ `OPTIONAL_BY_TYPE` нь заавал биш талбарыг
  schema-д оруулна.
- Админы тал бэлэн байсан (`IeltsPage` → `BULK_TARGETS`) — өөрчлөх шаардлагагүй.

**Батлагдсан (бодит Gemini):** Reading 296 үгт бичвэр + бичвэрээс гарах 3 асуулт ·
Listening нэртэй яриа (Sarah/Mark) + сонсогдох хариулт · Writing жинхэнэ Task 2
үгчлэл + 383 үгт хариулт + band тайлбар · Speaking cue card + 204 үгт хариулт.
Тест **71 ногоон**.

**➕ IELTS одоо BAND-аар үүсдэг ба ангилагдана (Choi хүсэлт).**
«Бүх төрлөөр үүсгэх» нь IELTS-д CEFR түвшин биш **зорилтот band** асууна.

- **Хаана хадгалагдах вэ:** `Quiz.topic` (ж: `"Band 6.5"`). ⚠️ Яагаад гэвэл апп
  IELTS-ийг **`topic`-оор нь аль хэдийн бүлэглэдэг** (`app/skill/[key].tsx:113`
  → `CategoryBrowser`) — тиймээс **аппын код өөрчлөхгүйгээр**, шинэ багана ч,
  migration ч нэмэлгүйгээр «Band 5.5 / 6.0 / 6.5…» гэсэн бүлгүүд гарч ирнэ.
- **CEFR түвшин автоматаар** гарна (`bandToLevel`: ≥7.5→c1, ≥5.5→b2, бусад→b1)
  тул админ **зөвхөн band сонгоно**. Bulk цонхны «Түвшин» сонголт IELTS-д
  нуугдана (`hideLevel`) — хоёр өөр хэмжүүр бөглөх төөрөгдөл арилна.
- **Prompt-д band нь сэдэв БИШ, хүндрэлийн заавар** болж хөрвөнө
  (`parseBandTopic`). Эс бөгөөс загвар «Band 6.5»-ын тухай эссэ бичих гээд
  утгагүй болно.
- Хуучин сэдвүүд (Section 1–4 · Task 1/2 · Part 1/2/3) **band-аар солигдов** —
  бүтцийг нь жор өөрөө агуулдаг тул давхардаж байсан. Хуучин мөрүүдийн `topic`
  хэвээр үлдэнэ (өөрийн бүлэгтээ гарна, backfill хийгээгүй).
- ⚠️ `IELTS_BANDS` (admin) ↔ `IELTS_BAND_TOPICS` (backend) **ЯГ таарах ёстой**.
- 🧪 Баталсан: 3 band-аар bulk → `Band 5.5|b2`, `Band 6.5|b2`, `Band 7.5|c1`;
  апп талд 3 бүлэг болж гарсан. (Тестийн мөрүүдийг устгасан.)
...
#### ✅ Choi — Сонсголын тоглуулагч: YouTube маягийн гүйлгэх зурвас (2026-08-14) · ДАВХАРДУУЛАХГҮЙ

Choi: «10 асуултаа шууд сонсоод хийхэд хэцүү — хүссэнээрээ ухраад, аль хэсэгт
явж байгаагаа хардаг байх ёстой. Мөн Үргэлжлүүлэх дарахад тэр хэсгээсээ л явж
байх хэрэгтэй, эхнээсээ эхлээд байвал хүлээхэд хэцүү.»

**Асуудал юу байсан бэ:** сонсох товч нь тоглуулагч БИШ, зүгээр л «уншуулах»
команд байв (`Speech.speak` нэг дуудлага). Тиймээс байрлал гэж байхгүй, зогсоох
ч, ухрах ч аргагүй, дарах бүрд **эхнээсээ**. Асуулт солигдоход мөн эхнээсээ.

**Одоо:** ярианы бичвэрийг **өгүүлбэрээр хувааж** (`splitScript`), унших
дэлгэцийн хөдөлгүүрээр (`useReadAlong`) гинжлэн тоглуулна.
- **Гүйлгэх зурвас** (`src/components/audio/SeekBar.tsx`, шинэ) — чирж эсвэл
  товшиж хүссэн газраа очно, доор нь «5 / 12 өгүүлбэр» гэж **хуруу дагаж**
  шинэчлэгдэнэ (тавихаас өмнө хаана буухаа харна). ⚠️ Бичвэрийг ил гаргахгүй
  тул хариулт задрахгүй.
- 🐛 **Чирэлт огт ажиллахгүй байсныг зассан (Choi мэдээлсэн).** Шалтгаан нь
  `Gesture` объектыг `useMemo([width, onSeek])`-ээр барьж байсан: тоглуулалтын
  явцад дэлгэц өгүүлбэр тутамд дахин рендерлэгдэх бүрд **шинэ жест үүсч,
  чирж байсан хуруу дундаас нь тасалдана**. Одоо жест нь **нэг л удаа**
  баригдаж, өргөн/callback/идэвх бүгд `ref`/shared value-аар дамжина.
  ⚠️ **Дүрэм:** RNGH жестийг байнга рендерлэгддэг дэлгэц дээр `useMemo`-гийн
  хамааралд бүү үүсгэ — тогтвортой байлга, өөрчлөгддөг зүйлээ ref-ээр өг.
- **Хуваалтын зураасууд хасагдав + хөдөлгөөн UI thread дээр** (Choi: «section
  хэсэг хэсэг хэрэггүй, яг л YouTube шиг, илүү smooth»). Зурвас нь одоо
  shared value + `useAnimatedStyle`-аар зурагдана (React-ийн хурдаар биш),
  өгүүлбэр дотор нь **тооцоолсон хугацаагаар жигд гүйнэ** (`speakMs`, ~2.6
  үг/сек) — өмнө нь өгүүлбэр бүрд үсэрч, дунд нь хөшиж зогсдог байв.
- **Удирдлага нь тоглуулах/зогсоох + зурвас, ЗӨВХӨН тэр.** ⚠️ Ухраах/урагшлах
  болон «Эхнээс нь» товчнуудыг **зориудаар хассан** (Choi: «зүгээр л ухраадаг
  товч байлгүйгээр, гараараа чирж хаана явж байгааг нь харуулдаг байх ёстой»).
  Дүрэм: энэ тоглуулагчид алгасах товч дахин нэмэхгүй — зурвас нь өөрөө
  ухраах ба хаана явж байгааг хэлэх үүргийг хоёуланг гүйцэтгэнэ.
- ⚠️ **Асуулт солигдоход дахин эхлүүлэхгүй** боллоо. Нөхөх дасгалд л хэрэгтэй
  өгүүлбэр рүү нь **үсэрнэ** (өмнө нь тэр өгүүлбэрийг тусад нь уншдаг байсан;
  одоо тэндээс цааш үргэлжилнэ).
- **Бодит бичлэгтэй (IELTS) тоглуулагч ч мөн зурвастай боллоо** — тэнд секунд
  бодитоор мэдэгддэг тул `0:42 / 3:15` + 10 сек ухрах товч. Хоёр тоглуулагч
  ижил төрхтэй (нэг л зүйл мэт харагдана).
- ⚠️ **Яагаад секунд биш өгүүлбэр вэ (TTS):** `expo-speech`-д цагийн шугам
  БАЙХГҮЙ — секунд рүү үсрэх боломжгүй. Өгүүлбэр бол үнэнчээр очиж чадах
  хамгийн жижиг байрлал (мөн сонсголын дасгалд яг хэрэгтэй нэгж).
- `useReadAlong`-д **`{ rate }` сонголт** (Удаан = 0.55) ба **`seek`/`count`**
  нэмэгдэв — бүгд нэмэлт, унших дэлгэцийн зан төлөв хэвээр. Хурд нь `rateRef`-д
  тул сольсон ч яриа таслагдахгүй.
- Дасгал дуусмагц яриа зогсоно (гинжин тоглуулалт баяр хүргэх дэлгэцийн доогуур
  үргэлжлэхээс сэргийлж).
- 🐛 **«Check дарахад уншиж байсан нь зогсчихоод, заавал дахин даруулдаг»
  зассан (Choi).** Эхлээд «дуу эффект таслаж байна» гэж таамаглаад автомат
  сэргээгч тавьсныг **бүрмөсөн хаяв** — таамаг дээр барьсан засвар нь
  урьдчилан таамаглах аргагүй зан төлөв өгдөг.
- ✅ **Оронд нь зогсоолтыг ӨӨРСДӨӨ удирдана:** шалгамагц зориудаар **түр
  зогсоно** (сурагч тэр агшинд сонсохоо больж хариултаа хардаг), дараагийн
  асуулт руу орохоор **зогссон өгүүлбэрээсээ өөрөө үргэлжилнэ**. Гараар товч
  дарах шаардлагагүй. `useReadAlong`-д `pause()` / `resume()` нэмэгдэв.
  ⚠️ Нөхөх дасгалыг энэ нөлөө үргэлжлүүлэхгүй — `focusIndex` нөлөө нь тухайн
  асуултын өгүүлбэр рүү үсэргэдэг тул хоёулаа ажиллавал хоёр өгүүлбэр зэрэг
  эхэлнэ.
- `useReadAlong.jump()` одоо **үргэлж audio session-ээ дахин баталгаажуулна**
  (өмнө зөвхөн зогсоо байдлаас эхлэхэд) — өөр дэлгэц/эффект сессийг өөрчилсний
  дараа хоолой чимээгүй болох ангийг арилгана.

**🐛 B2 (Сорилоос үүссэн) сонсголын дасгал УНШЛАГА мэт нээгддэг байсныг зассан.**
Choi: «listening хэсэгт B2-т байгаа хэсгүүд яагаад бусадтайгаа адилхан
ажиллахгүй байна вэ? reading passage гээд гарч ирчихсэн байх юм.»
- **Шалтгаан:** «Сонсгол» дэлгэц нь **хоёр эх сурвалжийг** нийлүүлдэг —
  Дасгал хуудасны `category: 'listening'` **ба Сорил хуудасны
  `category: 'soril'` + `quizType: 'listening'`** (`app/skill/[key].tsx:83`).
  Гүйцэтгэгч дэлгэц гэтэл зөвхөн `category`-г хардаг байсан тул Сорилоос
  үүссэн бүх сонсголын дасгал **сонсгол гэж танигдахгүй**: тоглуулагч гарахгүй,
  яриа нь «Уншлагын эх» болж ил гарч, дасгал утгаа алддаг байв.
- **Засвар:** `src/constants/quizSkill.ts` (шинэ) — `quizSkill(quiz)` нь
  `category` · `quizType` · `ielts_*` гурвуулангаас ур чадварыг гаргана.
  Гүйцэтгэгч одоо `isListeningQuiz(quiz)`-ийг ашиглана.
- ⚠️ **ДҮРЭМ (Choi онцлон хүссэн):** дасгалын ур чадвараар ялгаварлах бүрд
  **`quizSkill()`-ийг ашиглана, `quiz.category`-г шууд бүү харьцуул.** Шинэ эх
  сурвалж (шинэ админ хуудас, шинэ `ielts_*` модуль) нэмэгдвэл зөвхөн тэр файл
  засагдана — «энэ хэсэгт орсон контент бусадтайгаа адил ажиллах» баталгаа нь
  тэр. (Хичээлийн ур чадварын шошго/дүрсний `skills.ts`-тэй хольж болохгүй:
  тэр нь «яаж харагдах», энэ нь «юу вэ».)
- 🧪 9 кейс дээр батлав (Дасгал · IELTS · Сорил · хичээлийн тест · хуучин
  контент · Сорилын бусад төрөл).
- **Бусад хэсэг ч мөн адил таних болов** (Choi хүсэлт):
  · `app/skill/[key].tsx` Сорилын контентыг `quizSkill(q) === skillKey`-ээр
    шүүнэ (өмнө `q.quizType`-г шууд) → **жагсаалт ба нээгдэх зан төлөв нэг л
    логикоор шийдэгдэнэ**, зөрөх боломжгүй.
  · Гүйцэтгэгчид **`isReading`** тодорхой болов — өмнө нь «сонсгол биш бол
    уншлага» гэсэн дүгнэлтээр явдаг байсан. Уншлагын дасгал одоо өөрийн
    заавартай («Дээрх бичвэрийг уншаад хариул»), өмнө нь бичвэр яагаад дээр нь
    байгаа нь тайлбаргүй байв.

> ⛔ **Өсөхбаярт — ИЖИЛ АЛДАА BACKEND ДЭЭР БАЙНА (mobile талаас засах
> боломжгүй).** `backend/src/quizzes/ai-generate.ts:104` дэх
> `isListeningCategory()` нь мөн зөвхөн `['listening','ielts_listening']`-ийг
> хардаг тул **Сорил хуудсаар үүсгэсэн сонсголын дасгалд**:
> 1. AI-д яриа (`passageText`) **шаардагддаггүй** (`needsPassage` худал,
>    schema-д ч заавал биш, `MIN_LISTENING_SCRIPT` шалгалт ч алгасагдана) —
>    тиймээс эх мэдээлэлгүй сонсголын дасгал үүсэх боломжтой;
> 2. `quality.ts`-ийн **сонсголын бүх шалгалт алгасагдана** (нөхөх үг яриан
>    дотор байх, нэр яриан дотор дуудагдах, хариулт сонсогдох).
>
> Засвар нь энгийн: `isListeningCategory(category)` → `category === 'soril'`
> үед `quizType`-ыг харах (mobile талын `quizSkill()`-тэй ижил дүрэм). Ингэхгүй
> бол Сорилоос үүссэн сонсголын контент шалгалтгүй хэвээр үлдэнэ.
- **Жест:** зурвас нь `Pan` (хэвтээ, `failOffsetY` — хуудсын босоо гүйлгэлт
  хэвээр) + `Tap` (шууд очих) хосоор ажиллана. **Дүрэм:** ScrollView дотор
  чирдэг элемент нэмэхэд энэ хосыг ашигла, дан `minDistance(0)` Pan биш.

**📄 Сонссон бичвэр өөрөө цухуйхаа болив (мөн өдөр).** Choi: «Check дарах
болгонд бичвэр гарч ирэхээ болиё — хамгийн сүүлд, эсвэл товч дарахад гараг.
Асуулт бүрийн араас гарч ирээд байхаар сонин байна.»
- Урьд нь `hidePassage = isListening && !feedback` байсан тул хариулт шалгах
  **бүрд** бүтэн бичвэр доор нь дэлгэгддэг байв.
- Одоо: **зөвхөн товчоор**. Хариулсны дараа хэрэгслийн мөрөнд «Сонссон бичвэр»
  товч гарна; дарвал нээгдэнэ, **дараагийн асуулт дээр өөрөө хаагдана**
  (`transcriptOpen` нь `currentIndex` солигдоход тэглэгдэнэ) — эс бөгөөс нэг
  удаа нээсэн нь цаашид ил үлдэж, хуучин зан төлөв рүүгээ буцна.
- **Дүнгийн дэлгэцэд (хамгийн сүүлд) бүтнээрээ** гарна — `AnswerReview`-ийн
  доор. Юу сонссоноо бүтнээр нь шалгах газар нь тэр.
- ⚠️ **Дүрэм:** хариулахаас ӨМНӨ бичвэр хэзээ ч харагдахгүй (уншчихаад
  хариулах боломж) — товч нь `feedback` байгаа үед л рендерлэгдэнэ.

⚠️ **Boju:** `app/quiz/[id].tsx` дундын файл — сонсголын хэсэг бүхэлдээ
өөрчлөгдсөн (`speak`/`speakScript`/`spokenFor` устсан, `expo-speech` import
хасагдсан). Merge хийхээсээ өмнө pull хий.

#### ✅ Choi — Reading 2.0: ахиц · номын сан · шинэ үгийн статистик (2026-08-14) · ДАВХАРДУУЛАХГҮЙ

**Update 3-ын «Reading шинэчлэлт» мөр.** Дөрвөн дэд ажлаас **аудио дагаж унших**
нь аль хэдийн бэлэн байсан (`useReadAlong` — өгүүлбэр тодруулах, хуудас дагах,
бичлэггүй өгүүлбэрт төхөөрөмжийн хоолой) тул хөндөөгүй. Үлдсэн гурав:

**1. Ахиц хадгалагдана — уншиж байсан газраасаа үргэлжилнэ.**
- ⚠️ **BE тал 100% бэлэн байсан** (`PUT /reading/:id/progress` · `GET /reading/progress`,
  prod дээр 401 буцаана = амьд), mobile-ын `api/reading.ts`-д функц нь ч байсан —
  **гэхдээ ямар ч дэлгэц дуудаагүй** тул хэн ч ашиглаж чадахгүй байв. Backend
  өөрчлөх шаардлагагүй, migration ч алга.
- `src/lib/useReadingBookmark.ts` (шинэ) — нээхэд хаана зогссоныг татна, хуудас
  эргүүлэх бүрд **1.2 сек debounce**-оор бичнэ (8 хуудас гүйлгэвэл 1 PUT), дэлгэцээс
  гарахад үлдсэнийг нь **flush** хийнэ. Алдаа гарвал чимээгүй, унших тасрахгүй.
- ⚠️ **Bookmark ирэхээс өмнө юу ч бичихгүй** (`resumeIndex == null` бол `mark`
  дуудахгүй) — эс бөгөөс эхний хуудас 0 гэж бичигдээд, үргэлжлүүлэх байрлалыг
  дарж бичих байсан.
- `PagedReader`-т **`initialChar`** нэмэгдэв: хадгалсан тэмдэглэгээ рүү **нэг л
  удаа**, анимэйшнгүй үсэрнэ (үсэг томсгоход дахин хуудаслах үед хэрэглэгчийг
  буцааж татахгүй). Дуусгасан материал үргэлж эхнээсээ нээгдэнэ.
- ⚠️ **`onPageChange` гарын үсэг өөрчлөгдсөн** — одоо `(page, total, startChar)`.
  Цорын ганц дуудагч нь `app/reading/[id].tsx`.
- Үсрэлтийг тайлбарласан мөр гарна: «Уншиж байсан хуудсаас үргэлжлүүллээ»
  (хуудас эргүүлмэгц алга болно).

**2. Номын сан — `/reading` дотор (шинэ дэлгэц НЭМЭЭГҮЙ).**
- **«Үргэлжлүүлэх» карт** — хамгийн сүүлд эхэлсэн, дуусгаагүй материал
  (`ContinueReading.tsx`, Home-ийн continue картын хэлбэрээр). Аль сэдэвт байсныг
  санах шаардлагагүй боллоо.
- **CEFR шүүлт** — материалуудад бодитоор байгаа түвшнүүд л чип болж гарна
  (2-оос доош бол огт харагдахгүй).
- **Мөрийн дэд гарчиг** нэг баримтаар баяжив: эхэлсэн бол `42% уншсан`, үгүй бол
  `5 шинэ үг`.
- ⚠️ **`CategoryBrowser` (дундын) хөндөгдөөгүй** — бүх шинэ мэдээлэл нь `subtitle`
  ба `hero`-гоор дамжсан.

**3. Шинэ үгийн статистик.** «Шинэ үг» = админы **гол үгс**-ээс сурагчийн
хараахан ⭐ хадгалаагүй нь (`src/lib/newWords.ts`). Материалын ковер дээр,
жагсаалтын мөрөнд, дуусгасны баяр хүргэлтэд (өгүүлбэрийн тооны оронд) гарна.
- ⭐ дарах бүрд cache цэвэрлэгдэнэ (`forgetSavedWords()` — `useWordLookup.ts` ба
  `app/saved.tsx` дотор), эс бөгөөс тоо 60 секунд хоцрох байв.
- ⚠️ **Дүрэм:** хадгалсан үгийн жагсаалтыг дэлгэцээс шууд бүү тат —
  `loadSavedWords(token)` дамжуулна (60 сек cache, хоёр дэлгэц хуваалцана).

**Сервер тал:** ахиц нь серверт хадгалагддаг тул **төхөөрөмж хооронд**
үргэлжилнэ; локал `reading.completed` нь зөвхөн офлайн үед ✓-г зурах нөөц
(`loadReadingStates` нь хоёуланг нэгтгэнэ).

**Шалгасан:** `tsc --noEmit` + `eslint` цэвэр; цэвэр логикийг (өгүүлбэр↔тэмдэгт
буулгалт, `readShare`, `newWordCount`, «үргэлжлүүлэх» сонголт) тусад нь скриптээр
батлав (mobile-д тест ажиллуулагч байхгүй). ⛔ **Бодит утсан дээр туршаагүй** —
`npm run go`-гоор Унших → хагас уншаад гарах → буцаж орох урсгалыг шалгах хэрэгтэй.

⚠️ **Boju:** энэ багц чиний файлыг хөндөөгүй. Дундын файлаас
`src/components/dictionary/useWordLookup.ts` (1 мөр), `app/saved.tsx` (1 мөр)
хоёрт л cache цэвэрлэх дуудлага нэмэгдсэн.

#### ✅ Choi — Backend дуудах товчнууд нэг загварт орлоо (2026-08-14) · ДАВХАРДУУЛАХГҮЙ

**Асуудал:** backend дууддаг товч бүр ижил 12 мөрийг гараар давтаж бичсэн байв
(`setBusy(true)` → `try` → `haptics.success()` → `catch` → `alertError(e
instanceof ApiError ? e.message : t(...))` → `finally setBusy(false)`). 14 файлд
16 хувилбар — тиймээс тэд **хоорондоо зөрж эхэлсэн**: зарим нь чичрэлт өгдөг,
зарим нь өгдөггүй; зарим нь давхар товшилтоос хамгаалдаг, зарим нь **хүсэлтийг
2 удаа илгээдэг**; алдааны текст нь `errorGeneric` ба `errorFallback` гэж 2 янз.

**Шийдэл — 2 шинэ дундын хэсэг:**
- **`src/lib/useAsyncAction.ts`** — нэг backend дуудлагын бүх эргэн тойрныг эзэмшинэ:
  `busy` төлөв, **давхар товшилтын хамгаалалт** (`busyRef` — `busy` state нь нэг
  render хоцордог тул хангалтгүй), haptic, алдааг мессеж болгох, unmount хамгаалалт
  (амжилттай үйлдэл ихэвчлэн өөр дэлгэц рүү шилждэг). `run` нь **аргумент авна**
  (QR код, зургийн uri).
- **`src/components/ActionButton.tsx`** — `Button` + дээрх hook. Дэлгэц зөвхөн
  дуудлагаа өгнө; spinner/disable/чичрэлт/алдаа автоматаар. `confirm={{...}}`
  өгвөл эхлээд асууна (устгах гэх мэт).

**Дүрэм (шинэ код бичихэд):** товч backend дууддаг бол **`<ActionButton>`**
ашигла — `<Button>` + гараар бичсэн `busy` state дахин бүү бич. Товч биш зүйл
(QR, зураг сонгогч, мөр) бол `useAsyncAction`-ыг шууд дууд.

**Хөрвүүлсэн 14 файл** (−304/+206 мөр): `(auth)/forgot` · `change-password` ·
`(auth)/choose-username` · `(auth)/register` · `(teacher)/class/new` ·
`(teacher)/class/[id]/assign` · `SignInSheet` · `EditProfileModal` ·
`DeleteAccountSheet` · `StreakFreezeSheet` · `HeartsSheet` · `JoinClass` ·
`useAvatarPicker` (+ `Button.tsx` нь props төрлөө export хийв).

**Зан төлөвийн 2 өөрчлөлт (санаатай):**
1. **Auth дэлгэцүүд одоо мөн haptic өгнө.** Sheet-үүд (Sparks, зүрх, анги
   элсэх) аль хэдийн success/error чичрэлттэй байсан; нэвтрэх/бүртгүүлэх
   байгаагүй. Одоо бүгд ижил. Бүртгэл/нэвтрэлт дээр `haptic={false}` —
   тэдний `fail()` нь өөрөө чичрүүлээд формоо сэгсэрдэг (давхар чичрэлт болохоос
   сэргийлсэн).
2. **Алдааны текст нэгдэв:** `errorFallback` («Алдаа гарлаа») → `errorGeneric`
   («Алдаа гарлаа. Дахин оролдоно уу.») зүрх/Sparks sheet дээр. `errorFallback`
   түлхүүр устаагүй (`api/client.ts`, `DailyGoalSheet`, `buddy-memory` ашигласаар).

**Санаатай хөрвүүлээгүй 3 газар:**
- `app/trophies.tsx` — optimistic шинэчлэл + буцаах (rollback) логиктой; hook-д
  оруулбал буцаах утга нь буруу render-ээс уншигдана.
- `app/quiz/[id].tsx` · `app/game/[mode].tsx` — илгээлтийг **товч биш**, сүүлийн
  хариулт өөрөө өдөөдөг.
- `src/components/DailyGoalSheet.tsx` — `saving` нь boolean биш, **аль мөр**
  хадгалагдаж байгааг хадгалдаг (мөр тус бүрийн spinner).

⚠️ **Boju:** дундын файл хөндөгдсөн — `SignInSheet.tsx`, `EditProfileModal.tsx`,
`JoinClass.tsx`, `Button.tsx` (`Props` → `export interface ButtonProps`,
зан төлөв хэвээр), мөн чиний талбарын `(teacher)/class/new.tsx`,
`(teacher)/class/[id]/assign.tsx`. Merge хийхээсээ өмнө pull хий.

⚠️ **Тестлэх:** `tsc --noEmit` + `eslint` цэвэр, гэхдээ **утсан дээр гараар
шалгаагүй** (mobile-д jest тест алга). Гол урсгалууд: нэвтрэх · бүртгэл+OTP ·
нууц үг сэргээх · анги элсэх · зүрх/Sparks худалдан авалт · профайл засах ·
данс устгах.

#### ✅ Choi — IELTS: жинхэнэ шалгалтын тоглуулагч (Part · хариултын хуудас) (2026-08-14) · ДАВХАРДУУЛАХГҮЙ

**Асуудал:** IELTS нь өөрийн гэсэн юмгүй байв — `/ielts` → 4 хавтан →
`/skill/ielts_*` (энгийн жагсаалт) → **бүх дасгалтай хуваалцсан 2014 мөрийн
`app/quiz/[id].tsx`**, дээр нь passage хайрцаг + аудио мөр наасан. Тэр runner нь
нэг асуулт нэг дэлгэц, буруу хариултыг эцэст нь давтуулдаг — **дасгалын** зөв
хэлбэр, **шалгалтын** буруу хэлбэр. Үүнээс болж сурагч *хаана явааг*, *хэдэн
асуулт үлдсэнийг*, *ямар хэсэгт байгаагаа* мэдэх ямар ч арга байгаагүй.

**Шийдэл — IELTS-д зориулсан тусдаа тоглуулагч** (`app/ielts/test/[id].tsx`),
ieltsonlinetests.com-ийн загвараар:
- **Part таб** — Хэсэг 1/2/3/4, тус бүр дээрээ `4/6` гэсэн бөглөлтийн тоо.
  Өөр хэсэгт зогсож байхад дутуу хэсэг нь харагдана.
- **Хариултын хуудас** — асуултын дугаарын зурвас: бөглөсөн = дүүрэн, одоогийн =
  цагираг, бөглөөгүй = хоосон. Дугаар дарахад тэр асуулт руу гүйлгэнэ.
- **Хэсгийн бүх асуулт нэг хуудсанд** (жинхэнэ шалгалтын адил) — дурын дараалалд
  хариулна, сольж болно, **илгээх хүртэл юу ч шалгагдахгүй**.
- **Цаг** — өнгөрсөн цаг гүйнэ, санал болгосон хугацаанаас хэтрэхэд улаан болно.
  **Автоматаар илгээхгүй** (эзний шийдвэр: «байх, гэхдээ албадахгүй»). Хугацаа нь
  асуултын тооноос — Listening 45 сек/асуулт, Reading 90 сек/асуулт
  (жинхэнэ 40 асуулт / 30 · 60 минутаас гаргасан).
- **Эх материал** — Listening: дээр наалдсан тоглуулагч (бодит бичлэг байвал
  түүнийг, эс бөгөөс скриптийг төхөөрөмжийн хоолойгоор; хоёулаа нэг `SeekBar`).
  Reading: «Эх бичвэр ↔ Асуултууд» гэсэн нэг товчтой (утсан дэлгэц дээр
  desktop-ийн зэрэгцүүлсэн 2 багана багтахгүй).
- **Асуултын төрөл бүр шалгалтын хэлбэрээрээ**: сонголт = A/B/C/D жагсаалт,
  нөхөх = өгүүлбэр бүтэн + сонголтын чипс (эсвэл бичих талбар), матчинг = мөр
  тутамд сонголт, `open_response` = бичих талбар.
- **Дүн** — том band + `8/12 зөв` + XP, доор нь асуулт тус бүрийн ✓/✗ ба
  **өөрийн бичсэн хариулт**.

**Section-ыг хэрхэн хадгалсан бэ (backend, migration ХЭРЭГГҮЙ):**
- Асуулт бүр `section?: number` (1–4) авна — `questions` нь аль хэдийн `jsonb`
  тул **шинэ багана ч, migration ч алга**. `section`-гүй хуучин контент бүгд
  1-р хэсэгт унана → таб гарахгүй, дасгал хэвийн ажиллана.
- ⚠️ 2 газарт хүрэх шаардлагатай байсан: DTO (`BaseQuestionDto`, `whitelist:
  true` нь танихгүй талбарыг хаядаг) **ба** `validateQuestions` (энэ нь асуулт
  бүрийг мэддэг талбараас нь **дахин угсардаг** тул `section`-ыг гараар
  дамжуулахгүй бол хадгалахад алга болно).
- **Батлагдсан:** локал API руу 4 хэсэгтэй тест POST → DB → `GET /quizzes/:id`
  бүх `section` бүтэн ирлээ.

**Админ:** `QuizQuestionsEditor`-т `sections` prop нэмэгдэв (анхдагч **унтраалттай**
— Дасгал/Сорил/хичээлийн тестэд шаардлагагүй). IELTS хуудасны Listening/Reading-д
асуулт бүрд «Хэсэг» сонгогч + дээр нь «Хэсэг 1 · 4 / Хэсэг 2 · 3» гэсэн
хуваарилалтын тойм гарна (бүгд нэг хэсэгт байвал сануулна). Шинэ асуулт нэмэхэд
өмнөхийнхөө хэсгийг өвлөнө.

**Маршрут:** `skill/[key].tsx` дээр IELTS ангилал бол `/ielts/test/:id`, бусад нь
хуучин `/quiz/:id` руу. Шинэ дэлгэц НЭМЭЭГҮЙ (жагсаалт хэвээр).

**Бас:** `splitScript()` нь `app/quiz/[id].tsx`-ээс `src/lib/script.ts` руу
гарлаа (одоо 2 газар ашиглана — DRY).

⚠️ **Deploy дараалал — ЧУХАЛ.** Backend-ийн `section` өөрчлөлт **эхэлж** гарах
ёстой. Түүнээс өмнө админаас хэсэг сонговол backend түүнийг чимээгүй хаяна
(`whitelist: true`) — админ хадгалаад болсон гэж бодох боловч апп дээр таб
гарахгүй. `/backend` нь Өсөхбаярын талбар тул **PR-аар нь тохирно**
(`create-quiz.dto.ts`, `quizzes.service.ts`, `ielts.ts` — нийт ~25 мөр, additive).

⚠️ **Prod дээр IELTS контент байгаа эсэхийг шалгаарай.** Локал DB-д 77 quiz
байсны **нэг нь ч** `ielts_*` биш байв — өөрөөр хэлбэл IELTS хэсэг хоосон.
Тестлэхэд зориулж локал API руу 2 бодит тест үүсгэсэн (Listening 4 хэсэг · 12
асуулт, Reading 3 бүлэг · 10 асуулт). Апп нь `.env`-ээр **prod** руу заадаг тул
эдгээрийг харахын тулд `EXPO_PUBLIC_API_URL`-ээ локал руу түр солино.

⚠️ **Шалгагдсан:** backend round-trip (бодит API), `tsc` + `eslint` цэвэр (3
`exhaustive-deps` warning нь `quiz/[id].tsx`-ийн одоо байгаа хэв маягтай ижил),
**бүтэн апп Metro-гоор амжилттай bundle болсон** (`expo export --platform ios`).
**Утсан дээр гараар дараагүй** — Part таб, дугаар дарж үсрэх, аудио, илгээлт,
дүнгийн дэлгэцийг нүдээр шалгах шаардлагатай.

⚠️ **Boju:** дундын файл 2 хөндөгдсөн — `app/quiz/[id].tsx` (зөвхөн `splitScript`
устгаад import болгосон, зан төлөв хэвээр) ба `admin/.../QuizQuestionsEditor.tsx`
(шинэ **сонголтот** prop, анхдагчаар унтраалттай тул чиний хуудсууд хэвээр).

📌 **Дараагийн ажил (энэ багцад ОРООГҮЙ):** дүнгийн тойм нь **зөв хариултыг
харуулж чадахгүй** — `POST /quizzes/:id/submit` нь зөвхөн ✓/✗ буцаадаг, харин
`/check` нь зүрх зарцуулдаг тул тоймд ашиглаж болохгүй. Илгээсний дараа зөв
хариултыг буцаадаг болгох BE хүсэлт хэрэгтэй.

#### ✅ Choi — Сонсголын тоглуулагч секундтэй боллоо + сануулгын мессеж (2026-08-14) · ДАВХАРДУУЛАХГҮЙ

**3 гомдол, 3 засвар.**

**1. «Гүйлгэж зогсооход маш хэцүү».** 08-14-ний өмнөх багцад ухраах товчийг
*зориудаар* хассан байсан («зурвасаараа чирнэ») — практик дээр буруу шийдэл
болов: утсан дээр чирж таарах хэцүү, түүнээс ч дор нь **байрлал нь «Өгүүлбэр
4/12» гэсэн нэгжтэй** байсан тул «6 секунд ухраая» гэж шийдэх ч боломжгүй байв.
- **Алхах товч буцаж ирлээ** (⏪/⏩) — нэг товшилт, оносон эсэхээ бодох
  шаардлагагүй, яг хилэн дээр буудаг. Чирэх нь том үсрэлтэд хэвээр.
- **Бүх зүйл секундээр.** `1:04 / 3:12` гэсэн заалт + доор нь тухайн
  өгүүлбэрийн **өөрийнх нь хязгаар** `0:58 – 1:12 · 4/12`. Дахин сонсох гэдэг нь
  одоо «жаахан» биш, «12 секунд» гэсэн харагдах зүйл боллоо.
- **Зурвас бүдүүн, хуваалттай.** Хуваалт нь өгүүлбэрийн зааг — юу сонсох гэж
  байгаагийн хэлбэр нь хүрэхээс өмнө харагдана. Хүрэх талбай 36→**44px**,
  бариул 18→**22px**.

**TTS-д секунд хаанаас гарав?** Speech engine нь зөвхөн «хэддэх өгүүлбэр
эхэллээ» гэдгийг хэлдэг — цаг огт байхгүй. Тиймээс `src/lib/scriptTimeline.ts`
нь үгийн тооноос **хугацааг тооцоолж**, өгүүлбэр бүрд эхлэх/дуусах секунд
өгнө (`useScriptPosition` нь өгүүлбэр эхэлсэн агшнаас цагийг урагшлуулж,
тухайн өгүүлбэрийн төгсгөлд тогтоно — заалт зогсонги байгаад үсэрдэггүй).
Тооцоолол тул бага зэрэг хазайж болно; тэр нь **зөвхөн заалт ба чирэх байрлалд**
нөлөөлнө, тоглуулалт өөрөө өгүүлбэрийн нарийвчлалтай хэвээр.

**2. «Зарим газар зүгээр л error message».** IELTS-д дуусгаагүй байхад
илгээх гэвэл улаан **«Алдаа»** биш, **`components/Notice`** гэсэн зөөлөн
сануулга гарна: «Дуусгахад 3 асуулт үлдлээ» + **«Эхний хариулаагүй рүү»**
товч (хэрэв өөр Part-д байвал тэр Part руу нь шилжинэ). Бүгд бөглөгдсөн үед
мөн адил тайван мэдэгдэл гарна («Илгээхэд бэлэн»). Ачаалж чадаагүй үеийн
гарчиг ч «Алдаа гарлаа» → **«Ачаалж чадсангүй»** болов.
- **Дүрэм:** сурагчийн буруу биш зүйлийг `alertError`-оор бүү харуул —
  `Notice` (`tone="warning" | "info"`) ашигла. Alert нь зөвхөн жинхэнэ
  бүтэлгүйтэлд.
- Шинэ theme token: **`warningSoft`** (dark + light хоёуланд).

**3. «Юу сурах вэ? → Сонсгол-ын дизайн маш муу».** Тэр дасгал болон IELTS
шалгалт хоёр одоо **яг нэг тоглуулагч** (`components/audio/AudioPlayer`)
ашиглана — өмнө нь тус тусдаа бичигдсэн, өөр өөр төрхтэй, зөвхөн IELTS нь
секундтэй байв. Бодит бичлэгтэй дасгал (`audioUrl`) ч мөн адил.
«Удаан», «N удаа сонссон», «Бичвэр» нь бүгд `PlayerPill` болж нэг эгнээнд орлоо.

**Файлууд:** шинэ `src/components/audio/AudioPlayer.tsx` · `src/lib/scriptTimeline.ts`
· `src/components/Notice.tsx`; `SeekBar` нь `marks` (хуваалт) ба `tone`
(`onSurface`/`onGradient`) авдаг болов; `app/quiz/[id].tsx`-ээс **9 хэрэглэгдэхгүй
болсон style + `speakMs` + `seekIndex`** устав (`speakMs` нь `scriptTimeline`-д
шилжсэн).

⚠️ **Boju:** `app/quiz/[id].tsx` дахин хөндөгдсөн (тоглуулагчийн блок + түүний
style-ууд). Логик — асуулт, зүрх, шалгах урсгал — хөндөгдөөгүй.

⚠️ **Шалгагдсан:** `tsc` + `eslint` цэвэр (үлдсэн 6 warning нь өмнөх кодын
`exhaustive-deps` хэв маяг), **бүтэн апп Metro-гоор bundle болсон**.
**Утсан дээр гараар шалгаагүй** — ялангуяа: TTS-ийн секундын заалт бодит
уншилттай хэр таарч байгаа, алхах товч, хуваалтын зураас, `Notice`-ийн Part
хооронд үсрэх.

#### ✅ Choi — IELTS: Part-аар үүсгэх админ + band ангилал ЗАССАН (2026-08-14) · ДАВХАРДУУЛАХГҮЙ

**1. 🚨 «Band 4.5 … 8.0» гэсэн ангилал бол алдаа байсан — устгав.**
IELTS контентыг үүсгэхдээ **зорилтот band**-ыг `topic` талбарт гараар сонгож,
сурагчид тэрүүгээр нь бүлэглэн харуулдаг байв. Band бол **ДҮН**: сервер зөв
хариултын тооноос `ieltsBand(correct, total)`-оор гаргадаг. Урьдчилж band
сонгуулах нь «Band 6.5 бүлгээс сонговол 6.5 авна» гэсэн худал ойлголт төрүүлнэ
— дасгал тийм зүйл амлаж чадахгүй.
- `topic` нь бусад бүх контентын адил **жинхэнэ сэдэв** боллоо (Listening:
  Housing & accommodation · Travel & transport · Academic lecture …; Reading:
  Science & research · History & archaeology …; Writing/Speaking нь Task/Part
  бүтцээрээ). `admin/src/lib/options.ts` → `IELTS_TOPICS`.
- **Хүндрэл = `level` (CEFR)**, админ аль хэдийн сонгодог талбар.
- Устгасан: backend `IELTS_BAND_TOPICS` · `parseBandTopic()` · `bandToLevel()`,
  mobile `parseBandTopic()`, шалгалтын толгой дээрх **band тэмдэг**. AI үүсгэх
  prompt-оос «ЗОРИЛТОТ BAND» заавар хасагдаж, сэдэв/түвшингээр удирддаг болов.
- ⚠️ **Prod migration `ClearIeltsBandTopics1787400000000`** — хуучин
  `topic = 'Band 6.5'` мөрүүдийг `NULL` болгоно (зөвхөн `ielts_*` ангилал, зөвхөн
  яг band хэлбэртэй утга). Эс бөгөөс аппын жагсаалт «Band 6.5» гэсэн бүлгийг
  үүрд харуулсаар байна. Railway дээр `DB_MIGRATIONS_RUN=true` эсэхийг шалга.
- ✅ Band-ыг **дүнгийн дэлгэц** дээр хэвээр том харуулна — тэр л зөв газар нь.

**2. Админ: Part тус бүрээр нь үүсгэдэг боллоо.** Өмнөх хувилбар (мөн өнөөдөр)
асуулт бүрд «Хэсэг ▾» гэсэн dropdown тавьсан байсан нь буруу: бүтэц нь зөвхөн
зохиогчийн толгойд байх ба нэг dropdown мартвал асуулт чимээгүй 1-р хэсэгт унана.
Одоо **хэсэг бүр өөрийн блоктой**:
- Блок бүрд гарчиг («Хэсэг 2 · 3 асуулт · №5–7»), доор нь өөрийн
  **«Хэсэг 2-т асуулт нэмэх»** товч.
- Доор нь **«Хэсэг N нэмэх»** (`MAX_SECTIONS = 4` хүртэл; жинхэнэ Listening = 4,
  Academic Reading = 3 гэдгийг сануулна). Сүүлийн хэсгийг устгахад доторх
  асуултууд нь **устахгүй**, өмнөх хэсэг рүү шилжинэ.
- Асуулт бүрд «Өөр хэсэг рүү» гэсэн жижиг сонгогч (зөвхөн 2+ хэсэгтэй үед).
- ⚠️ **Массив нь хэсгээр эрэмбэлэгдэж хадгалагдана** — сурагчийн харах асуултын
  дугаар нь массив дахь байрлал тул эрэмбэлэхгүй бол «Хэсэг 1: №1, 2, 9» болно.

**3. Mobile: Part-ын дизайн.**
- Хэсгийн таб нь гүйлгэдэг зурвас байхаа больж **тэнцүү өргөнтэй нэг эгнээ**
  (хамгийн ихдээ 4 — утсанд үргэлж багтана). Таб бүр дээр **асуулт тутамд нэг
  цэг** (бөглөсөн нь дүүрэн) — 4 асуулт = 4 цэг, хувь хэрэггүй.
- Таб доор «Асуулт 7–10» ба тухайн хэсгийн `2/4` тоо; дуусмагц ногоон ✓.
- Асуултын жагсаалтын дээр **«Хэсэг 2 / 4»** гэсэн гарчиг (нав нь гүйлгэхэд
  алга болдог — уншиж сууж байгаад «энэ аль хэсэг билээ?» гэдэг нь хамгийн
  түрүүнд мартагддаг).
- Дугаарын товч 32→**36px**, тод бичиг. Дараагийн хэсгийн товч «Хэсэг 3» биш
  **«Хэсэг 3 рүү →»**.

**Шалгагдсан:** backend 214 unit test бүгд ✅ · POST **ба** PATCH хоёулаа
`section`-ыг бүтэн хадгалж байгааг бодит API-гаар баталсан (4 хэсэг:
`{1:4, 2:3, 3:2, 4:3}`) · migration-ий SQL локал дээр ажиллуулж `UPDATE 2`
(band сэдвүүд цэвэрлэгдэж, `level` хэвээр) · `tsc` + `eslint` (admin/mobile/
backend) цэвэр · бүтэн апп Metro-гоор bundle болсон.
⚠️ **Утсан дээр гараар шалгаагүй** — Part таб/цэг, хэсэг хооронд шилжих,
админы блок үүсгэх урсгалыг нүдээр үзэх хэрэгтэй.

⚠️ **Өсөхбаяр:** энэ багц `/backend`-д хүрсэн — `create-quiz.dto.ts`,
`quizzes.service.ts`, `bulk-generate.ts`, `ielts.ts` + шинэ migration. Бүгд
additive эсвэл устгал, схем өөрчлөөгүй.

#### ✅ Choi — Хавтас доторх хавтас урсгалыг устгав + band нэрийн үлдэгдэл (2026-08-14) · ДАВХАРДУУЛАХГҮЙ

**1. Дасгал руу орох нь 3 даралт байсныг 2 болгов.**
`CategoryBrowser` нь **хоёр түвшний** хөтөч байв: сэдэв дар → дараа нь дасгал
дар. Дунд дэлгэц нь толгойд багтаах боломжтой мэдээллээс өөр юу ч агуулдаггүй
(хавтас руу орж байж дотор нь 2 дасгал байгааг мэддэг), өөр сэдэв үзэхийн тулд
жагсаалтаас бүрмөсөн гарах шаардлагатай байсан.
- Одоо **бүх зүйл нэг дэлгэцэд**: дасгалууд шууд харагдана, сэдвүүд нь
  **шүүлтүүрийн чипс** болж жагсаалтыг байрандаа нарийсгана. Нүүрнээс дасгал
  хүртэл **2 даралт**, сэдэв солих нь навигацгүй 1 даралт.
- Мөрөнд сэдэв нь дэд бичвэр болж үлдсэн тул юу ч алдагдаагүй.
- Хөндөгдсөн дэлгэцүүд: **Сонсгол/Бичих/Дүрэм/Нөхөх** (`skill/[key]`),
  **IELTS Listening/Reading** (мөн адил дэлгэц), **Унших** (`reading/index`).
- API цэвэрлэгдэв: `selectedCat` / `onSelectCat` / `selectTitle` prop-ууд
  устсан (шүүлтүүр нь одоо component-ийн дотоод төлөв), `selectTopic` i18n
  түлхүүр → **`allTopics`**.
- ⚠️ **Дүрэм (санах ойд ч байсан):** контентыг завсрын дэлгэц ард бүү нуу —
  жагсаалт дээрээ шүүлтүүрээр шийд. Шинэ контентын жагсаалт нэмэхдээ энэ
  component-ыг ашигла.
- Соril · Хэлц үг · Хичээл зэрэг бусад жагсаалтыг шалгасан — тэдгээр нь аль
  хэдийн нэг түвшний (нэг даралтаар нээгддэг), өөрчлөх шаардлагагүй.

**2. «Band 4.5» нэрс аппад хэвээр гарч байсныг зассан.**
Өмнөх багцад эх үүсвэрийг нь (админы сонголт) зассан ба хуучин мөрүүдэд
migration бичсэн. Гэвч **prod дээр migration ажиллах хүртэл** аппын жагсаалт
`topic`-оор бүлэглэдэг тул «Band 4.5» гэсэн бүлгүүд гарсаар байв.
- Одоо **клиент тал ч хамгаалагдлаа**: `displayTopic()` нь band хэлбэртэй
  утгыг сэдэв гэж үзэхгүй → мөр нь өөрийн **CEFR түвшний** бүлэгт (B2 г.м.)
  унана. Migration ажиллаагүй ч, хуучин мөрийг хэн нэг нь дахин үүсгэсэн ч
  band нэр хэзээ ч харагдахгүй.
- `.topic`-ыг түүхийчлэн харуулдаг бусад газрыг шалгасан — өөр газар алга
  (аппад `topic` зөвхөн энэ жагсаалтад л уншигддаг).

**Шалгагдсан:** `tsc` + `eslint` цэвэр, ашиглагдахгүй import/i18n түлхүүр 0,
бүтэн апп Metro-гоор bundle болсон. **Утсан дээр гараар шалгаагүй** — шүүлтүүр
чипс, урт жагсаалтын гүйлт, Унших дэлгэцийн hero-г нүдээр үзэх хэрэгтэй.

#### ✅ Choi — IELTS: модуль бүрийн жинхэнэ бүтэц + CEFR түвшин хасагдав (2026-08-14) · ДАВХАРДУУЛАХГҮЙ

**1. Хэсэг нь модулиас хамаарна — «хэсэг нэмэх» товч байхаа болив.**
Өмнөх хувилбарт зохиогч өөрөө «Хэсэг нэмэх» дарж бүтцээ угсардаг байв. Гэтэл
бүтэц нь **аль хэдийн тодорхой**: модуль бүр өөрийн гэсэн тогтсон хэсэгтэй.
Одоо форм нээмэгц тухайн модулийн бүх блок **хоосон байдлаар бэлэн** гарч
ирнэ — «шалгалт нь энэ, бөглө» гэсэн урсгал.
...
- ⚠️ **Reading нь 3, 4 биш.** Academic ба General Training хоёул **3 passage /
  40 асуулт**. (General-ийн Section 1 дотроо 2–3 богино эх агуулдаг нь «4»
  гэсэн ойлголт төрүүлдэг.) Хэрэв бид зориудаар 4 болгохыг хүсвэл
  `admin/src/lib/options.ts` ба `mobile/src/constants/ielts.ts` дахь `parts: 3`
  гэсэн **нэг тоог** солиход бүх зүйл дагаж өөрчлөгдөнө.
- Энэ модульд байхгүй хэсэгт хамаарах хуучин асуулт байвал админ шар
  анхааруулга + «сүүлийн хэсэг рүү зөөх» товч харуулна (чимээгүй алдагдахгүй).
- `QuizQuestionsEditor`-ийн prop `sections?: boolean` → **`parts?: number` +
  `partLabel?: string`**. Бусад хуудсууд (Дасгал/Сорил/хичээлийн тест) prop
  өгдөггүй тул хэвээрээ нэг жагсаалт.
- Аппын шалгалтын тоглуулагч мөн энэ нэршлийг ашиглана: таб дээр «Section»
  гэсэн гарчиг + доор нь **зөвхөн дугаар** (4 багана дээр «Section 1» багтахгүй),
  доторх гарчиг «Section 2 / 4», товч «Section 3 рүү».

**2. 🚨 IELTS-д CEFR түвшин (B1/B2…) байх ёсгүй — хасав.**
Жинхэнэ шалгалт бүх шалгуулагчид **яг ижил** байдаг: «B1-ийн Listening» гэж
байхгүй. Ялгаа нь зөвхөн хэдийг зөв бөглөснөөс гарах **band**. Тиймээс:
- Админы IELTS формоос **«Түвшин» сонголт устав**, жагсаалтын CEFR багана ч
  хасагдав. `level` талбар DB-д хэвээр (enum, анхдагч `a1`) — зүгээр л хаана ч
  асуухгүй, харуулахгүй.
- Аппын жагсаалтад IELTS мөр **түвшин харуулахаа больж**, оронд нь **бүтцээ**
  хэлнэ: «12 асуулт · 4 Section · 50 XP».
- Бүлэглэхэд ч түвшинг ашиглахгүй (өмнө нь сэдэвгүй IELTS мөр «B2» гэсэн
  бүлэгт унадаг байсан) — зөвхөн сэдэв, эс бөгөөс «Бусад».
- Band нь хэвээрээ **зөвхөн дүнгийн дэлгэц** дээр, `ieltsBand(correct, total)`-оос.

**Шалгагдсан:** бодит API-гаар — түвшингүй, 2 Task-тай Writing контент
хадгалагдаж, `section` [1,2] бүтэн ирлээ; `level` нь анхдагч `a1` болж
чимээгүй үлдэв. `tsc` (admin+mobile+backend) · `eslint` цэвэр · бүтэн апп
Metro-гоор bundle болсон.
⚠️ **Утсан дээр гараар шалгаагүй** — Section таб/цэг, админы 4 блок бөглөх
урсгалыг нүдээр үзэх хэрэгтэй.

#### ✅ Choi — Сонсголын дасгал «хариулах боломжгүй» болж алга болдог шалтгаан (2026-08-14) · ДАВХАРДУУЛАХГҮЙ

**Онош (таамаг биш, локал DB-гээс тоолсон): 7 сонсголын дасгалын 5 нь
нийтлэгдсэн атлаа аппад ОГТ харагдахгүй байв.**

`quality.ts` дээр зөв дүрэм бий: *сонсголын дасгалд сонсох зүйл заавал* —
**`audioUrl` ЭСВЭЛ 40+ тэмдэгтийн яриа**. Байхгүй бол
(1) хадгалахад сервер татгалзана («Дасгал хариулах боломжгүй байна…»),
(2) `GET /quizzes` нь SQL түвшинд шүүж хаядаг. Дүрэм нь зөв — сонсох зүйлгүй
сонсголын дасгал бол таамаглах дасгал.

**Гэвч админ түүнийг ХАНГАХ аргагүй байсан:** Дасгал хуудасны форм дээр
**`audioUrl` талбар огт байхгүй** байв (зөвхөн IELTS-д байсан). Өөрөөр хэлбэл
бодит бичлэгтэй сонсголын дасгал үүсгэх боломжгүй, цорын ганц зам нь ярианы
бичвэрийг гараар бичих. Хуучин мөрүүд хоёулангүй нь байхгүй тул мухардмал
байдалд орсон: алдаа өгдөг, харагддаггүй, засах хэрэгсэл нь алга.

**Засвар:**
- Дасгалын формд **«Аудио URL»** талбар нэмэгдэв (сонсгол сонгосон үед).
  Шалгуур нь одоо **«бичлэг ЭСВЭЛ яриа»** — бичлэг тавибал ярианы талбар
  автоматаар «сонголтоор» болно.
- `audioUrl` payload-д орж, засах цонхонд ачаалагдана.
- Мөрийн улаан тэмдэг «Хариулах боломжгүй» → **«Аппад харагдахгүй»**. Онош
  биш **үр дагаврыг** нь хэлэх нь чухал: админ нийтэлсэн мөрөө хараад бүх юм
  хэвийн гэж боддог байв.

**Батлагдсан (бодит API):** бичлэгтэй/яриагүй сонсголын дасгал одоо
**хадгалагдаж, аппын жагсаалтад гарч байна** (өмнө нь хадгалалт татгалздаг
байсан). Аппын тал өөрчлөх шаардлагагүй байсан — `audioUrl` байвал
`app/quiz/[id].tsx` аль хэдийн бодит тоглуулагчийн замаар явдаг.

⚠️ **Хуучин 5 мөрийг гараар засна.** Автомат backfill боломжгүй — байхгүй
ярианы бичвэрийг зохиох ёстой. Админаас нээгээд бичлэгийн холбоос эсвэл
яриаг нь бөглөнө (эсвэл устгана).

**Гүйлгэх зурвасны тухай:** тэр нь өмнөх багцад аль хэдийн IELTS-тэй нэг
`components/audio/AudioPlayer` болсон (алхах товч · `1:04 / 3:12` · өгүүлбэрийн
хуваалт). Гэхдээ **дээрх 5 дасгалд сонсох зүйл байхгүй тул тоглуулагч огт
харагддаггүй** байсан — «хэвээрээ байна» гэж мэдрэгдсэн шалтгаан нь энэ.
Контент засагдмагц тоглуулагч бүрэн гарна.

#### ✅ Choi — Чанарын шалгагчийн худал дохио (2026-08-14) · ДАВХАРДУУЛАХГҮЙ

**Гомдол:** «Мэдээний сонсгол» дасгалын 8 асуултын **4 нь** «Зөв хариулт …
сонсох яриан дотор шууд сонсогдохгүй байна» гэсэн анхааруулга авч, админ
өөрийгөө буруу хийсэн гэж бодов. (Дасгал нь **блоклогдоогүй**, аппад хэвийн
харагдаж байсан — эдгээр нь `warn` төрөл.)

**Шалтгаан:** хариултыг **бүтэн хэллэгээр** тулгадаг байсан (`containsWord` нь
үг БҮРИЙГ шаарддаг). Тиймээс «By the library» гэсэн зөв хариулт «It's beside
the library» гэсэн яриатай **тохирохгүй** — `by` нь дотор нь байхгүй. Хагас
дээрээ дохио өгдөг анхааруулга бол дохио биш, шуугиан.

**Засвар — утгын үгээр тулгана:**
- Үйлчилгээний үгс (`the · a · by · on · is · he …`) хасагдаж, зөвхөн утга
  агуулсан үг үлдэнэ. «By the library» → `library`.
- Үгийн хэлбэрийн өөрчлөлт тооцогдоно (эхний 4 үсгээр): `local` ↔ `locally`,
  `excite` ↔ `excited`.
- Утгын үг **нэг ч** олдоогүй үед л анхааруулна. Мессеж нь буруутгахаа болив:
  «…-тай холбоотой үг олдсонгүй. Өөр үгээр илэрхийлсэн бол зүгээр — сурагч
  ярианаас дүгнэж чадаж байгаа эсэхийг л шалгаарай.»

**Мөн БЛОКЛОХ дүрмийг ч сулруулав (илүү чухал).** «Асуулт ч, хариулт ч
яриатай холбоогүй» гэсэн дүрэм асуултын үгсийн **олонхыг** шаарддаг байсан тул
«Where did the mayor speak?» гэсэн бүрэн зөв асуулт ч блоклогдож, дасгал
бүхэлдээ аппаас **алга болох** эрсдэлтэй байв (`where`/`did`/`speak` нь ярианд
байхгүй, зөвхөн `mayor` байсан). Одоо утгын үг **нэг ч** сонсогдоогүй үед л
блоклоно — тэр нь жинхэнэ эвдрэл.

**Тест:** `quality.spec.ts`-д Choi-гийн 4 жишээгээр 5 шинэ тест
(«By the library» ↔ «beside the library» · «A local resident» ↔ «lives
locally» · огт хамааралгүй хариулт хэвээр анхааруулна · зөвхөн
үйлчилгээний үгтэй хариултыг шалгахгүй · хэзээ ч блоклохгүй).
Backend бүх тест **219 ✅** (өмнө 214).

#### ✅ Choi — 🔒 Дасгалын хариулт сүлжээгээр ил явдаг байсныг зассан (2026-08-15) · ДАВХАРДУУЛАХГҮЙ

**Асуудал:** `GET /quizzes` ба `GET /quizzes/:id` нь Quiz entity-г **бүтнээр**
буцаадаг байсан — `multiple_choice`-ийн `correct` индекс, `fill_blank`-ийн
`answer` мөр хоёулаа хариунд ил. Аппын код тэдгээрийг ашигладаггүй ч энэ нь
хамаагүй: DevTools, proxy, эсвэл гараар илгээсэн `curl` бүр дасгалын бүх
хариултыг харуулна. Өөрөөр хэлбэл **дасгал болгоныг 100%-иар «шийдэх»**
боломжтой байсан. (`src/api/quizzes.ts`-ийн тайлбар «correct & answer are NOT
returned to the client» гэж бичсэн байсан нь бодит байдалтай таарахгүй байв.)

**Засвар — `src/quizzes/sanitize.ts` (шинэ):**
- `multiple_choice` → `correct` хасагдана, `options` үлдэнэ.
- `fill_blank` → `answer` хасагдана, `choices` үлдэнэ (аль хэдийн холигдсон
  4 хувилбар, зөв нь дотор нь байх нь дасгалын мөн чанар).
- `word_match` → хосууд үлдэнэ, харин **баруун багана холигдоно**. Апп хоёр
  баганаа энэ массиваас угсардаг тул эгнээгээрээ таарч байвал түлхүүр нь
  шууд уншигдана. Холиход харагдах байдал ижил, шалгалт нь сервер дээр
  `(left,right)` тэнцүүгээр хийгддэг тул дараалал нөлөөлөхгүй.
- `open_response` → юу ч хасахгүй (`modelAnswer` нь ЗОРИУД харуулдаг зүйл).
- **Админ/модератор бүтнээр нь авна** — контентоо засахад хариулт хэрэгтэй
  (админ хуудсууд жагсаалтын хариунаас засварын форм дүүргэдэг).

**Урьдчилан шалгасан зүйлс (аль нь ч эвдрээгүй):**
- `choices` (`normalizeChoices`) ба `wordBank` (`buildWordBank`) хоёул аль
  хэдийн **холигддог** тул байрлалаараа түлхүүрээ задлахгүй.
- Сонголт/үгийн санг бэлдсэний **ДАРАА** хасна — тэдгээр нь хариултаас
  тооцоологддог.
- Аппын цорын ганц `answer` уншдаг газар (`pickFillChoices` доторх хуучин
  контентын нөөц зам) нь өөрөө «сервер явуулаагүй бол таслахгүй» гэж
  бичигдсэн — зөв уналттай, дээрээс нь `withFillChoices` асуулт бүрд 4
  сонголт өгдөг тул тэр зам аль хэдийн хэрэглэгддэггүй.
- `quality-report` нь аль хэдийн админаар хамгаалагдсан байсан.

**Батлагдсан (бодит API, 2 өөр дүрээр):**
| Зам | Сурагч | Админ |
| --- | --- | --- |
| `GET /quizzes/:id` | түлхүүр алга ✅ | бүтэн ✅ |
| `GET /quizzes` | түлхүүр алга ✅ | бүтэн ✅ |

`POST /:id/check` → `correct: true`, `POST /:id/submit` → оноо/XP хэвийн —
хариулах урсгал огт хөндөгдөөгүй. Тест: `sanitize.spec.ts` (8 шинэ),
backend бүгд **227 ✅**.

⚠️ **Апп шинэчлэх шаардлагагүй** — сервер талын засвар тул deploy хиймэгц
хуучин суулгацууд дээр ч үйлчилнэ.

#### ✅ Choi — Бүтэн IELTS шалгалт үүсгэх + албан ёсны band (2026-08-15) · ДАВХАРДУУЛАХГҮЙ

**1. «Бүтэн шалгалт үүсгэх» — нэг товчоор бүтэн тест.** Өмнө нь админ нэг
удаад нэг л дасгал (Part 1) үүсгэдэг байсан. Одоо модулийн бүтцээр нь бүтнээр
үүснэ, хэсэг бүр өөрийн эх материалтай:

| Модуль | Бүтэц | Асуулт |
| --- | --- | --- |
| Listening | 4 Section | 10×4 = **40** |
| Reading | 3 Passage | 13+13+14 = **40** |
| Writing | 2 Task | 2 (задгай) |
| Speaking | 3 Part | 4+1+4 = 9 (задгай) |

- `POST /quizzes/ielts-paper` → background job, `GET /quizzes/bulk-generate/:jobId`-ээр явц.
- Хэсэг бүрд тусад нь AI дуудлага: (а) нэг дуудлагад 20 асуултын хязгаартай,
  (б) Section 1 нь захиалгын яриа, Section 4 нь лекц — тусад нь бичүүлэх нь
  жинхэнэ шалгалттай илүү төстэй.
- Хэсгүүдийн яриа/эх нь `--- Section 2 ---` тэмдэглэгээгээр НЭГ `passageText`-д
  цуглана; **апп зөвхөн тухайн хэсгийнхийг харуулна** (`sectionText()`) — эс
  бөгөөс 2-р хэсэг дээр 4-ийнхөө хариултыг сонсоно.
- Writing/Speaking нь `questionType: 'open_response'` тогтмол (эс бөгөөс AI
  эссэний даалгаврыг сонголтот асуулт болгодог).

**2. 📏 Band — албан ёсны хүснэгт болов.** Өмнө нь хувь хэмжээний ойролцоолол
байсан. Одоо түүхий оноо → band, Listening ба Academic Reading тус тусын
хүснэгтээр. **ielts.org-оос шалгасан** (2026-08-15, «IELTS scoring in detail»):
...
Манай хүснэгт эдгээр **8 цэг бүртэй яг таарна** (тест-д бэхлэв).
⚠️ IELTS зөвхөн эдгээрийг нийтэлдэг ба «хувилбар бүрд бага зэрэг өөр байж
болно» гэдэг. Хагас band (5.5 · 6.5…) нь **албан ёсны бус интерполяци**.
40-өөс цөөн асуулттай дасгалын оноог 40-д шилжүүлж хэмждэг тул богино дасгал
ч жинхэнэ шалгалттай ижил хэмжүүртэй.

**3. ⚠️ Reading бол 3 эх, 4 биш.** ielts.org: Academic Reading = **3 passage,
40 асуулт, 60 минут**. (4 гэж санагдах нь General Training-ийн Section 1
дотроо 2–3 богино эх агуулдагтай холбоотой.) Admin ба mobile-ын `parts`
хоёуланг 3 болгов.

**4. Нуугдсан 5 сонсголын дасгал — ЗАСАГДЛАА.** `POST /quizzes/:id/generate-script`
(админ) нь байгаа асуулт + зөв хариултаас нь AI-гаар сонсох яриа бичүүлж,
мөрийг амилуулна. Үүсгэсний дараа чанарын шалгуурыг ДАХИН ажиллуулна — AI
хариултуудыг оруулаагүй бол хадгалахгүй (худал «зассан» гэж хэлэхгүй).
Локал дээр 5/5 амжилттай: аппад харагдах сонсголын дасгал **3 → 8**, нуугдсан
мөр **0**.

**Шалгагдсан:** backend **239 тест ✅** (өмнө 227) · бодит AI-гаар Listening
40 асуулт/4 хэсэг, Writing 2 Task, Speaking 9/3 Part үүссэн · `tsc`+`eslint`
цэвэр · admin build ✅ · mobile bundle ✅.
⚠️ **Утсан дээр гараар шалгаагүй.**

#### ✅ Choi — Reading: эх бичвэр үргэлж харагдана + тэмдэглэх (2026-08-15) · ДАВХАРДУУЛАХГҮЙ

**Асуудал:** уншлагын эх нь «Эх бичвэр ↔ Асуултууд» гэсэн товчны ард байсан
тул **эх ба асуултыг зэрэг харах боломжгүй** байв — уншиж ойлгох шалгалтын
цөм нь яг тэр хоёрыг зэрэг харах явдал. Асуулт уншаад, эх рүү шилжиж, буцаж
ирээд асуултаа мартах давталт үүсдэг.

**Одоо (`components/ielts/ReadingPane.tsx`):**
- **Эх бичвэр ҮРГЭЛЖ дээр нь**, өөрийн гүйлгэлттэй; асуултууд доор нь. Аль нь
  ч нөгөөгөө нуухгүй.
- **Хураана** — толгойн ⌃ товчоор нэг мөр болгож хумина (хариултаа олчихсон
  асуулт дээр эх хэрэггүй).
- **Томсгоно** — дэлгэцийн 34% ↔ 55%. Хуваалтыг бид биш, уншигч сонгоно.
- **Тэмдэглэнэ** — үг дээр удаан дараад, нэмэх үгс дээрээ дарж сунгаад
  **«Тэмдэглэх»**. Маркер шиг шар (`warningSoft`), орчуулгын сонголтоос
  ялгаатай өнгө. Тэмдэглэгээ нь **хэсэг тус бүрээр** хадгалагдана — өөр Part
  руу очоод буцахад алдагдахгүй. Толгойд «Тэмдэглэгээ арилгах».

**`SelectableText` өргөтгөв (дундын component):** заавал биш `marks` /
`onMarksChange` prop нэмэгдсэн. Өгөөгүй үед (Унших дэлгэц) **зан төлөв яг
хэвээр** — түр сонголт + орчуулга. Өгвөл сонголтын хажууд «Тэмдэглэх» товч
гарч, тэмдэглэсэн үг сонголтоо алдсаны дараа ч өнгөтэй үлдэнэ.

Хасагдсан: `ieltsShowPassage` · `ieltsShowQuestions` түлхүүр, toggle-ийн
style-ууд (одоо ашиглагдахгүй).

⚠️ **Boju:** `SelectableText.tsx` хөндөгдсөн — шинэ prop нь **сонголтот** тул
одоо байгаа дуудлагууд өөрчлөгдөөгүй.

**Шалгагдсан:** `tsc` + `eslint` цэвэр, бүтэн апп Metro-гоор bundle болсон.
**Утсан дээр гараар шалгаагүй** — ялангуяа давхар гүйлгэлт (эх дотор гүйлгэх
vs хуудас гүйлгэх) ба тэмдэглэх дохиог нүдээр үзэх хэрэгтэй.

#### ✅ Choi — IELTS Speaking: бичих биш, ЯРИХ болов (2026-08-16) · ДАВХАРДУУЛАХГҮЙ

**Асуудал:** Ярих шалгалтын даалгаварт **бичих талбар** гарч ирдэг байв. Хэн ч
IELTS Speaking-ийг бичиж өгдөггүй — бичиж дасгал хийвэл огт өөр чадвар
дасгалжуулж байгаа хэрэг.

**Хоёр давхар шалтгаан байсан:**
1. Шалгалтын тоглуулагч `open_response`-ыг үргэлж `TextInput` болгож
   харуулдаг байсан.
2. ⚠️ **Илүү нуугдмал нь:** Ярих/Бичих хоёр миний шинэ тоглуулагч руу **огт
   ордоггүй** байв. IELTS hub нь `m.auto` биш модулиудыг
   `/ielts/practice/[category]` гэсэн **хуучин дэлгэц** рүү явуулдаг байсан —
   тэнд Part бүтэц ч, ярих боломж ч байхгүй, зөвхөн «тэмдэглэл» бичих талбар.

**Засвар:**
- **`components/ielts/SpeakingAnswer.tsx`** (шинэ) — микрофон товч, бичиж
  байгаа хугацаа, дараа нь **өөрийгөө сонсох** тоглуулалт, дахин бичих.
  `expo-audio`-ийн бичлэгийн урсгалыг Дуудлагын дасгалаас (`app/speaking.tsx`)
  дагасан: зөвшөөрөл асуух, `setAudioModeAsync` (эс бөгөөс iOS дээр чихэвчний
  чанга яригчаар тоглуулна), дуусахад буцаах.
- **Жишиг хариулт** нь одоо задгай даалгавар бүрд «Жишиг хариулт харах»
  товчоор нээгддэг (оролдохоос ӨМНӨ харвал өөрийгөө сорих утга алдагдана).
- **Дөрвүүлээ нэг зам:** hub → жагсаалт → шалгалтын тоглуулагч. Writing нь
  бичих талбартай хэвээр (тэр нь зөв), Speaking нь микрофонтой.
- Бичлэгийн зам (`file://…`) **серверт илгээгдэхгүй** — задгай хариулт хэзээ ч
  оноологддоггүй тул зөвхөн «хариулсан» гэдгийг мэдэгдэнэ.

**Оноо:** Ярих шалгалтыг шалгагч ХҮН үнэлдэг (уян хатан байдал, дуудлага, үг
хэллэгийн хүрээ) тул band гаргахгүй — үүнийг картан дээр ил бичсэн. Энэ нь
өөрийгөө сонсох → жишигтэй харьцуулах → дахин оролдох давталт.

⚠️ **`app/ielts/practice/[category].tsx` (Boju) одоо hub-аас хүрэхгүй болов.**
Файлыг устгаагүй — шууд холбоосоор нээгдэх боломжтой хэвээр. Устгах эсэхийг
Boju-тай ярилцах.

⚠️ **Expo Go дээр микрофон ажиллана** (`expo-audio` нь SDK 54-д багтсан) —
Дуудлагын дасгал аль хэдийн ингэж ажилладаг.

**🐛 Засвар (Choi мэдээлсэн, мөн өдөр): «FunctionCallException: Calling the
'pause' function has failed» + микрофон ажиллахгүй.** Хоёр шалтгаан:
1. **Гол нь:** `useEffect(() => () => player.pause(), [])` гэж unmount дээр
   зогсоодог байсан. `useAudioPlayer` нь `useReleasingSharedObject` дээр
   суурилдаг тул component салахад player-ээ **өөрөө release хийдэг** —
   cleanup доторх `pause()` нь аль хэдийн суларсан объект руу очиж унана.
   `SpeakingAnswer` ба `ExamAudioBar` хоёулаас хассан (release нь тоглуулалтыг
   мөн зогсоодог тул юу ч алдагдахгүй).
   **Дүрэм: `useAudioPlayer`-ийн cleanup дотор `pause()` бүү дууд.**
2. **Аудио сессийн булаалдаан:** Ярих Part-д 4 хүртэл даалгавар байдаг ба
   даалгавар бүр урьдчилж player үүсгэдэг байсан тул микрофонтой сесс
   булаалдаж, бичлэг эхлэхгүй байх эрсдэлтэй байв. Одоо тоглуулагч нь
   **бичлэг гарсны дараа** л mount болно (`TakePlayback`).
Мөн бичлэгийн алдаа одоо жинхэнэ мессежээ харуулна («Алдаа гарлаа» гэвэл
микрофон завгүй юу, горим солигдоогүй юү гэдгийг мэдэх аргагүй байв).

**Шалгагдсан:** `tsc` + `eslint` цэвэр, бүтэн апп Metro-гоор bundle болсон.
**Утсан дээр гараар шалгаагүй** — бичлэг хийх/сонсох, зөвшөөрлийн цонх,
iOS-ийн аудио горим солигдолтыг заавал нүдээр үзэх хэрэгтэй.

#### ✅ Choi — Өдрийн зорилт: 3 түвшин хүн тус бүрд тохирлоо (2026-08-18) · ДАВХАРДУУЛАХГҮЙ

**Асуудал:** Өдрийн зорилтын 3 сонголт (Хөнгөн 20 · Дунд 50 · Ширүүн 100) нь
хэн ч байсан хамаагүй, зүгээр л «бага/дунд/их» гэсэн хийсвэр шат байв. Мөн
тоонууд нь **бодит XP эдийн засагтай тулгаж хэзээ ч хэмжигдээгүй**: SRS давталт
нь үг тутамд 10 XP өгдөг тул **20 XP = 2 үг ≈ 30 секунд**. Өөрөөр хэлбэл
«streak хадгалсан» гэдэг нь хичээл хийсэн эсэхийг огт хэлдэггүй байлаа.

**Шинэ 3 түвшин — хүн тус бүрээр:**

| Түвшин | XP | Хэн бэ | Бодит ажил |
| --- | --- | --- | --- |
| **Сэргээх** | **30** | Англиа мэддэг, зүгээр мартахгүй байхыг хүсэгч | ~3 давтах үг эсвэл 6 зөв хариулт |
| **Тогтмол** | **80** | Жинхэнэ сурч байгаа энгийн сурагч | 1 хичээл + түүний тест (15+~50) |
| **Эрчтэй** | **200** | Гэнэт ухаараад асар их хичээл хийдэг анхан шатны хүн | 3–4 хичээл тесттэйгээ, эсвэл дүүрэн давталтын дараалал |

**Тоог хэрхэн гаргасан (XP эдийн засгаас):** хичээл 15 · унших 15 · сорил
`xpReward` (default 50) — гурвуулаа **нэг контентод ганц удаа**; давтагддаг нь
зөвхөн SRS давталт (10/үг/өдөр) ба үгийн тоглоом (5/зөв хариулт, хязгааргүй).
Streak bonus нь зорилт биелсний **дараа** олгогддог тул зорилтод тооцогдохгүй.

⚠️ **Минут ≠ XP.** Унших нь ~5 минутад 15 XP өгдөг бол үгийн тоглоом хариулт
тутамд 5 XP өгдөг — XP/минут 3-аас 60 хүртэл савладаг. Тиймээс картан дээрх
минутын тоо бол **зорилгын чиглүүлэг, хэмжилт биш**. Кодод тайлбарлагдсан.

**Хуучин хэрэглэгчдийг ЗОРИУД шилжүүлээгүй.** 50 XP-тэй яваа хүнийг 80 болгож
өргөвөл өчигдөр амжиж байсан хүн маргааш амжихгүй болж **streak-ээ алдана**.
Тиймээс:
- Хуучин утга (20/50/100) DB-д хэвээр; хүн өөрөө сонгох цонхоо нээж
  сольтол хуучин зорилтоороо явна. **Migration хийгээгүй.**
- `goalTier()` нь хуучин утгыг өөрийг нь орлуулсан мөр рүү зурааслаад тэр мөрийг
  «сонгогдсон» гэж харуулна, дээр нь **«Одоогийн зорилт чинь 50 XP»** гэж
  үнэнээр нь бичнэ — тухайн шатны тоог нь өөрийнх юм шиг дүр эсгэхгүй.
- Backend-ийн `DAILY_GOAL` fallback (goal тавиагүй хуучин мөрүүд) мөн **50
  хэвээр** — яг тэр шалтгаанаар.

**⚠️ Backend (Өсөхбаяр — 2 файл, хянана уу):**
- `xp.service.ts` → `DAILY_GOAL_CHOICES = [30, 80, 200]` + шинэ
  `LEGACY_DAILY_GOALS = [20, 50, 100]` export.
- `dto/set-goal.dto.ts` → хуучин 3 утгыг **бас хүлээж авна**. Учир нь шинэчлээгүй
  апп (OTA/Expo Go) 50 илгээсээр байх бөгөөд түүнийг 400-аар унагавал
  хэрэглэгчийн өөрийнх нь зорилт сонгох цонх эвдэрнэ.
- **Migration шаардлагагүй, шинэ env алга.**

**Deploy дараалал:** backend **эхэлж эсвэл хамт** гарна. Эс бөгөөс шинэ апп 200
илгээгээд 400 иднэ. Урвуу зүгт (backend түрүүлсэн) ямар ч эвдрэл алга.

**Онбординг:** `MINUTES_TO_DAILY_XP` = 5→30 · 10→80 · **15→80** · 20→200.
15 минут нь 200 руу **зориуд харайгаагүй** — 200 XP-г 15 минутад авахын тулд
хамгийн их төлдөг дэлгэц дээр л сууна. Хүрэхгүй зорилт тавих нь амласан
streak-ийг нь авч үлдэх тул хоёрдмол утгатай газарт **доогуур талд нь эндүүрсэн**.

**Хөндсөн файл:** `api/gamification.ts` (`DAILY_GOAL_CHOICES`, шинэ `goalTier()`),
`components/DailyGoalSheet.tsx`, `lib/onboardingAnswers.ts`, `i18n/index.ts`
(шинэ түлхүүр `dailyGoalCurrentLegacy`; MN+EN).

**Шалгагдсан:** mobile `tsc` цэвэр, backend `tsc` цэвэр, `src/xp` **40 тест
ногоон**. Утсан дээр гараар шалгаагүй — цонхны 3 мөр + хуучин зорилттой
хэрэглэгчийн «Одоогийн зорилт» мөрийг нүдээр үзэх хэрэгтэй.

⚠️ **Boju:** `app/(tabs)/soril.tsx`-ийн `DAILY_GOAL_FALLBACK = 50` **хөндөөгүй**
(дундын файл). Энэ нь зөвхөн `gam` ачаалагдаж дуустал харагддаг түр утга тул
эвдрэл үүсгэхгүй, гэхдээ хүсвэл 80 болгож жигдрүүлж болно.
...
| Ажил | Owner | Тайлбар |
| --- | --- | --- |
| **Reading шинэчлэлт** | Choi | ✅ (2026-08-14) Ахиц хадгалах · номын сан (Үргэлжлүүлэх + CEFR шүүлт) · шинэ үгийн статистик · аудио дагаж унших. Дэлгэрэнгүй → §3 Choi. Үлдсэн: бодит утсан дээр турших |
...
#### ✅ Choi — Багшийн даалгавар мэдрэгддэг боллоо + үнэгүй 3 хичээлийн квот (2026-08-19) · ДАВХАРДУУЛАХГҮЙ

Дизайн баримт: `docs/superpowers/specs/2026-08-19-assignments-and-free-lesson-quota-design.md`
Салбар: `feat/choi-assignments-and-free-lessons`

**Судалгаанаас гарсан зүйл:** даалгаврын систем аль хэдийн ~60% баригдсан байсан
(`assignments` + `assignment_completions` нь `dueAt` · `note` · `studentIds` ·
`scorePct` · `attemptCount`-той, багшийн assign дэлгэц, сурагчийн жагсаалт бүгд
бэлэн). Шинээр бариагүй — **дутуу 4 нүхийг л нөхсөн.**

**🐛 Олдсон бодит алдаа: `GET /notifications/me` БАЙХГҮЙ байсан.** Апп түүнийг
дуудсаар байсан ба мэдэгдлийн төв 404 иддэг байв. Хэн ч анзаараагүйн шалтгаан нь
`app/notifications.tsx`-ийн `catch` нь `DEV_MOCK_NOTIFICATIONS` үзүүлээд
`setError(false)` хийдэг байсан — **алдааг хуурамч датагаар нуусан**. Endpoint
бичигдсэн, mock-ууд (`notificationCenter.ts` + `useUnreadNotifications.ts`-ээс
хамт) **бүрмөсөн устгагдсан**.

**1. Даалгавар өгөхөд сурагч руу мэдэгдэл очдог боллоо.** `POST /assignments`
одоо зорилтот сурагч бүрд мэдэгдлийн мөр + push илгээнэ («Багш "X" даалгавар
өглөө. 3 хоногийн дараа дуусна.»). `notifications` хүснэгтэд `user_id` (NULL =
хуучинтай ижил broadcast) ба `data` jsonb (deep link) нэмэгдэв. Push дарахад
шууд `/assignments` руу очно (`usePushTapRouting`, `app/_layout.tsx`-д залгагдсан).
Илгээлт **best-effort** — push унасан ч даалгавар үүсгэх нь бүтэлгүйтэхгүй.
- ⚠️ Push нь **Expo Go дээр ажиллахгүй** (SDK 53-аас хасагдсан) → зөвхөн dev/prod
  build дээр шалгагдана. Мэдэгдлийн төвийн жагсаалт нь Expo Go дээр ажиллана.
- Migration: `AddPersonalNotifications1787600000000`.

**2. Assign дэлгэцэд хайлт + шүүлт.** Өмнө нь бүх хичээл/сорилыг нэг урт
жагсаалтаар татаж, **гарчгаар** нь буцааж хайдаг байсан (ижил нэртэй 2 хичээл
байвал буруу нь оногдоно). Одоо нэрээр хайх талбар + түвшин/ангиллын chip мөр,
сонголт нь **id-гаар** шийдэгдэнэ. Chip-ууд бодит датаас үүснэ (хоосон түвшин
харагдахгүй). Шинэ дундын компонент: `src/components/FilterChips.tsx`.

**3. Даалгаврын оноо/хугацаа ил боллоо.** «8-р сарын 22» гэсэн огноо нь одоо
**«3 өдөр үлдлээ» · «Маргааш дуусна» · «Өнөөдөр дуусна» · «Хугацаа хэтэрсэн»**
(`src/lib/dueDate.ts`, өнөөдөр/маргааш нь шар өнгөөр). Оноог **хийхээс өмнө**
харуулна: сорил → «100 оноотой» → дүнгээ авсны дараа «Дүн 80 / 100»; хичээл →
«Үзэхэд хангалттай» (хичээл дүн авдаггүй тул тоо зохиогоогүй).
- **Оноо = дүн % хэвээр, XP олгохгүй** (`API.md` §6a хөндөгдөөгүй) — эс бөгөөс
  багш нэг сорилыг дахин дахин оноож XP тариалах зам нээгдэнэ.

**4. Үнэгүй 3 хичээлийн квот — бүрэн бэлэн, ГЭХДЭЭ УНТРААЛТТАЙ.**
`lesson_unlocks` нь одоо хичээлийн хандалтын **цорын ганц бүртгэл**
(`source`: `sparks` · `free` · `assignment` · `legacy`). Дүрэм:
багц → бүх хичээл · unlock мөр → тухайн хичээл үүрд · **багшийн даалгавар →
үнэгүй, квотод тооцогдохгүй** · үлдсэн эрх → «Эхлэх» · үгүй бол «Багц авах».
- ⚠️ **`FREE_LESSON_QUOTA_ENABLED=false` (анхдагч) — QPay бэлэн болтол ХЭВЭЭР.**
  `PAYMENTS_ENABLED` мөн хаалттай тул асаавал сурагчийг хааж байгаад мөнгө авах
  боломжгүй болно. Унтраалттай үед зан төлөв **яг өнөөдрийнхтэй ижил**.
- 🔒 **Paywall нь сервер талд.** `GET /lessons/:id` эрхгүй хүнд `content`-ыг
  хоосноор буцаана → аппыг тойрч видеоны URL авах боломжгүй. Шинэ
  `OptionalJwtAuthGuard` (нэвтрээгүй хүн гарчиг/тайлбар уншсан хэвээр).
- ⚠️ **Хуучин хэрэглэгч хамгаалагдсан:** migration нь `xp_logs`-оос дуусгасан
  хичээл бүрд `legacy` мөр үүсгэнэ → өмнө үзсэн нь үүрд нээлттэй + 3 шинэ эрх.
  Хэн ч юм алдахгүй. **Railway дээр `DB_MIGRATIONS_RUN=true` шалга.**
- Квот **зөвхөн хичээлд**: Дасгал · Сорил · Унших · Хэлц · Толь · SRS үнэгүй хэвээр.
- Migration: `AddLessonUnlockSource1787700000000`. Тест: 16 (`lesson-access.spec.ts`).

**Хөндсөн файл:**
- Backend: `notifications/*`, `assignments/*`, `lessons/lesson-access.service.ts`
  (шинэ), `lessons/lessons.controller.ts`, `lessons/lessons.module.ts`,
  `sparks/sparks.controller.ts` (`/access` зам эндээс **гарсан**),
  `auth/guards/optional-jwt-auth.guard.ts` (шинэ), `entities/notification.entity.ts`,
  `entities/lesson-unlock.entity.ts`, `common/enums`, 2 migration, `.env.example`.
- Mobile: `api/notifications.ts`, `api/lessons.ts`, `lib/pushRegistration.ts`,
  `lib/notificationCenter.ts`, `lib/useUnreadNotifications.ts`, `lib/dueDate.ts`
  (шинэ), `components/FilterChips.tsx` (шинэ), `components/AssignmentRow.tsx`,
  `app/_layout.tsx`, `app/notifications.tsx`, `app/assignments.tsx`,
  `app/lesson/[id].tsx`, `app/(teacher)/class/[id]/assign.tsx`, `i18n`.

**Шалгагдсан:** backend `tsc` + eslint цэвэр, **295 тест ногоон** (16 шинэ);
mobile `tsc` + eslint цэвэр. ⚠️ **Утсан дээр гараар шалгаагүй** — ялангуяа push
(dev build шаардана) ба квотын дэлгэц (`FREE_LESSON_QUOTA_ENABLED=true` тавьж
локал дээр үзнэ).

**Deploy дараалал: backend ЭХЭЛЖ эсвэл хамт.** Урвуугаар гарвал шинэ апп
`/lessons/:id/open` рүү 404 авна. Backend түрүүлбэл эвдрэл алга.

⚠️ **Өсөхбаяр — хянана уу:** энэ багц `/backend` хөндсөн (мэдэгдэл, хичээлийн
хандалт, 2 migration, 1 шинэ env). Ажлын хуваарийн дагуу чиний талбар.

⚠️ **Boju:** `app/(teacher)/class/[id]/assign.tsx` (багшийн хэсэг) хөндөгдсөн —
Choi хийхээр тохирсон. Мөн дундын `AssignmentRow` нь одоо `overdue` prop
**авахаа больсон** (огноог өөрөө тооцно) — чиний `class/[id].tsx` дэх дуудлага
тэр prop дамжуулдаггүй тул эвдрээгүй.

#### ✅ Choi — Багш хэн хийж, хэн хийгээгүйг хардаг боллоо (2026-08-19) · ДАВХАРДУУЛАХГҮЙ

**Асуудал:** багш даалгавар өгсний дараа **хэн хийснийг харах газар байгаагүй**.
Сурагч тус бүрээр нь (`class/[id]/student/[studentId]`) харах боломжтой байсан ч
30 сурагчийг нэг нэгээр нээж үзнэ гэсэн үг — «энэ даалгаврыг хэн хийгээгүй вэ?»
гэдэг нэг ч дэлгэцээс уншигдахгүй байв.

**🐛 Үхмэл код олдсон:** `GET /assignments/:id/submissions` backend дээр бүрэн
ажиллаж байсан, `mobile/src/api/teacher.ts`-д `getAssignmentSubmissions()` ч
бичигдсэн байсан — гэтэл **хаанаас ч дуудагддаггүй** байв. Өөрөөр хэлбэл
өгөгдөл бэлэн байсан атлаа харуулдаг UI нь хэзээ ч холбогдоогүй.

**Одоо:**
- Ангийн дэлгэцийн даалгавар бүр дээр **`8/12`** гэсэн ахицын тэмдэг (👥 дүрстэй).
  Бүгд хийсэн бол **ногоон** — багш жагсаалтаа гүйлгэхэд алгасах мөрөө шууд танина.
  `completedCount` backend-ээс өмнөөс ирдэг байсан, зүгээр л харуулаагүй байв.
- Даалгавар дээр дарахад **тэр мөрөн дороо дэлгэгдэнэ** (шинэ дэлгэц НЭМЭЭГҮЙ):
  **«Хийгээгүй» бүлэг ЭХЭНД**, дараа нь «Хийсэн» + оноо. Дуусгасан сурагчдыг
  дээр тавивал багшийн яг хайж буй нэрс доор дарагдана.
- Жагсаалт нь **залхуу татагдана** (дэлгэх үед л) — 20 даалгавартай анги нээхэд
  20 хүсэлт явахгүй. Нэг дор зөвхөн нэг мөр дэлгэгдэнэ.

**Шинэ:** `src/components/SubmissionList.tsx`. `AssignmentRow`-д `progress` ба
`expanded` **сонголтот** prop нэмэгдсэн (сурагчийн талын дуудлага хөндөгдөөгүй).

**Backend өөрчлөлт ШААРДЛАГАГҮЙ** — бүх өгөгдөл аль хэдийн ирдэг байсан.

**Шалгагдсан:** mobile `tsc` + eslint цэвэр. ⚠️ Утсан дээр гараар шалгаагүй.

⚠️ **Boju:** `app/(teacher)/class/[id].tsx` (чиний эзэмшил) хөндөгдсөн — Choi
хийхээр тохирсон. Дундын `AssignmentRow`-гийн шинэ prop-ууд бүгд optional тул
чиний бусад дуудлага эвдрээгүй.

#### ✅ Choi — Даалгавар «өнөөдөр ирсэн» нь мэдэгддэг боллоо (2026-08-19) · ДАВХАРДУУЛАХГҮЙ

**Асуудал (Choi):** «өмнөх хийсэн юм харагдсаар байгаа учир өнөөдөр аль нь ирсэн
гэдэг нь мэдэгдэхгүй байна». Жагсаалт **дуусах хугацаагаар** эрэмбэлэгддэг
байсан тул өнөөдөр ирсэн даалгавар аль хэдийн дуусгасан мөрүүдийн дор дарагдаж
байв. Мөн Home дээрх «Миний даалгавар» карт бол зүгээр л **хөдөлгөөнгүй мөр** —
push-ыг арчсан (эсвэл зөвшөөрөл өгөөгүй) сурагч даалгавар ирснийг мэдэх ямар ч
арга байгаагүй.

**Одоо:**
- **Эрэмбэ өөрчлөгдсөн:** хийгээгүй нь эхэнд, тус бүрдээ **шинэ нь дээр**
  (`createdAt` буурахаар). Яаралтай эсэх нь алдагдаагүй — мөр бүр дээрээ
  «3 өдөр үлдлээ» тоолуураа авч явна.
- **«ШИНЭ» тэмдэг** — сүүлд жагсаалтаа нээснээс хойш ирсэн мөрд улаан pill.
  Тэмдэглэгээг **уншсаны ДАРАА** шинэчилдэг тул нэг зочилох хугацаанд алга
  болохгүй (`assignments.lastSeen`, AsyncStorage).
- **Ирсэн цаг** мөр бүрд («2 цагийн өмнө» · «өчигдөр»).
- **Home-ийн карт амьд боллоо:** хүлээгдэж буй тоо («3 даалгавар хүлээгдэж
  байна») + шинэ зүйл ирсэн бол **ШИНЭ** pill. `useAssignmentBadge(enrolled)`
  нь ангид элссэн сурагчид л хүсэлт явуулна.

⚠️ **Анх удаа нээхэд бүгдийг «ШИНЭ» гэж хашгирахгүй.** `lastSeen` хоосон үед
харьцуулах зүйл байхгүй тул **сүүлийн 24 цаг** руу шилжинэ — эс бөгөөс хэдэн
долоо хоногийн өмнө дуусгасан даалгавар «ШИНЭ» болно (`isRecent`).

**Шинэ/дундын файл:**
- `src/lib/timeAgo.ts` — `timeAgo()` нь `notifications.tsx` дотор түгжээтэй
  байсныг гаргаж дундын болгов (DRY; хоёулаа «өнөөдөр ирсэн үү?» гэдгийг
  хариулдаг). `isRecent()` мөн энд.
- `src/lib/useAssignmentBadge.ts` — Home-ийн badge + `markAssignmentsSeen()`.
  Мэдэгдлийн хонхны (`useUnreadNotifications`) яг тэр хэв маяг.

**Backend өөрчлөлт ШААРДЛАГАГҮЙ** — `createdAt`/`status` аль хэдийн ирдэг.

**Шалгагдсан:** mobile `tsc` + eslint цэвэр. ⚠️ Утсан дээр гараар шалгаагүй.

⚠️ **Boju:** `app/(tabs)/index.tsx` (дундын файл) хөндөгдсөн — зөвхөн «Миний
даалгавар» картын дотор тал (badge) + 2 style нэмэгдсэн.

#### ✅ Choi — Даалгаврын сан: багшийн контент + асуултаар сонгож оноох (2026-08-20) · ДАВХАРДУУЛАХГҮЙ

**Choi:** «pre made assignment-ийг зөвхөн багшид харагддаг болгоно… сурагчид
шууд сонгож орж өөрөө хийж болохгүй, заавал багшаас даалгавар авч байж
тэр хэсгийг харж чаддаг байх. Нэг тест 15 дасгалтай — багш 5 даалгавар өгнө
нэг хичээл дээр», «2 сэдвийн даалгаварч оруулж болох тул сайн салгаж ялгаж
явуулдаг харагдуулдаг байх — жишээ нь Present Simple, Modal verbs 2-ийн
даалгавруудыг сонгож явуулж болдог болгох».

**Хоёр шинэ багана — өөр юу ч эвдээгүй** (migration `AddAssignmentBank1787800000000`):

| Багана | Утга | Анхдагч |
| --- | --- | --- |
| `quizzes.assign_only` | Зөвхөн багш хардаг сан | `false` → **байгаа контент бүхэлдээ хэвээр** |
| `assignments.question_indexes` | Багшийн сонгосон асуултууд | `NULL` = бүгд → **өгсөн даалгавар бүр хэвээр** |

**Аюулгүй байдал нь сервер дээр.** Сурагчийн 4 зам БҮГД хаагдана: жагсаалт
(`findAll` нь SQL түвшинд `assign_only = false` шүүнэ), нээх, `/check`,
`/submit`. Аппын шүүлт хийгээгүй — тэр нь DevTools-оор тайлагдана. Цорын
ганц хаалга нь оногдсон `assignments` мөр. `assignmentId` бол **итгэмжлэл
биш**: `findStudentAssignment` нь «энэ сурагчийнх мөн үү, энэ quiz руу
заасан уу» гэж бүр удаад шалгана.

**Асуултын дэд олонлог** (`assignments/question-subset.ts`, 11 unit тест):
сервер сурагч руу явахдаа асуултуудыг шүүж **0..n-1 болгон дахин
дугаарлана**. Тиймээс `getQuiz`/`check`/`submit` гурвуулаа `assignmentId`
дамжуулна — эс бөгөөс сурагчийн 3 дахь асуулт эх тестийн 3 дахь асуулттай
тулгагдана. Дараа нь админ тестээс асуулт хассан ч унахгүй (алгасна; нэг ч
үлдэхгүй бол бүтэн тест).

**2 сэдэв нэг дор.** `POST /assignments` одоо `targets: [{ targetId,
questionIndexes }]` авна → сэдэв бүр **өөрийн даалгаврын мөр**, харин
**мэдэгдэл нэг** (5 push илгээх нь шийтгэл). ⚠️ **Хариу нь одоо массив** —
хуучин `targetId` хэлбэр хэвээр ажиллана.

**Гарчиг серверээс ирдэг болов** (`targetTitle` · `targetTopic` ·
`questionCount`). Урьд нь апп бүх хичээл+сорилыг татаад id-гаар нь
тааруулдаг байв — сангийн тест тэр жагсаалтад байхгүй тул «—» гарах байлаа.
Даалгаврын дэлгэц ба багшийн ангийн дэлгэц дээр **2-2 илүү хүсэлт хасагдсан**.

**Мөн засагдсан бодит алдаа:** апп `assignmentId`-г `/submit` рүү **огт
илгээдэггүй** байсан → багшийн самбарт «хийсэн» гэж хэзээ ч тэмдэглэгддэггүй
байв.

**Админ (Дасгал хуудас):** «Бүгд · Сурагчид нээлттэй · Даалгаврын сан»
хамрах хүрээний таб (тоотой), формд «Зөвхөн даалгавраар» checkbox, импортод
мөн, багц үйлдэлд «Даалгаврын сан руу» / «Сурагчид нээх». **Сэдэв нь одоо
чөлөөт текст** (`datalist` — сонгох ЭСВЭЛ шинээр бичих): «Present Simple»
гэх дүрмийн сэдвүүдийг урьдчилан таамаглах боломжгүй. UI нь
`components/AssignmentBank.tsx`-д (`Publish.tsx`-ийн зарчмаар — хуудсанд
давтаж бичихгүй).

**Багшийн апп:** сорил оноохдоо `QuestionPicker` — сэдвээр шүүж, тест
задалж, асуулт бүрийг тэмдэглэнэ. Сэдэв солиход сонголт **хэвээр үлдэнэ**
(олон сэдэв нэг илгээлт). Доор «7 асуулт · 2 сэдэв» гэж хураангуйлна.

**Шалгагдсан:** backend `tsc` цэвэр · unit 122 ✅ · e2e-д **5 шинэ тест**
(сан сурагчид нуугдсан эсэх · багшид харагдах эсэх · даалгаваргүй бол 403 ·
дэд олонлог + дахин дугаарлалт · `/check` зөв индексээр) бүгд ✅. admin +
mobile `tsc`/eslint цэвэр.
⚠️ **Утсан дээр гараар шалгаагүй** — контент оруулсны дараа нүдээр батал.

⚠️ **Prod deploy:** Railway дээр `DB_MIGRATIONS_RUN=true` эсэхийг шалгаж
байж deploy хий. Мобайл шинэ bundle **шаардлагатай** (даалгавраас сорил
нээхэд `assignmentId` дамжуулах шинэ зан төлөв).

⚠️ **Boju:** `app/quiz/[id].tsx` ба `src/components/AssignmentRow.tsx`
(дундын файлууд) хөндөгдсөн — `assignmentId` param + мөрөнд сэдэв/асуултын
тоо нэмэгдсэн. Хуучин дуудлагууд бүгд хэвээр ажиллана (шинэ param нь
optional).

⚠️ **Өсөхбаяр:** `/backend` хөндөгдсөн (Choi мобайл эзэн боловч энэ ажил BE
шаардсан) — `quizzes` (controller/service/sanitize/DTO), `assignments`
(service/DTO + шинэ `question-subset.ts`), 2 entity, 1 migration. `API.md`
§16 шинэчлэгдсэн. Хянаад merge хийнэ үү.

---

#### ✅ Choi — Home-ийн дараалал + өдрийн зорилтын карт нимгэрлээ (2026-08-19) · ДАВХАРДУУЛАХГҮЙ

**Choi:** «даалгавар нь review words-ийн дээр байхгүй бол доошлоод харагдахгүй
болохоор даалгавар ирсэнийг ч мэдэхгүй байж магадгүй», «бас үзээрэй гэдгийг
чансааны дээр гаргая, тэгэхгүй бол доошоо хэрэгтэй юмнууд байхаар харагдахгүй»,
«daily goal хэтэрхий их зай эзэлж том харагдаж байна».

**Шинэ дараалал** (Үргэлжлүүлэх → Өдрийн зорилт хүртэл хэвээр):

| Өмнө | Одоо |
| --- | --- |
| Давтах үгс | **Миний даалгавар** |
| Миний даалгавар | Давтах үгс |
| … Эвент → **Чансаа** → Бас үзээрэй | … Эвент → **Бас үзээрэй** → Чансаа |

- **Даалгавар нь давталтын дээр гарсан шалтгаан:** даалгаварт **эцсийн хугацаа**
  бий, хүнээс ирдэг — алдвал сурагчид бодит үнэ өртөгтэй. Давталт тийм биш.
- **«Бас үзээрэй» нь чансааны дээр:** IELTS/Хэлц бол *хийх* зүйл, чансаа бол
  *харах* зүйл. Урт leaderboard картын ард орсноор эдгээр рүү хүрдэггүй байв.

**Өдрийн зорилтын карт (`DailyGoalCard`) — ~88px → ~64px:**
- **3 мөр → 2 мөр.** Том үсгээр бичсэн «ӨДРИЙН ЗОРИЛТ» overline мөр устаж,
  гарчиг ба тоо **нэг мөрөнд** нийлсэн (цагираг өөрөө «ахиц» гэдэг утгыг аль
  хэдийн үүрч байгаа тул давхар хэлэх шаардлагагүй).
- Цагираг **56 → 40** (stroke 7 → 5), доторх дүрс 22 → 16.
- `paddingVertical` `md` → `sm`; засах дүрс дээд талд өлгөөтэй байсныг **төвд**.
- Мэдээлэл юу ч алдагдаагүй — тоо, үлдэгдэл, дуусгасан төлөв бүгд хэвээр.

**Backend өөрчлөлт ШААРДЛАГАГҮЙ.** Шалгагдсан: mobile `tsc` + eslint цэвэр.
⚠️ Утсан дээр гараар шалгаагүй — өндрийн өөрчлөлт нүдээр баталгаажуулах хэрэгтэй.

⚠️ **Boju:** `app/(tabs)/index.tsx` (дундын файл) — JSX блокууд **байрлалаа
сольсон** (агуулга нь хэвээр). Энэ файлд өөрчлөлттэй бол merge-д анхаар.
`DailyGoalCard` нь Home-оос өөр газар ашиглагддаггүй.

---

#### ✅ Choi — Даалгаврын жагсаалтын мөр цэгцрэв (2026-08-20) · ДАВХАРДУУЛАХГҮЙ

**Choi:** «хэзээ ирсэнийг нь тэгж сонин ангилж харагдуулахгүй, ерөнхий
notify-ийн хэсэг шиг харуул; мөн ‘not done’ гэдгийг илүү гоёор шийд; доор нь
байгаа ‘just watch it through’ · ‘out of 100’ гэх мэтийг замбараагүй
байлгахгүй гоё болго».

**Асуудал:** нэг мөрөнд 4 шошго зэрэгцэж байв — улаан «ШИНЭ» бөмбөлөг, саарал
«Хийгээгүй» бөмбөлөг, «100 оноотой» / «Үзэхэд хангалттай», хамгийн ард
цагийн бичиг. Гурав нь сурагчийн **хийж чадах юм биш** (оноо нь хараахан
байхгүй, «Хийгээгүй» нь мөр өөрөө хэлж байгааг давтаж байсан).

| Өмнө | Одоо |
| --- | --- |
| Шүүлт байхгүй — бүгд нэг овоо | **3 таб: «Бүгд · Хийх ёстой · Хийсэн»** (`PeriodTabs`, таб бүр дээрээ тоотой) |
| Мөр бүр дээр «23 цагийн өмнө» гэсэн бичиг | **Өдрөөр бүлэглэсэн гарчиг:** ӨНӨӨДӨР · ӨЧИГДӨР · СҮҮЛИЙН 7 ХОНОГ · ӨМНӨХ (мөрөн дээрх цаг **бүрмөсөн хасагдсан**) |
| Саарал «Хийгээгүй» бөмбөлөг | **«Эхлэх →» / «Үзэх →»** үйлдлийн чип (primary) |
| «100 оноотой» · «Үзэхэд хангалттай» | *огт байхгүй* — оноо зөвхөн **бодитоор гарсан үед** («85 / 100» ✓ ногоон) |
| «Хоцорсон» саарал текст | ⏱ шар чип + оноо |
| Улаан «ШИНЭ» бөмбөлөг | Мэдэгдлийн «уншаагүй» хэлбэр: **картаа бүхэлд нь primary өнгөөр** + улаан биш **primary «ШИНЭ»** |

- **Таб нь `PeriodTabs`** (чансаа · хадгалсан үгсийнхтэй ижил сегмент) —
  шинэ компонент бичээгүй. Таб дээрх тоо нь «хэд нь үлдсэн бэ» гэсэн, сурагчийн
  энэ дэлгэцийг нээдэг цорын ганц асуултын хариу.
- **Хоосон таб нь юу болсныг хэлнэ:** «Хийх ёстой» хоосон бол *«Бүгдийг нь
  хийчихсэн!»*, «Хийсэн» хоосон бол *«Дуусгасан даалгавар алга»* — «илэрц алга»
  гэсэн хуурай мессеж биш.
- **Бүлэглэлт нь мэдэгдлийн төвийн яг тэр код** — `notificationCenter.ts`-ийн
  `bucketOf()`-г ашигласан (хуулбарлаагүй). Бүлэг доторх эрэмбэ: **хийгээгүй нь
  эхэлж**, дараа нь шинэ нь.
- Улаан = алдаа. Шинэ даалгавар бол алдаа биш урилга тул мэдэгдлийн төвийн
  `cardUnread` (primarySoft дэвсгэр + primary хүрээ) хэлийг ашигласан.
- Мөр одоо **гарчгийн блок → нимгэн зураас → мета мөр** гэсэн 2 давхаргатай.
  Баруун талд **үргэлж ганц чип** — юу дарахаа эсвэл ямар дүн авснаа хэлнэ.
- `StatusBadge` **багшийн дэлгэцүүдэд хэвээр** (тэнд «Хийгээгүй» нь сурагч тус
  бүрийн бодит төлөв тул утгатай). Зөвхөн сурагчийн жагсаалтаас хасагдсан.
- `AssignmentRow`-д **өөрчлөлт ОРООГҮЙ** (Boju/багшийн талтай дундын файл) —
  `onPress` дамжуулахаа болиход chevron нь өөрөө алга болж, дарах үйлдлийг
  `Card` авсан.

⚠️ **Дундын файл `src/lib/notificationCenter.ts` өөрчлөгдсөн:** `TimeBucket`-д
**`week`** (сүүлийн 7 хоног) бүлэг нэмэгдэж, `BUCKET_ORDER` · `BUCKET_LABEL`
экспортлогдов (өмнө нь шошгын хүснэгт `notifications.tsx` дотор байсан —
одоо хоёр дэлгэц нэг эх сурвалжаас уншина). Үүний үр дүнд **мэдэгдлийн төв
дээр ч** «Өмнөх» доторх сүүлийн 7 хоног тусдаа хэсэг болж салсан.

**i18n:** `assignmentScore` · `assignmentMaxScore` · `assignmentLessonNoScore`
· хэрэглэгддэггүй байсан `assignmentArrived: 'Ирсэн:'` устсан;
`assignmentOpenQuiz` · `assignmentOpenLesson` · `assignmentScoreOf` ·
`notifGroupWeek` · `assignmentFilterTodo` · `assignmentFilterDone` ·
`assignmentAllDone(Hint)` · `assignmentNoneDone(Hint)` нэмэгдсэн
(«Бүгд» таб нь байсан `filterAll`-ыг ашиглана).
...
#### ✅ Choi — Өдрийн зорилт: карт → streak-ийн доорх бяцхан цагираг (2026-08-20) · ДАВХАРДУУЛАХГҮЙ

**Choi:** «daily goal-ийг тэгж уртаар нь биш жижгэн бөөрөнхий болгоод нэг
хэсэгт нь болгоё, streak-ийн доор ч юм уу».

**Асуудал:** 08-19-нд карт 88 → 64px болж нимгэрсэн ч **бүтэн мөр** хэвээр байв
— хуудсын нэг эгнээ хоёр тоонд зарцуулагдаж, гэрэлтдэг «Үргэлжлүүлэх» картын
доор өрсөлдөж байсан. Дунд шатанд (энэ л ажлын эхний оролдлого) hero дээрх
`StatPill` болгосон ч тэр нь дахиад **өргөн капсул** («12/50 · Зорилт») болж,
яг зугтаж байсан хэлбэр рүүгээ буцаж байв.

| Өмнө | Одоо |
| --- | --- |
| `DailyGoalCard` — биед байрлах бүтэн өргөнтэй зурвас | Hero дээрх **40×40 дугуй** товч (`goalDial`) |
| Цагираг + «Өдрийн зорилт 30/50 XP» + засах дүрс | Зөвхөн **цагираг**, дотор нь өнөөдрийн XP (биелсэн бол ✓) |
| Байрлал: «Үргэлжлүүлэх» картын доор | **Streak pill-ийн яг доор** — өдөр тутмын хоёр тоолуур нэг хосоор уншигдана |

- **Компонент нэр солигдов:** `DailyGoalCard` → **`DailyGoalRing`**
  (`src/components/DailyGoalRing.tsx`). Одоо зөвхөн цагирагийг зурна; бүрхүүл,
  дарах үйлдэл, шошгыг дуудагч тал өгнө. Шинэ prop: `showValue` (цагирагийн
  дотор өнөөдрийн XP) · `valueColor` (hero дээр цагаан) · `track` (артворк дээр
  тунгалаг цагаан — theme-ийн `surfaceAlt` шөнийн тэнгэрт алга болдог).
- **Дугуй нь pill-ээс 4px намхан (40 vs 44)** — streak-ийн хажуугийн нэмэлт
  тэмдэг мэт уншигдана, тэнцүү жинтэй хоёр дахь стат мэт биш. 40pt нь дарах
  талбайн доод хязгаараас доош ороогүй.
- Бүрхүүл нь pill-үүдтэй ижил (`HERO_PILL` дэвсгэр + ягаан hairline + гэрэлтэлт)
  тул тэр багцад харьяалагдана.
- Зорилтын **тоо** (50/100) одоо мөрөн дээр биш — нэг товшилтын цаана
  `DailyGoalSheet` дотор. Цагираг өөрөө «хэр явж байна» гэдгийг хэлдэг.
- i18n: `dailyGoalShort` («Зорилт»/«Goal») нэмэгдээд шаардлагагүй болсон тул
  **устсан**. `dailyGoalProgress` нь одоо accessibility label-д ашиглагдана.

**Backend өөрчлөлт ШААРДЛАГАГҮЙ.** Шалгагдсан: mobile `tsc` + eslint цэвэр.
⚠️ Утсан дээр гараар шалгаагүй — hero дээрх байрлалыг нүдээр батал.

⚠️ **Boju:** `app/(tabs)/index.tsx` (дундын файл) hero блок дахин зассан;
`DailyGoalCard` файл байхгүй болсон (`DailyGoalRing`) — Home-оос өөр газар
ашиглагддаггүй тул merge-д зөвхөн энэ файл хамаарна.

---

#### ✅ Choi — Даалгавар оноох дэлгэцийн уналт + багшийн «хэд нь хийсэн» (2026-08-20) · ДАВХАРДУУЛАХГҮЙ

**1) `Uncaught (in promise) API Error: limit …` ЗАСАГДСАН.**
Багш «Даалгавар оноох» дарахад дэлгэц ачаалахгүй, Expo улаан дэлгэц гардаг байв.

- **Шалтгаан:** `assign.tsx` нь `getLessons(token, { limit: 200 })` дууддаг байсан
  ч `QueryLessonsDto.limit` дээр **`@Max(100)`** байдаг →
  `400 ["limit must not be greater than 100"]`. Prod дээр батлагдсан:
  `GET /api/lessons?isPublished=true&limit=200` → **400**, `…&limit=100&page=1` → **200**.
- **Хоёр дахь шалтгаан:** тэр `Promise.all` нь `try { … } finally { … }` дотор,
  **`catch` огт байхгүй** байсан тул алдаа баригдалгүй унаж «Uncaught (in promise)»
  болдог байв.
- **Засвар:** `CONTENT_LIMIT = 200` → `PAGE_LIMIT = 100` + `fetchAll()` туслах
  (хамгийн ихдээ `MAX_PAGES = 5` хуудас = 500 мөр). `getLessons`/`getQuizzes`
  хоёулаа `page` параметр авдаг боллоо. `catch` нэмэгдэж, татаж чадаагүй үед
  хоосон талбарын оронд **`EmptyState` + «Дахин оролдох»** гарна.
- ⚠️ **Дүрэм:** `GET /lessons`-ийн `limit` **100-аас хэтэрч болохгүй**. Илүү
  контент хэрэгтэй бол `page`-ээр давт (`src/api/lessons.ts`-ийн тайлбарт бий).

**2) Багшийн даалгаврын UI — «хэд нь хийсэн» нь гол мэдээлэл боллоо.**

| Өмнө | Одоо |
| --- | --- |
| Мета мөрийн хамгийн ард «👥 8/12» гэсэн жижиг бичиг (төрөл · сэдэв · асуулт · хугацаатай нэг эгнээнд шахагдсан) | Мөрийн доор **өөрийн дүүргэлтийн зураас** (`ProgressBar`) + «8/12 хийсэн» / «Бүгд хийсэн» |
| Бар нь өнгөгүй | **Ногоон** = бүгд хийсэн · **улаан** = хугацаа өнгөрсөн мөртлөө дуусаагүй · бусад нь primary |
| Задарсан жагсаалт дээр нэр бүрийн ард саарал «Хийгээгүй» бөмбөлөг (бүлгийн гарчиг аль хэдийн хэлсэн зүйлийг давтаж) | Бөмбөлөг **хасагдсан**. Баруун талд зөвхөн шинэ мэдээлэл: **оноо** (ногоон) эсвэл **⏱ хоцорсон** (шар). Хүлээгдэж буй сурагчид юу ч үгүй |
| Бүлгийн гарчиг «Хийгээгүй (3)» | **`overline` + тоо**: «ХҮЛЭЭГДЭЖ БАЙНА · 3» (шар) · «ХИЙСЭН · 8» (ногоон), мөр бүр **аватартай** |
| Доор нь «12 сурагчаас 8 нь хийсэн» гэсэн давхардсан мөр | Устсан — дээрх мөрийн бар яг үүнийг хэлж байна. Задарсан жагсаалт нь зөвхөн **нэрсийг** задлана |

- **`StatusBadge` хэвээр** — сурагчийн ахицын дэлгэцэд (`class/[id]/student/[studentId].tsx`)
  тэнд «Хийгээгүй» нь нэг сурагчийн бодит төлөв тул утгатай.
- **i18n:** `submissionsPending` утга «Хийгээгүй» → **«Хүлээгдэж байна»** (en: `Waiting`);
  `submissionsSummary` **устсан**; `submissionsDoneCount` («{done}/{total} хийсэн») ·
  `submissionsAllDone` («Бүгд хийсэн») нэмэгдсэн.
- ⚠️ **Дундын файлууд өөрчлөгдсөн:** `src/components/AssignmentRow.tsx` (сурагчийн
  тал `progress` дамжуулдаггүй тул хөндөгдөөгүй), `src/components/SubmissionList.tsx`,
  `src/api/lessons.ts`, `src/api/quizzes.ts` (зөвхөн `page` нэмэгдсэн, буцах хэлбэр хэвээр).

**Backend өөрчлөлт ШААРДЛАГАГҮЙ.** Шалгагдсан: `tsc` + eslint цэвэр, 400/200
хариу prod дээр curl-ээр батлагдсан. ⚠️ Утсан дээр гараар шалгаагүй.

---

#### ✅ Choi — Даалгавар = зөвхөн багшийн сангаас (2026-08-20) · ДАВХАРДУУЛАХГҮЙ

**Choi:** «сурагч шууд сонгоод өөрөө хийж болохгүй, заавал багшаас даалгавар
авч байж л тэр хэсгийг харна; багш даалгавар өгөхдөө зөвхөн тэр нууц хэсгээс өгнө».

Сангийн **дэд бүтэц аль хэдийн байсан** (`Quiz.assignOnly`, `canSeeAssignmentBank`,
`subsetQuiz` — PR #254), гэхдээ багшийн оноох дэлгэц нь **сан + сурагчид
нээлттэй дасгал хоёуланг** нийлүүлж үзүүлдэг байсан тул гэрээ нь бүтэн биш байв.

- **Одоо `assign.tsx` нь зөвхөн `?assignOnly=true`-г татна.** Нээлттэй дасгал
  оноох зам хаагдсан — эс бөгөөс сурагч Дасгал табаасаа тэр дасгалыг даалгавар
  хүлээлгүй хийчихнэ (яг таслах гэсэн зүйл нь тэр).
- `getAssignmentBank(token, { page, limit })` хуудаслалт авдаг боллоо;
  `getQuizzes` дуудлага энэ дэлгэцээс **хасагдсан** (нэг хүсэлт цөөрсөн).
- **`QuestionPicker`-ийн «🔒 Даалгаврын сан» шошго хасагдсан** — мөр болгон
  дээр давтагдах болсон тул мэдээлэл өгөхөө больсон. Оронд нь `assignPickHint`
  дээд талд нэг удаа: «Эдгээр нь зөвхөн багшид харагдах даалгаврын сан —
  сурагч өөрөө олж хийж чадахгүй…».
- `assignBankPill` i18n түлхүүр устсан.

**Хаана байдгийг тэмдэглэв (админ дээр олдохгүй байсан шалтгаан):** сан нь
**Дасгал (`/exercises`) хуудсан** дээр байдаг, **Сорил (`/quizzes`) хуудсанд
БАЙХГҮЙ**. Тэнд: `Бүгд · Сурагчид нээлттэй · Даалгаврын сан` гэсэн хамрах
хүрээний таб → «Даалгаврын сан» таб дээр байхад «Дасгал нэмэх» дарвал
`assignOnly` **урьдчилан тэмдэглэгдсэн** ирнэ. Байгаа мөрүүдийг сонгоод
«Даалгаврын сан руу» / «Сурагчид нээх» товчоор шилжүүлнэ.

**Гинжин хэлхээ (эцсийн байдал):**
1. Админ → Дасгал → Даалгаврын сан → 15 асуулттай тест үүсгэнэ (`assignOnly=true`).
2. Багш → анги → Даалгавар оноох → Сорил → сэдвээ сонгоод **5 асуулт** тэмдэглэнэ
   (`targets[].questionIndexes`). Сэдэв бүр өөрийн даалгаврын мөр, мэдэгдэл нэг очно.
3. Сурагч → зөвхөн `GET /quizzes/:id?assignmentId=` замаар нээнэ; сервер
   `subsetQuiz`-ээр яг тэр 5 асуултыг л өгнө. Даалгавраас гадуур нээвэл
   **403 «Энэ дасгалыг багш даалгавар болгож өгсний дараа үзнэ»**; жагсаалтад ч
   SQL түвшинд (`q.assignOnly = false`) огт орохгүй.

**Backend өөрчлөлт ШААРДЛАГАГҮЙ** (дүрэм нь аль хэдийн серверт бий).
Шалгагдсан: `tsc` + eslint цэвэр. ⚠️ Утсан дээр гараар шалгаагүй.

**Админ: сан нь өөрийн ангилал боллоо (2026-08-20, ижил багц).**
⚠️ **`/admin` бол Өсөхбаярын хэсэг** — энэ өөрчлөлт жижиг PR болж, түүнд
мэдэгдэнэ. Шалтгаан: сан нь **ангилал бүрийн дотор нуугдсан** «хамрах хүрээ»
шүүлтүүр байсан тул (эхлээд Сонсгол/Дүрэм гэдгийг нь мэдэж байж, дараа нь
«Даалгаврын сан» гэсэн жижиг таб дарж байж олдоно) хэн ч олдоггүй байв.

- **Дасгал хуудсанд 7 дахь таб: «Даалгавар»** (`BANK_CAT = 'assignment'`) —
  Сонсгол · Унших · Бичих · Дуудлага · Нөхөх · Дүрэм-тэй нэг эгнээнд.
- **Хоёр жагсаалт огтлолцохгүй** (шүүлт нь одоо серверт):
  сангийн таб = `?assignOnly=true` (бүх ангиллаас), ур чадварын таб =
  `?assignOnly=false`. Өөрөөр хэлбэл **сангийн дасгал сурагчийн контентын
  жагсаалтад дахин хэзээ ч харагдахгүй**.
- Тэр табад **үүсгэсэн/импортолсон/AI-аар гаргасан** бүхэн `assignOnly: true`
  бичнэ (AI нь `target.save`-аар). Формын «Зөвхөн даалгавраар» checkbox
  **хасагдсан** — таб нь өөрөө шийднэ (`BankCheckbox` устсан).
- Мөрийн «Даалгаврын сан» шошго хасагдсан (таб бүхэлдээ сангийнх). Оронд нь
  **хуучин сангийн мөр** ямар ур чадвараас ирснийг саарал шошгоор харуулна.
- Сэдвийн санал болголт: `EXERCISE_CATEGORIES.assignment` (Present Simple,
  Modal verbs, Conditionals…) — багшийн оноох дэлгэц сэдвээр бүлэглэдэг.
- Сонгоод **«Даалгаврын сан руу» / «Сурагчид нээх»** товч хэвээр — мөр табаа
  сольж, шууд нөгөө жагсаалт руу шилжинэ.
- ⚠️ **`category` нь аюулгүй байдлын хил БИШ.** Хил нь `Quiz.assignOnly`
  (сервер сурагчийн жагсаалтаас SQL түвшинд хасдаг). `assignment` ангилалд
  **аппын уншигч дэлгэц хэзээ ч нэмэхгүй** — энэ бол зориудаар «хүрэх
  дэлгэцгүй» ангилал (CLAUDE.md-ийн «шинэ category нэмвэл аппын талыг нь
  нэм» дүрмийн ганц үл хамаарах тохиолдол).
- **Хуучин сангийн мөрүүд backfill ХИЙГЭЭГҮЙ** — тэдгээр `assignOnly=true`
  хэвээр тул шинэ табад бүгд гарна, зөвхөн `category` нь хуучнаараа
  (саарал шошгоор ялгагдана). Тэр мөрийг нээж хадгалбал `assignment` болно.
- Шалгагдсан: `npx tsc --noEmit` + eslint цэвэр, `npm run build` амжилттай.

---

#### ✅ Choi — Нэг даалгавар = олон багц (2026-08-20) · ДАВХАРДУУЛАХГҮЙ

**Choi:** «багш нэг даалгавар өгөхдөө 5 багц өгнө, тэд дотроо 15 дасгалтай.
Өөр сэдэвтэй хольж болно, гэхдээ **нэг л даалгавар** болж явна, дотроо салдаг».

**Асуудал:** `POST /assignments` нь `targets` доторх **сэдэв бүрд тусдаа
`assignments` мөр** үүсгэдэг. Тиймээс багш 2 сэдвээс асуулт сонгож нэг удаа
илгээхэд сурагч дээр **2 тусдаа карт**, «3 хоног үлдлээ» 2 удаа гарч байв.

**Шийдэл (аппын талд бүлэглэх — backend хөндөөгүй):** шинэ
`src/lib/assignmentGroups.ts` нь нэг илгээлтээс үүссэн мөрүүдийг нэг бүлэг
болгоно. Түлхүүр = `classId | type | assignedById | createdAt | dueAt`.
- ⚠️ **Яагаад `createdAt` найдвартай вэ:** нэг `POST` бүх мөрөө **нэг
  гүйлгээнд** хадгалдаг ба Postgres-ийн `now()` нь гүйлгээний эхлэлээр тогтдог
  тул мөрүүд миллисекунд хүртэл ижил `created_at`-тай ирнэ. Локал сервер дээр
  бодит хүсэлтээр шалгаж баталсан (2 мөр → 1 бүлэг).
- ⚠️ **Энэ бол түр шийдэл.** Зөв нь `assignments.batch_id` багана —
  Өсөхбаяраас хүсэх ажил. Тэр гармагц `keyOf`-ийг `a.batchId ?? <одоогийн>`
  болгож **нэг мөрөөр** солино, бусад код хөндөгдөхгүй.

| Хаана | Өмнө | Одоо |
| --- | --- | --- |
| Сурагчийн жагсаалт | 5 карт, «3 хоног» 5 удаа | **1 карт**: сэдвүүд · «5 багц · 75 асуулт» · хугацаа нэг удаа · «2/5 багц хийсэн» бар. Дарвал доор нь багцууд задарна, багц бүр өөрийн «Эхлэх →»-тэй |
| Шүүлтүүрийн тоо (Бүгд/Хийх ёстой/Хийсэн) | мөрөөр | **бүлгээр** — бүх багц хийгдэж байж «Хийсэн» болно |
| Home badge | «5 даалгавар хүлээгдэж байна» | **«1 даалгавар»** (`useAssignmentBadge` бүлэглэдэг болов) |
| Багшийн ангийн дэлгэц | 5 мөр | **1 мөр** + «5 багц», бар нь `{гардуулсан}/{багц × сурагч}`. Дарвал багцууд, багц бүрийг дарвал тэрний нэрсийн жагсаалт |
| Устгах | нэг багц | **бүх багц** (баталгаажуулах цонх «{n} багц бүгд устана» гэж хэлнэ) |

- **Багцын дараалал чөлөөтэй** (эзний шийдвэр): түгжээ байхгүй, дурын
  дарааллаар хийнэ; картад «Багцуудаа дурын дарааллаар хийж болно» гэсэн мөр.
- Ганц багцтай даалгавар нь **яг хуучнаараа** харагдана (bundle биш).
- `AssignmentRow`-д 2 шинэ prop: `partCount` (мета мөрөнд «5 багц») ба
  `progressLabel` (нэгжийг дарж бичих — багш «12/25 багц гардуулсан», сурагч
  «2/5 багц хийсэн»).
- **i18n:** `assignmentPartCount` · `assignmentPacksDone` ·
  `assignmentPacksAllDone` · `assignmentPacksHint` · `assignmentOpenPacks` ·
  `submissionsPacksDone` · `deleteAssignmentParts`.
- ⚠️ **5 багц = сангийн 5 өөр дасгал.** Нэг дасгалыг нэг даалгаварт хоёр багц
  болгож өгөх боломжгүй (`QuestionPicker` нь дасгалын id-гаар түлхүүрлэдэг) —
  админ дээр «Present Simple 1…5» гэсэн 5 дасгал үүсгэнэ, тус бүр нь 15
  асуулттай.

**Backend өөрчлөлт ШААРДЛАГАГҮЙ.** Шалгагдсан: `tsc` + eslint цэвэр; локал
сервер дээр бодит урсгалаар (багш нэг удаа оноов → 2 мөр → сурагч дээр **1
бүлэг**, нийт асуулт нийлсэн, хугацаа нэг). ⚠️ Утсан дээр гараар шалгаагүй.

---

#### ✅ Choi — Админ: нэг файлаас олон багц импортлох (2026-08-20) · ДАВХАРДУУЛАХГҮЙ

**Choi:** «жишээг засаж өг, би файлаар оруулдаг болно — Excel/Word файл бэлдээд
5 дотор 15,15 дасгалтайгаар оруулна».

Импортын цонх өмнө нь **нэг л дасгал** үүсгэдэг, зөвхөн `|`-аар тусгаарласан
текст буулгаж авдаг байв. Одоо:

| Өмнө | Одоо |
| --- | --- |
| Зөвхөн текст буулгах | **«Файл сонгох»** — `.csv` · `.tsv` · `.txt` · `.json`. Агуулга нь талбарт орох тул импортлохын өмнө засаж болно |
| Зөвхөн `|` тусгаарлагч | **Таслал (Excel-ийн CSV) · таб (Excel-ээс шууд хуулж буулгасан) · `|`** — мөр бүрээс өөрөө таана. Хашилттай талбар (`"…, …"`) зөв уншигдана |
| Нэг файл = нэг дасгал | **Эхний багана = багцын нэр** → нэг файлаас олон дасгал. 75 мөр → 5 багц × 15 асуулт. Гарчиг нь «<Гарчиг> · <багц>» болно |
| Формат нь `|`-тэй нэг мөр жишээ | Багана нэртэй бүтэн жишээ + **«Загвар татах»** (Excel-д нээгдэх UTF-8 CSV, BOM-той тул кирилл эвдрэхгүй) |
| «Импортлох» дарж байж юу болохыг мэднэ | **Урьдчилан харах:** «5 багц · нийт 75 асуулт үүснэ» + багц бүрийн нэр/тоо |
| `.xlsx`/`.docx` сонговол чимээгүй амжилтгүй | Юу дарахыг нь хэлнэ: Excel → «Save As → CSV UTF-8», Word → «Save As → Plain Text» |

- Задлагч нь тусдаа модуль: **`admin/src/lib/importRows.ts`** (`parsePacks` ·
  `templateCsv`). Хуудсан доторх `parseQuestions` устсан.
- **Жишээ файл:** `docs/templates/daalgavriin-san-present-simple.csv` —
  5 багц × 15 асуулт (Positive · Negative · Questions · -s spelling ·
  Frequency), бүгд 4 сонголттой. Локал сервер рүү бодитоор импортлож,
  5/5 нь багшийн санд харагдахыг шалгаад буцаан устгасан.
- ⚠️ **Excel/Word-ийн эх файл (.xlsx/.docx) шууд уншигдахгүй** — тэдгээр нь ZIP
  архив тул номын сан (SheetJS/mammoth) шаардана. Хэрэв хэрэгтэй бол
  `admin`-д **шинэ dependency** нэмнэ (Өсөхбаярын хэсэг) — одоогоор «Save As
  CSV/TXT» гэсэн нэг алхмаар шийдэгдэж байгаа тул нэмээгүй.
- ⚠️ `/admin` бол Өсөхбаярын хэсэг — өмнөх сангийн өөрчлөлттэй **нэг PR**-д
  орно.

**Дараа нь (мөн 2026-08-20): Excel/Word шууд + импорт нэг дундын цонх боллоо.**
- ⚠️ **Сорил (`/quizzes`) хуудас өөрийн импортын цонхтой байсныг** олж
  илрүүлэв — Дасгал дээрх жишээг зассан ч тэнд хуучин `|`-тэй жишээ хэвээр
  байв («жишээ өөрчлөгдөөгүй байна» гэдэг нь энэ). Одоо хоёр хуудас **нэг л**
  `components/ImportModal.tsx`-ыг ашиглана: формат, жишээ, урьдчилан харах,
  файл унших бүгд ганц газар. Хуудас нь зөвхөн өөрийн талбар (гарчиг · түвшин ·
  сэдэв · сонсох яриа) ба хадгалах дүрмээ өгнө. Сорил дээр ч «олон багц»
  боломжтой (анхдагчаар унтраалттай).
- **`.xlsx` ба `.docx` шууд уншигдана** — шинэ dependency:
  `read-excel-file` (51 KB) ба `mammoth` (496 KB). Хоёулаа `import()`-оор
  ачаалагддаг тул импортын цонх нээгээгүй хүн татахгүй (үндсэн bundle
  193 KB хэвээр). Уншсан үр дүнг **таб-аар тусгаарласан текст** болгож нэг л
  задлагч руу өгдөг тул CSV · Excel · Word · буулгасан текст дөрвүүлээ ижил
  замаар боловсрогдоно.
- ⚠️ **`read-excel-file` нь мөрүүд БИШ, хуудсуудын жагсаалт буцаадаг**
  (`[{ sheet, data }]`) — эхлээд мөр гэж үзэж бичсэнийг тест барьсан. Одоо бүх
  хуудсыг нийлүүлдэг (5 багцаа 5 хуудсанд бичсэн ч алдагдахгүй), тиймээс
  толгой мөрийг **аль ч байрлалд** таньж алгасдаг болов (`HEADER_WORDS`).
- ⚠️ **Хуучин `.doc`** (Word 97) уншигдахгүй — «Save As → .docx» гэж хэлнэ.
- ⚠️ `/admin`-д **шинэ dependency 2** нэмэгдсэн (Өсөхбаярт мэдэгдэх;
  `npm install` шаардана).

**Багшийн харагдац зассан (мөн 2026-08-20): нэгж нь БАГЦ биш СУРАГЧ.**
Задарсан даалгаврын доор багц бүрийг дарахад тэр багцын **бүх сурагчийн нэр**
гарч ирдэг байсан нь буруу байв — «энэ багцад эдгээр сурагч байна» гэж
уншигдаж, хэн юу хийснийг хэлдэггүй байлаа (нэг сурагч 5 багцын доор 5 удаа
давтагдана). Сурагч даалгаврыг **багц багцаар нь** гүйцэтгэдэг тул багшийн
асуулт бол «Болд хэдэн багц хийчихсэн бэ».
- `SubmissionList` одоо `assignmentIds: string[]` авч, багц бүрийн жагсаалтыг
  **сурагчаар нэгтгэнэ**: мөр бүр «3/5 багц» (шар, хүлээгдэж буй бүлэгт) эсвэл
  дууссан бол **дундаж оноо** (ногоон). Багц дарж задлах алга болсон — багцууд
  зөвхөн «юу өгсөн» гэсэн мэдээллийн жагсаалт.
- Картын бар: олон багцтайд «X/Y хийсэн» гэж бичих боломжгүй (хэн бүгдийг
  дуусгасныг мэдэхэд багц бүрийн нэрс хэрэгтэй, тэр нь зөвхөн задлахад
  татагдана) → нэгжгүй **«Гүйцэтгэл N%»**. Ганц багцтай даалгавар
  «8/12 хийсэн» хэвээр.
- Локал сервер дээр 2 сурагч · 2 багцаар шалгав: нэг сурагч 1-р багцыг
  илгээхэд жагсаалт «1/2 багц» ба «0/2 багц» гэж, карт нь «25% гүйцэтгэл»
  гэж гарав.

Шалгагдсан: `tsc` + eslint цэвэр, `npm run build` амжилттай; задлагчийг **9
хувилбараар** туршсан — Excel CSV (хашилттай таслал) · Excel-ээс буулгасан таб ·
`|` · багцгүй · загвар файл · жишээ файл 5×15 · **жинхэнэ `.xlsx`** (15 асуулт) ·
**жинхэнэ `.docx`** (15 асуулт) · олон хуудасны давтагдсан толгой · word_match-ийн
алдаа.

---

#### ✅ Choi — Даалгаврын хүрээ · хожуу элссэн сурагч · алдааны задаргаа (2026-08-21) · ДАВХАРДУУЛАХГҮЙ

**Choi:** «даалгавар өгсний дараа шинэ сурагч ирвэл нэмдэг болго, буруу сурагч
сонгосон бол засдаг болго. Сонгоогүй байхад ч даалгавар сурагчид харагдаж
байна — багш дээр “сурагч алга” гэж байхад. Мөн сурагчдын юун дээр алдсаныг
харж болдог болго».

⚠️ **Энэ бол `/backend` дээрх өөрчлөлт** (эзний зөвшөөрлөөр) — Өсөхбаярт
мэдэгдэж, тусдаа PR болгоно. **Шинэ migration 1**:
`AddQuizAttemptAnswers1787900000000` (`quiz_attempts.answers` jsonb).
Railway дээр `DB_MIGRATIONS_RUN=true` эсэхийг шалгаж байж deploy хий.

**1) Хүрээний алдаа (аюулгүй байдал + логик).** `findForStudent` нь зөвхөн
`classId`-гаар шүүдэг байсан тул «зөвхөн 3 сурагчид» гэж өгсөн даалгавар
**бүх ангид** харагддаг байв — сонгогдоогүй хүн түүнийг хийж ч чадна, харин
багшийн самбарт мөр нь байхгүй тул хаана ч бүртгэгдэхгүй. Одоо
`student_ids IS NULL OR student_ids @> [me]` гэж SQL түвшинд шүүнэ.

**2) «Багш дээр сурагч алга, сурагч дээр даалгавар байна».** Гүйцэтгэлийн мөр
нь даалгавар **үүсэх агшинд** л бэлдэгддэг тул дараа элссэн сурагч багшид
харагддаггүй байв. `submissionsFor` одоо **одоогийн бүрэлдэхүүнээс** гаргаж,
мөргүй сурагчийг «хийгээгүй» гэж үзнэ → бүх ангид өгсөн даалгаварт **дараа
элссэн сурагч автоматаар** орно.

**3) `PATCH /assignments/:id` (шинэ).** `{ studentIds: [] }` = бүх анги.
Нэмэгдсэн сурагчид мөр үүснэ; хасагдсаных нь **зөвхөн хийгээгүй бол** устана —
гүйцэтгэсэн дүнг хэзээ ч арчихгүй. Апп дээр даалгаврыг задлаад **«Сурагч
засах»** → чагттай жагсаалт (`EditAssignmentStudents`). Багц даалгаварт
**багц бүрд** PATCH явна.

**4) «Юун дээр алдав» (шинэ).** `quiz_attempts` нь зөвхөн тоо хадгалдаг байсан
тул «6/10»-аас цааш юу ч мэдэх боломжгүй байв. Одоо `answers` jsonb-д
`[{ i, a, ok }]` бичигдэнэ (`i` = **сурагчийн харсан** дарааллын индекс) ба
`GET /assignments/:id/students/:studentId/answers` нь асуулт · сурагчийн
хариулт · зөв хариултыг буцаана. Апп дээр нэрийг дарахад доор нь задарна
(`StudentAnswers`) — **алдсан асуулт эхэлж**, зөв хийснийг нь намуухнаар.
- ⚠️ Хуучин илгээлтэд `answers = NULL` (backfill боломжгүй — хариултууд нь
  хаана ч хадгалагдаагүй) → «дэлгэрэнгүй алга» гэж харагдана.
- ⚠️ Багш **зөв хариултыг харна** — дүн тавьдаг хүн тэр. Сурагчийн зам
  `stripAnswers`-аар хамгаалалттай хэвээр.

**Хавтасны дүрэм тогтов (2026-08-21).** Сангийн 5 багцыг цэгцлэх «folder»
асуултын хариу: **шинэ хүснэгт хэрэггүй — `Quiz.topic` нь аль хэдийн хавтас**
(аппын `QuestionPicker.groupOf` чипсээ түүгээр үүсгэдэг). Тогтоосон дүрэм:

| Талбар | Үүрэг | Жишээ |
| --- | --- | --- |
| `topic` | **Хавтас** — багцуудыг нэгтгэнэ | `Present Simple` |
| `title` | **Багц** — нэг дасгал | `Present Simple 1 · Positive` |

Импортын цонх аль хэдийн яг ийм хэлбэр гаргадаг («Сэдэв» нь нэг талбар, багц
бүр өөрийн гарчигтай) тул код биш, **бөглөх дүрэм**. Түүнийг ил болгосон:
- Админы сангийн жагсаалт **сэдвээрээ бөөгнөрч** эрэмбэлэгдэнэ (10 сэдэв × 5
  багц = 50 мөр хавтасгүй хана болохоос сэргийлнэ).
- Сангийн табын анхааруулга ба «Сэдэв — хавтасны нэр» шошго дүрмийг хэлнэ.
- ⚠️ **Аппын багцын мөр одоо `title` харуулна** (өмнө нь `topic` эхэлж байсан):
  хавтасны нэр нь бүх багц дээр ижил тул түүгээр нэрлэвэл 5 мөр бүгд «Present
  Simple» гэж уншигдана. Хавтасны нэр нь картын гарчиг дээр нэг л удаа гарна
  (`groupTitle`).
- **ХИЙГЭЭГҮЙ (зориуд):** сонгогчийн «Бүх багцыг сонгох» товч. Тест бүр дээр
  «Бүх асуултыг сонгох» аль хэдийн байдаг тул 5 багц оноох нь ~10 товшилт —
  9 товшилт хэмнэхийн тулд шинэ код бичихээс өмнө бодит хэрэглээг харна.
  Мөн `assignment_sets` хүснэгт: дараалал чухал болох, эсвэл сэдэв дамнасан
  бэлэн иж бүрдэл хэрэгтэй болох хүртэл ашиглагдахгүй хүснэгт болно.

**Алдааны задаргааны гарчиг (2026-08-21, тэр өдрийн засвар).** «1-р багц ·
47%» гэсэн дугаар нь багш ямар сэдэв дээр алдсаныг хэлдэггүй, мөн бүх асуулт
нэг урсгал болж хаана нэг багц дуусаад нөгөө нь эхэлснийг ялгах аргагүй байв.
Одоо **багцын жинхэнэ нэр** (`Positive`, `Negative`…) `bodyStrong`-оор,
хажууд нь оноогоор өнгө авсан чип (70+ ногоон · 40+ шар · доош улаан), багц
хооронд нимгэн зураас. `SubmissionList`/`StudentAnswers` нь одоо `assignmentIds`
биш **`packs: { id, label }[]`** авна (нэр нь ангийн дэлгэцээс дамжина);
`assignmentPackNo` түлхүүр устсан.

**Локал сервер дээр 7 шалгалт, бүгд ✅:** хүрээ (сурагч2 = 0 багц) · багшийн
жагсаалт бүрэлдэхүүнээс · «1/2 багц» явц · алдааны задаргаа (2-оос 1 буруу,
өгсөн/зөв хариулт зөв гарав) · сурагч нэмэх · «бүх анги» болгох
(`studentIds = null`) · хийсэн сурагчийг хасахад **дүн нь хэвээр**.
`tsc` (backend+mobile) + eslint цэвэр.

---

#### ✅ Choi — Word шалгалт импортлох + чанарын худал дуулга (2026-08-24) · ДАВХАРДУУЛАХГҮЙ

**Choi:** «Надад 5 тест байна (Word). Эдгээрийг яаж шууд багцаар админ руу
оруулах вэ? 5-уулаа нэг хавтас шиг зүйлд орж нэг багц болж багш сурагч руу
явуулах вэ?»

**1) Шалгалтын бичиг уншдаг боллоо.** Word дээр бичсэн тест нь «мөр бүр = нэг
асуулт» БИШ — нэг асуулт таван мөрөнд тархаж, зөв хариулт нь баримтын
төгсгөлийн `ANSWER KEY` хүснэгтэд байдаг. Хуучин задлагч 5 файлыг 7 хогийн
багц болгодог байв (эхний «асуулт» нь `Lesson: …` толгойн мөр, сонголт 0).
- `importRows.ts` → `looksLikeExam()` + `parseExam()`. Танилт нь **хоёр удаа
  «дугаарласан асуулт → шууд дараа нь A. сонголт»** гарвал — санамсаргүй
  таарахаас хамгаална. AI огт оролцохгүй, дүрэм тодорхой.
- `1.`/`1)` = асуулт · `A.`–`D.` (кирилл `А`–`Д` мөн) = сонголт ·
  `ANSWER KEY`-ээс хойш `дугаар → үсэг` = зөв хариулт ·
  `Level:`/`Lesson:`/`Test:`/`Choose …` = алгасах.
- Багцын нэр: баримтын `Test: N` мөр → байхгүй бол файлын нэр.
- ⚠️ Хариултын түлхүүргүй асуултыг **хаяна** (сануулга болгож `A` тавибал
  админ анзаарахгүй өнгөрөх эрсдэлтэй) — тоо нь урьдчилан харахад дутуу гарна.

**2) Олон файл нэг дор.** `<input multiple>`; файл бүрийн өмнө
`----- FILE: <нэр> -----` тэмдэглэгээ тавьж нийлүүлнэ, задлагч түүгээр багцуудыг
салгана. Цонхонд «📄 Шалгалтын бичиг танигдлаа» гэсэн мөр гарна.
- **Бодит үр дүн:** `Test 1…5.docx` → **5 багц · 75 асуулт**, бүгд 4 сонголттой,
  зөв хариулт нь `ANSWER KEY`-ээс зөв уншигдсан.

**3) ⚠️ Чанарын шалгуурын ХУДАЛ дуулга (backend).** Импорт амжилттай орсон ч
админ дээр **40+ «Зөв хариулт асуултын дотор шууд бичигдсэн байна»** гарч,
«шалгах шаардлагатай» гэж улаан болов. Бүгд худал:
```
In "Tara carries boxes.", which word is the subject?   → зөв: Tara
```
Задлан шинжлэх дасгалд зөв хариулт нь **заавал** асуултын доторх өгүүлбэрээс
гарна — тэр нь дасгалын мөн чанар, эвдрэл биш. Хоёр үл хамаарах дүрэм нэмэв
(`quality.ts`):
- **`isWordOrderQuestion`** — бүх сонголт **яг ижил үгсээс** бүтсэн бол (зөвхөн
  дараалал өөр) хариулт асуултад байх нь ач холбогдолгүй: сурагч эрэмбийг
  мэдэхээс өөр аргагүй. 3-аас цөөн сонголт ба нэг үгтэй сонголтыг алгасна.
- **`isStimulusQuestion`** — ишлэл (`"…"`, кирилл/буржгар хашилт мөн) ба хоёр
  цэгийн ард жагсаасан үг нь **шинжлэх материал**. Зөв хариулт зөвхөн тэндээс
  олдож, БУСАД сонголт ч мөн тэндээс гарсан бол → анхааруулахгүй.
- ⚠️ **Жинхэнэ эвдрэл хэвээр баригдана:** `Which word means "at seven"?` дээр
  зөвхөн зөв хариулт нь ишлэлд байж бусад нь (At six/At eight) байхгүй тул
  анхааруулга гарсаар байна (тест бий).
- ⚠️ **Анхаарах алдаа:** `stimulusOf` нь хэсгүүдээ НИЙЛҮҮЛЖ буцаадаг байсан тул
  доор нь асуултаас хасахад хэзээ ч таарахгүй (нэгдсэн мөр эх текстэд байхгүй)
  → бүх шалгуур чимээгүй унтарч байв. Одоо **массив** буцааж, хэсэг бүрийг
  тусад нь хасна. Тест барьсан.

**Хэмжигдсэн үр дүн:** бодит 5 багц (75 асуулт) дээр **40+ анхааруулга → 0**.
`quality.spec.ts` **45 тест** (4 шинэ). Бүтэн backend suite: 402 passed,
3 failed — гурвуулаа `main` дээр аль хэдийн байсан (Dictionary listSaves,
Lesson stars ×2), миний оруулсан шинэ уналт алга.

⚠️ **`npm install` шаардлагатай** (`/backend`): `main`-аас
`microsoft-cognitiveservices-speech-sdk` ирсэн байсан тул tsc унаж, backend
hot-reload зогсоод байв.

**4) Сэдэв/түвшин ӨӨРӨӨ бөглөгдөнө.** Шалгалтын бичгийн толгой мөр
(`Level: A1 | Lesson: Basic English sentence structure … | Test: 1`) нь
хэрэгтэй бүх зүйлээ агуулж байхад админ гараар хуулж бичдэг байв.
`examMeta()` нь `Lesson:` → **сэдэв (хавтасны нэр)**, `Level:` → **түвшин**
уншина; цонх нь юуг уншсанаа хэлж, `onMeta` callback-аар хуудсанд өгнө.
- ⚠️ **Гараар бичсэн утгыг ХЭЗЭЭ Ч дарж бичихгүй** — зөвхөн хоосон талбарыг
  нөхнө (түвшин нь `a1` анхдагч дээр л солигдоно).
- Бодит 5 файлаас: `topic = "Basic English sentence structure - Subject +
  Verb + Object"`, `level = a1` ✅. CSV зам дээр мета хоосон (регресс алга).

**5) Багшийн сонгогч — мөрөн дээр шууд чагт.** Багш ихэвчлэн бүтэн тестээ
өгдөг атал «мөрөө нээ → «Бүх асуултыг сонгох» дар» гэсэн хоёр алхам заавал
байв. Одоо мөрийн зүүн талд **гурван төлөвт чагт** (хоосон · хэсэгчилсэн `—`
· бүгд): нэг товшилтоор бүтэн тест сонгогдоно, задлах нь зөвхөн **хэсгийг нь**
өгөх үед хэрэгтэй.
- Задарсан доторх «Бүх асуултыг сонгох» мөр **хасагдсан** (толгойн чагт яг
  үүнийг хийдэг болсон); `assignAllQuestions` i18n түлхүүр устсан.
- `assignPickHint` шинэ дүрмийг тайлбарлана.

**6) Чагтын дизайн — дөрвөлжин → дугуй (`SelectMark`).** Ionicons-ийн
`square-outline`/`checkbox` хос нь хатуу ирмэгтэй, вэб маягийн харагдацтай
бөгөөд аппын бусад бүх зүйл (аватар, дүрсний хайрцаг, чип, товч) дугуйрсан
байхад ганцаараа тусдаг байв.
- Шинэ дундын компонент **`src/components/SelectMark.tsx`** — гурван төлөв нь
  **өнгө биш ХЭЛБЭРЭЭР** ялгагдана (өнгө ялгахгүй хүнд ч уншигдана):
  хоосон = хоосон дугуй · хэсэгчилсэн = зураас · бүгд = чагт. Товшилт бүрд
  нэг удаагийн scale spring (Reduce Motion үед шууд).
- Хэрэглэсэн газар: `QuestionPicker` (толгой + асуулт), `EditAssignmentStudents`,
  оноох дэлгэцийн сурагчийн жагсаалт, мөн **`Checkbox`** — тэр өөрийн
  дөрвөлжин хайрцгийг зурдаг байсан тул шинэчлэлтээс хоцрох байлаа.
  **Дүрэм: шинэ чагт нэмэхдээ `SelectMark`-ыг ашиглана.**
- **«Сурагч засах» цонх:** «Бүх анги» нь хүрээтэй толгой мөр болж, баруун
  талдаа `3/12` тоо гаргана (хэдэн сурагч сонгогдсоныг задлан уншихгүйгээр);
  сонгогдсон мөр нь `primarySoft` дэвсгэртэй, нэр нь тод болно — хурдан
  гүйлгэхэд хэн сонгогдсоныг чагт ганцаараа хэлж чаддаггүй байв.

**7) Хайлт — олон үгээр.** `QuestionPicker` нь бүтэн мөрөөр `includes()`
хийдэг байсан тул «present positive» гэж бичихэд юу ч олдохгүй (тэр хос
гарчигт зэрэгцэж байхгүй). Одоо **үг бүрийг тусад нь** шалгана (бүгд таарвал
олдоно), гарчиг + сэдвийн аль алинаас. Дэд мөрийн хайлт хэвээр: «simple» гэж
бичихэд дундах үг ч олдоно.

---

#### ✅ Choi — Сурагчийн ахицын дэлгэц цэгцрэв (2026-08-24) · ДАВХАРДУУЛАХГҮЙ

**Choi:** «Багшийн хэсэгт ангируугаа орж сурагчаа сонгоод процессийг нь харах
гэхэд `?` тэмдэгтэй, “not done” гэх мэт замбараагүй харагдана. Дундаж ахиц нь
ажиллахгүй байх шиг байна — ажиллаж байгаа юу?»

**Оношилгоо — гурван тусдаа шалтгаан.**

**1) `?` тэмдэг = `help-circle-outline`** (сорилын дүрс), гэхдээ мөрөнд **гарчиг
огт байгаагүй** тул `[?] · [Хийгээгүй] · [—]` гэсэн танигдахгүй эгнээ болдог
байв. Ямар даалгавар болохыг мэдэх ямар ч арга алга.
- Backend `studentProgress` одоо **`targetTitle` · `targetTopic` · `createdAt`
  · `dueAt`** буцаана (Quiz/Lesson-оос багцаар татаж).
- Дүрс нь `document-text-outline` / `play-circle-outline` болж, дугуй
  дэвсгэртэй боллоо.

**2) 15 мөр — багцууд салангид.** Нэг даалгавар = 5 багц тул жагсаалт 15
эгнээ болж урсдаг байв. Одоо **бүлэглэнэ** (`createdAt|dueAt`): 15 мөр →
**3 даалгавар**. Бүх багц нэг сэдэвтэй бол гарчиг нь **тэр сэдэв** («Present
Simple») — эс бөгөөс «Test5 · Test 2 · Test5 · Test 5 +3» гэсэн давхардсан
урт мөр болно.
- Мөр бүр: гарчиг · «5 багц · 2/5 хийсэн» · баруун талд **ганц утга** —
  дуусгасан бол **дундаж дүн** (70+ ногоон · 40+ шар · доош улаан), эс бөгөөс
  явц (`2/5`) эсвэл `—`.
- `StatusBadge` энэ дэлгэцээс **хасагдсан** (мөр өөрөө төлөвөө хэлдэг болсон).

**3) ⚠️ Өөр ангийн даалгавар холилдож ирдэг байсан.** `submissionRepo.find`
нь `where: { studentId }` гэж БҮХ ангиас татдаг байв — багш «9а анги»-ийн
сурагчийг нээхэд өөр ангийн даалгавар ч жагсаалтад орно. Одоо
`assignment: { classId }` -аар шүүнэ.

**«Дундаж ахиц» ажиллаж байгаа** — зүгээр л **хоосон**: даалгаврын сангийн
дасгал нь `category = 'assignment'` тул `resolveSkill()` түүнийг ур чадварт
буулгадаггүй (`'other'`), мөн сурагч ур чадварын дасгал (Сонсгол/Унших/…)
хийгээгүй. Бүх зураас хоосон үед одоо **тайлбар** гарна: «Ур чадварын дасгал
хараахан хийгээгүй байна. Багшийн даалгавар энд тооцогддоггүй — доорх
жагсаалтаас хараарай». `—` гэдэг нь эвдрэл биш, «дата алга» гэдгийг хэлнэ.
- ⚠️ **Хойшлуулсан шийдвэр:** даалгаврын дасгалыг ур чадварт тооцох эсэх.
  Тооцох бол админд «ямар ур чадвар» гэсэн талбар хэрэгтэй — одоогийн сангийн
  дасгал дүрмийн шинжтэй тул аль ур чадварт хамаарахыг таах боломжгүй.

**Даалгавар дээр дарж алдааг нь харна.** Ахицын дэлгэцийн даалгаврын мөр одоо
задардаг: доор нь тухайн сурагчийн **алдсан асуултууд** гарна («Хариулсан:
went · Зөв нь: goes»). Ангийн дэлгэцтэй **яг ижил компонент**
(`StudentAnswers`) — хоёр газарт хоёр өөр харагдац үүсэхгүй. Юу ч хийгээгүй
даалгавар дарагдахгүй (задлах зүйл алга), тиймээс chevron ч гарахгүй.

⚠️ **Өнчирсөн даалгавар.** Админ дасгалыг устгавал даалгавар үлдэж, дүн нь
хадгалагдана (75% гэх мэт) ч гарчиг нь алга болно. Урьд нь «—» гэж гарч
ойлгомжгүй байсныг **«Устгагдсан дасгал»** гэж нэрлэв — дүнг арчихгүй,
шалтгааныг нь хэлнэ.

Шалгагдсан: `tsc` (backend + mobile) + eslint цэвэр; бодит датаар
**15 мөр → 3 даалгавар**, гарчиг · багцын тоо · дүн бүгд зөв гарав; задаргаа
нь бодит алдаануудыг зөв харуулав.

---

#### ✅ Choi — Word тест: жаахан өөр бичсэн файл импортлогдохгүй байсныг зассан (2026-08-26) · ДАВХАРДУУЛАХГҮЙ

**Choi:** «Файл үүсгүүлээд админруу оруулах гэхэд орохгүй байна. Яг өмнөх
файлаа өгч байж адилхныг нь олгож оруулсан. Энэ 2 юугаараа өөр вэ???»

**Хоёр файл агуулгаараа ЯГ ижил** (15 асуулт, түлхүүр нь `BCACBCDCBCDABCB`) —
зөвхөн **бичиглэл** нь өөр байв. Задлагч эхнийхийг таньж, хоёр дахийг
«Асуулт олдсонгүй» гэж хаядаг байсан:

| | Ажилласан файл | Ажиллаагүй файл |
| --- | --- | --- |
| Түлхүүрийн гарчиг | `ANSWER KEY` | `ANSWER KEY — TEST 1` |
| Хариултууд | Word **хүснэгт** (`1` / `B` тусдаа нүдэнд) | `1. B` гэсэн энгийн мөр |
| Толгой | `Level: A1 \| Lesson: … \| Test: 1` | `A1 — Lesson 2 … — TEST 1` + `Lesson content: …` |

**Гол шалтгаан:** `KEY_HEAD` нь мөрийг **бүтнээр нь** тэнцүүлдэг байсан
(`/^answer\s*key\s*:?$/`) тул ард нь `— TEST 1` байхад таарахгүй. Түлхүүрийн
хэсэг эхлээгүй тул `1. B` мөрүүд нь **асуулт** гэж уншигдаж, жинхэнэ 15
асуулт нь зөв хариулттайгаа холбогдож чадалгүй бүгд хаягдаж, үр дүнд нь
хоосон буцдаг байв.

**Зассан нь** (`admin/src/lib/importRows.ts`):
1. **Түлхүүрийн гарчиг уян хатан** — `ANSWER KEY`, `ANSWER KEY — TEST 1`,
   `Answers:`, `Хариултын түлхүүр — Тест 2` бүгд таарна. Гарчгийн ард нэмэлт
   үг зөвшөөрөгдөх ч тэр нь **цэг тэмдгээр** эхэлсэн байх ёстой — тиймээс
   «Answer keys are listed below» гэх өгүүлбэр гарчиг гэж андуурагдахгүй.
2. **Гарчиггүй ч таана** — `1. B` шиг агуулга нь ганц үсэг мөр бол тэр нь
   асуулт биш **хариулт**. `ANSWER KEY` гэсэн мөр огт байхгүй файл ч одоо
   импортлогдоно.
3. **Нэг файлд олон тест** — `Test N` толгой (эсвэл түлхүүрийн дараа дахин
   эхэлсэн асуулт) гарвал өмнөх багц хаагдана. Өмнө нь түлхүүрийн хэсэг
   эхэлсний дараах бүх мөр залгигдаж, 2 дахь тест бүхэлдээ алдагддаг байв.
   Багцын нэр нь цэггүй `TEST 1` хэлбэрийг ч уншина.
4. **Толгойн мета** — `Lesson content:` (мөн `Topic:` / `Сэдэв:` / `Хичээл:`)
   → сэдэв; `Level:` гэж нэрлээгүй бол **зөвхөн толгой хэсгээс** `A1`-ийг
   өөрөө олно (асуултын текст доторх санамсаргүй «B1» түвшин болж хувирахгүй).
5. **Алдаа нь юу болохоо хэлдэг боллоо** — асуулт олдсон мөртөө түлхүүр нь
   олдоогүй бол «Асуулт олдсонгүй» гэхийн оронд *«Асуултууд олдсон ч зөв
   хариулт нь олдсонгүй. Баримтын төгсгөлд «ANSWER KEY» гэсэн мөр, доор нь
   «1. B» хэлбэрийн хариултууд байх ёстой»* гэж хэлнэ. Мөн энэ мессеж
   **«Импортлох» дартал биш, файл сонгомогц** гарна (`ImportModal` нь
   задлалтын алдааг чимээгүй залгидаг байсныг зассан).

⚠️ **Дүрэм:** энэ задлагчид шинэ хэлбэр нэмэхдээ **хатуу тэнцүүлэхээс
зайлсхий**. Багш болгон тестээ өөрөөр бичдэг ба «жаахан өөр» файл
«Асуулт олдсонгүй» гэж унах нь админд ойлгомжгүй, өөрөө буруутай мэт
мэдрэгддэг. Тайлбар + жишээ `importRows.ts`-ийн `Q_LINE`-ийн дээрх
тайлбарт байгаа.

Шалгагдсан: `tsc -b` + eslint цэвэр; бодит 6 `.docx` (ToBe/Test 1–5 +
«Aldaatai» хувилбар) нэг дор импортлоход **6 багц × 15 асуулт**, өмнө нь
уначихдаг байсан файлын түлхүүр нь зассан хувилбартайгаа **яг ижил** гарав.

---

#### ✅ Choi — Даалгавар оноох: CEFR түвшнээр шүүх (2026-08-26) · ДАВХАРДУУЛАХГҮЙ

**Choi:** «Багш сурагчдадаа даалгавар өгөхдөө дасгалуудын CEFR-ийг хараад
хайж болдог болго — A1 гэхэд A1 түвшний тестүүд л гарч ирнэ гэх мэт. Үүнийг
харагдахуйц болго.»

**Байсан нь:** `QuestionPicker`-ийн чипс нь `topic || level` гэсэн **нэг**
бүлгээр явдаг байв. Сангийн дасгал бүр сэдэвтэй бол түвшин хаана ч
харагдахгүй — багш «Present Simple 1» гэдэг нь A1 юу B1 юү гэдгийг мэдэх
аргагүй байсан (админ талд түвшин нь аль хэдийн ангилагдсан, зөвхөн апп руу
дамжуулагдаагүй байсан).

**Одоо** (`mobile/src/components/QuestionPicker.tsx`):
- **«Түвшин» чипсийн мөр** — `Бүгд · A1 · A2 · B1 …`, зөвхөн **бодитоор
  байгаа** түвшнүүд. Ганц түвшинтэй байсан ч энэ мөр **үргэлж** харагдана:
  энэ нь шүүлт төдийгүй тайлбар — «яагаад зөвхөн A1 гарч байна вэ» гэдгийг
  багш нэг харцаар мэдэх ёстой. («Сэдэв» мөр хуучин дүрмээрээ — 2-оос цөөн
  бол нуугдана.)
- **Мөр бүр дээр өнгөт түвшний шошго** (`levelColor` — A1 ногоон · B1 цэнхэр
  …, хичээлийн дэлгэцтэй яг ижил өнгө), ард нь сэдвийн шошго (байвал).
- **Түвшин → сэдэв дараалалтай.** Сэдвийн чипс нь **сонгосон түвшинд байгаа**
  сэдвүүдээс л үүснэ, түвшин солиход сэдэв «Бүгд» рүү буцна. Эс бөгөөс багш
  «A1 + Passive voice» гэсэн хоосон хослол сонгоод хоосон жагсаалт руу
  хөтлөгдөнө.
- **«{n} олдлоо»** мөр нэмэгдэв — шүүлт үнэхээр ажилласан эсэхийг шууд хэлнэ.
- Хичээлийн таб дээрх түвшний чипс мөн **«Түвшин» гэж нэрлэгдэж**, үргэлж
  харагддаг боллоо — хоёр таб дээр ижил байрлалд, ижил нэртэй шүүлт.

**Backend өөрчлөлт ШААРДЛАГАГҮЙ** — `Quiz.level` аль хэдийн ирдэг байсан,
зүгээр л ашиглагдаагүй байв. Шинэ i18n түлхүүр: `topicLabel` (түвшин нь
байсан `levelLabel`-ийг ашиглана).

⚠️ **Админд түвшин буруу бол шүүлт ч буруу.** Дасгалын формын анхдагч нь
`a1` тул түвшнээ сольж өгөөгүй бүх сангийн дасгал A1 дор хуримтлагдана —
шүүлт нэмэгдсэн ч сан нь зөв ангилагдсан байх шаардлага хэвээр.

Шалгагдсан: `tsc --noEmit` + eslint цэвэр.

---

#### ✅ Choi — Даалгаврыг нэг дор олон ангид оноох (2026-09-04) · ДАВХАРДУУЛАХГҮЙ

**Choi:** «Ангийн бүх сурагчийг сонгож болдог шиг, багш өөр дээрээ байгаа
хэдэн ангиасаа сонгодог байх хэрэгтэй — 5 ангид ордог бол тавуулд нь нэг дор
явуулж чаддаг болго.»

**Байсан нь:** `assign.tsx` нь route-ийн `id`-г **ганц** ангийн id болгож
шууд ашигладаг байв (`classId: id!`). 5 ангид ижил даалгавар өгөх багш
дэлгэцээ 5 удаа нээж, контентоо 5 удаа сонгож, дуусах хугацаагаа 5 удаа
тавих ёстой байсан.

**Одоо** (`mobile/app/(teacher)/class/[id]/assign.tsx`) — «Хэнд оноох» хэсэг
нь **нэг эгнээнд 3 товчтой**, дарсан товчны самбар нь доор задарна:

```
Хэнд оноох
┌───────────┬────────────┬───────────────┐
│ Аль ангид │ Бүх сурагч │ Сурагч сонгох │
└───────────┴────────────┴───────────────┘
```

- **«Аль ангид»** — багшийн `GET /classes` → `teaching` жагсаалт, мөр бүр
  `SelectMark`-тай. Эхний мөр нь **«Бүх анги»** (гурван төлөвт чагт +
  `{сонгосон}/{нийт}`) = багшийн нээсэн бүх ангид нэг дор. Дээр нь сонгосон
  ангиудын нэр бичигдэнэ. Анхдагчаар дэлгэцийг нээсэн анги сонгогдсон тул
  **юу ч дарахгүй бол зан төлөв хуучинтай яг ижил**. Ганцхан анги заадаг
  багшид энэ товч **огт гарахгүй** (сонгох юу ч байхгүй).
- ⚠️ **«Аль ангид» нь хэнд өгөхийг ӨӨРЧЛӨХГҮЙ.** `panel` (аль самбар
  нээлттэй) ба `targetMode` (бүх сурагч уу, сонгосон хэд үү) хоёр нь
  **тусдаа** төлөв — анги солиод буцахад өмнөх сонголт хэвээр үлдэнэ.
  Хоёрыг нэг төлөв болгож «хялбарчилж» болохгүй.
- **Товчны нэр «Бүх анги» → «Бүх сурагч»** болов (`wholeClass` →
  `allStudents`): «анги» гэдэг үг одоо дээд түвшний сонголтод очсон тул
  хоёр газар давхардвал ойлгомжгүй болно.
- **«Сурагч сонгох» нь олон ангид ч ажиллана** — нэрс нь **ангиараа
  бүлэглэгдэж**, бүлгийн толгой дээр ангийн нэр + `{сонгосон}/{нийт}` тоо,
  толгойн чагтаар тэр ангийг бүхэлд нь сонгоно. Анги бүрд **зөвхөн өөрийнх
  нь сурагчдын id** явна (сервер `studentIds`-ыг ангийн бүрэлдэхүүнтэй
  тулгаж шалгадаг → өөр ангийн id орвол 400). Нэг ч сурагч сонгоогүй анги
  алгасагдана.
- Ангиа сонголтоос хаявал тэр ангийн сурагчид сонголтоос **автоматаар
  хасагдана** (харагдахгүй сурагч нуугдмал явахаас сэргийлнэ).
- «Аль ангид» самбар нээлттэй үед сурагчийн сонголт нүднээс далд байдаг тул
  «Оноох» товч унтарсан шалтгааныг доор нь бичнэ (`assignPickStudent`) —
  шалтгаангүй унтарсан товч бол хамгийн муу.

**Backend өөрчлөлт ШААРДЛАГАГҮЙ.** `POST /assignments` нэг хүсэлтэд нэг
`classId` авдаг тул апп **анги бүрд нэг дуудлага** хийнэ. Тэгэх нь зөв ч
байна: анги бүр өөрийн даалгаврын мөртэй, өөрийн гүйцэтгэлийн тоотой болж,
мэдэгдэл нь зөвхөн тухайн ангийн сурагчид руу очно.

⚠️ **Хэсэгчилсэн амжилт боломжтой.** 3 дахь анги дээр алдвал эхний 2 ангид
даалгавар аль хэдийн үүссэн байна — буцаах боломжгүй тул алдааны мессеж
хэдэн ангид үүссэнийг нь хэлдэг (`assignPartialFail`), багш үлдсэнийг нь
дахин илгээнэ. Бүгдийг нь давтаж илгээвэл эхний ангиуд **давхардана**.

Шинэ i18n түлхүүрүүд: `assignClasses` · `selectAllClasses` · `assignPickClass`
· `assignPickStudent` · `assignChosenCount` · `assignNoneChosen` ·
`assignPartialFail`. `wholeClass` → **`allStudents`** болж нэр солигдов
(утга нь өөрчлөгдсөн).

Шалгагдсан: `tsc --noEmit` + eslint цэвэр; Metro bundle (3403 модуль) алдаагүй
эвлэгдэж, iOS симулятор дээр апп ачаалагдсан.

⚠️ **Утасны Expo Go нь SDK 57 болсон** (App Store) тул төслийг (SDK 54) нээхээ
больсон — «Project is incompatible with this version of Expo Go». Түр зуурын
зам нь **iOS симулятор**: `npx expo start --go --ios` нь SDK 54-т тохирсон
...
#### ✅ Choi — AI Buddy дэлгэц: номын сангийн орчин + чимэглэл (2026-09-20) · ДАВХАРДУУЛАХГҮЙ

Дуут дэлгэц үнэг цул дэвсгэр дээр хоосон харагддаг байсныг зассан. **Бичлэгийн
болон ярианы логикт нэг ч мөр хүрээгүй** — `git diff`-ээр баталсан: тайзны
gesture, `begin`/`finish`/`lock`, `startRecording`/`stopRecording`/
`cancelRecording` бүгд эх хувилбартай ижил. Микрофон **дарж барих** хэвээр.

**Орчин**
- Шинэ `src/components/BuddyBackdrop.tsx` — **дэлгэцийн** давхарга, тайзных биш.
  Тайзны дотор байхад header дээр theme өнгийн зурвас үлддэг байв.
- Хоёр asset: `assets/buddy-room-light.webp` (өдрийн) · `buddy-room-dark.webp`
  (оройн). Босоо 941×1672, ~165KB тус бүр.
- Scrim нь **градиент**: дээд тал (header) ба доод тал (товчнууд) гүнзгий, дунд
  (үнэгний нүүр) тунгалаг. Цул scrim нь товчнуудад хангалттай байхад өрөөг
  шаварчилж байв.
- **Доод blur зурвас** — үнэг бол цээж хүртэлх дүрс, түүний шулуун зүсэлт
  задгай шалан дээр буудаг. `BlurView` + 5 зогсолттой градиент. ⚠️ Зурвас нь
  тайзнаас **доош үргэлжилнэ** (`bottom: -FADE_TAIL`); тайзаар хязгаарлавал
  өөрөө хоёр дахь хурц шугам үүсгэдэг. Хэмжээ нь пиксел биш **хувиар**.

**Chrome**
- ⚠️ `TopBar`-т **`onArt`** (бичвэр `textOnDark` + сүүдэр, буцах товч тунгалаг)
  ба **`right`** slot нэмэгдэв — дундын компонент, анхдагч утга нь хуучин зан
  төлөв тул бусад дэлгэц хөндөгдөөгүй.
- Шинэ `CaptionToggle` — CC толгой мөрөнд. «3.0 мин» чип зөвхөн **80/95%
  анхааруулга** дээр гарна (guardrail-ийг чимээгүй алдахгүйн тулд үлдээв).
- Шинэ `src/theme/onArt.ts` — `GLASS`/`GLASS_EDGE`/`ON_ART_SHADOW`.
  ⚠️ Эдгээр нь theme-ийн `glassBg` **БИШ**: тэдгээр нь доороо expo-blur давхарга
  шаарддаг, энэ дэлгэц дээр GL canvas дээгүүр blur хийх нь frame бүрд
  re-composite болно.

**Статус мөр ба header үсрэх — хоёр тусдаа алдаа, хоёулаа зассан**
- Шинэ `src/lib/statusBarOnArt.ts` — зураг дээр суусан дэлгэц бүртгүүлэхэд цаг/
  батерей цагаан болно. Дэлгэц өөрөө `StatusBar` зурдаггүй (`setStatusBarStyle`
  нь дараагийн дэлгэц рүү **алддаг**); гарахад автоматаар буцна.
- ⚠️ `useStatusBarStyle()`-ийг `ThemedNav` дуудахад тэр захиалга нь **бүх
  навигаторыг** дахин зуруулж, header үсэрдэг байв → `<AppStatusBar />` болгон
  тусгаарлав.
- ⚠️ Дуут дэлгэцэд `SafeAreaView` → **`useSafeAreaInsets()` + View**.
  `SafeAreaView` нь үндэс байхдаа л үнэгүй; үүрлэсэн үед байрлалаа хэмжиж байж
  padding тавьдаг тул эхний frame-үүдэд дээд зай **0** байв — буцах товч
  статус мөрний доор гараад дараа нь буудаг байсан шалтгаан.

**Бусад**
- Мэдэгдлийн бөмбөлөг **шилэн**, `position: absolute` доороосоо тогтож **дээш**
  ургадаг → **тайлбар бүтнээр** харагдана. Хоёр мөрийн хязгаарлалт зөвхөн
  buddy-гийн хэмжээг өөрчлөхгүйн тулд байсан бөгөөд одоо тэр эрсдэл алга.
- **Buddy хөдлөхөө болив** (найгалт, амьсгал, бодох үеийн хазайлт бүгд).
  Номын сангийн өмнө хөвж байгаа мэт харагддаг байв.
- Микрофонд туяа + рим — **дарах талбай хэвээр** (чимэглэл gesture-ийн гадна).
- `src/lib/mic.ts` — **зөвшөөрлийн race зассан**. `warmMicPermission()` дэлгэц
  нээгдмэгц асууна, хэрэглэгч дарвал `ensureMicPermission()` **хоёр дахь**
  хүсэлтийг зэрэг илгээнэ; iOS түүнийг татгалздаг → throw → *«Бичлэг эхлүүлж
  чадсангүй»*. Одоо явж буй хүсэлтийг хуваалцана. Шинэ суулгалт бүрийн
  **анхны товшилт** дээр гардаг алдаа байв.
- `BuddyAvatar` гэрэлтүүлэг: exposure 1.15→1.3, ambient 0.35→0.5, hemisphere
  0.75→0.9, **газрын өнгө `#3A2A63` → `#6A4A33`** (дулаан мод). Хуучин утгууд
  «харанхуй тайз»-д тааруулсан байсан тул гэрэлтсэн өрөөн дээр үнэг бараан
  харагдаж байв. ⚠️ **Simulator дээр шалгах боломжгүй** (доор үз).
- ⚠️ `SHOW_3D_AVATAR` нь **iOS Simulator дээр автоматаар унтардаг**
  (`Platform.OS === 'ios' && !Device.isDevice`). expo-gl тэнд **юу ч зурдаггүй**
  мөртлөө `onReady(true)` хэлдэг тул `BuddyAvatar`-ийн «GLB ачаалж чадсангүй →
  2D» fallback хэзээ ч ажилладаггүй — хөгжүүлэгч хоосон өрөө хардаг байв.
  Android emulator нь GL зурдаг тул зөвхөн iOS simulator-т хамаарна.

⚠️ **ОРОЛДООД БУЦААСАН — дахин бүү оролд** (тус бүрийг нь prod-той ижил замаар
туршиж эвдсэн):
1. **Capture state machine** (`idle→starting→listening→stopping`) — бичлэг эвдэрсэн.
2. **Recorder-ийг урьдчилж нээх (prewarm)** — **дуу бүрмөсөн алга болсон**.
   Урсгалт хариулт хэсэг хэсгээр тоглодог ба хэсгүүдийн хооронд тоглуулагч
   «зогссон» гэж мэдээлдэг; тэр завсарт бэлдэх нь session-ийг бичлэгийн горимд
   оруулж, үлдсэн хариултыг чихэвчний нүх рүү чиглүүлдэг. Хоёр удаа
   хамгаалалт нэмээд ч найдвартай болгож чадсангүй.
3. **Tap-to-talk** — хоёр дахь товшилт огт ажиллаагүй. Gesture-ийн worklet нь
   callback-аа нэг л удаа барьж авдаг тул хоёр дахь товшилт хуучирсан хуулбарыг
   ажиллуулж, `begin()`-ийг дахин дуудна → `holdRef` аль хэдийн үнэн тул
   чимээгүй буцна. Ref-ээр засах оролдлого ч үр дүнгүй.
4. **1 минутын автомат илгээлт** — (3)-тай хамт буцаагдсан.

⚠️ **Дүрэм:** энэ дэлгэцийн бичлэгийн логикийг simulator дээрээс засаж
**болохгүй** — тэнд микрофон дээр дарах боломжгүй, `__DEV__` лог нь зөвхөн
Metro терминал руу явдаг (CDP-ээр баригдахгүй). Өөрчлөх шаардлагатай бол
**төхөөрөмж дээр** ажиллаж байж хий.

- Шинэ dependency **алга**. Migration/backend өөрчлөлт **алга** — API гэрээ
  бүрэн хэвээр. `tsc` цэвэр · `eslint` 0 error (үлдсэн 2 сануулга нь өөрчлөлтөөс
  өмнөх, `git stash`-аар баталсан).

#### ✅ Choi — Багцын нэр/бичвэр + ачаалах дэлгэц (2026-09-24) · ДАВХАРДУУЛАХГҮЙ

**Багц (`app/plan.tsx`, i18n)**
- Нэр: Стандарт → **Essential**, Premium → **Plus** (i18n утга л солигдсон;
  дотоод `'standard' | 'premium'` хэвээр). Апп дахь бүх «Premium» бичвэр
  (профайлын баннер, buddy дэлгүүр/unlock) → «Plus».
- **Профайл ↔ «Миний багц» нэгдсэн:** профайл өмнө backend-ийн `planName`
  («Үнэгүй») харуулж, багцын дэлгэц Essential гэдэг байв. Одоо хоёулаа
  `planTier()` + `PLAN_NAME_KEY` (`src/api/users.ts`) ашиглана: багцгүй =
  **Essential**, төлбөртэй = **Plus**; тэмдэг нь «Идэвхтэй». Backend хөндөөгүй.
- **Дуут ярианы минут харуулахгүй** — Plus дээр «2 дахин их AI дуут яриа».
  Толь бичиг (300/700 үг) ба санах ой (100/250MB) тоогоор хэвээр.
- Plus карт «Essential-ийн бүх боломж, нэмээд:» мөрөөр эхэлнэ; үнэ бүрийн хажууд
  өдрийн үнэ (~1,100₮ / ~1,900₮); картуудын хооронд «Ердөө +22,000₮-өөр 2 дахин
  их ярилцаарай».
- «Энэ сарын хэрэглээ» хэсэг (хэрэглэгчийн өөрийн хэрэглээ) минутаар хэвээр.

**Ачаалах дэлгэц** — `BrandLoader` + `assets/splash-logo.png`, `colors.splash`
