...
**Wave tab bar (2026-07-31 redesign).** Код: `src/components/CustomTabBar.tsx`
+ `src/components/tabbar/` (`WaveCard` = дүрс · `TabItem` = хавтгай таб ·
`BuddyTab` = төв CTA · `geometry.ts` = бүх тоо).
...
- Шил: доор нь `BlurView`, дээр нь SVG-г тунгалаг `surface`-ээр дүүргэнэ.
  **Ягаан-цэнхэр-нил градиент зөвхөн давалгааны 2px шугам дээр** — картын
  дэвсгэр дээр градиент тавихгүй.
- Сүүдэр: **саарал/бараан**, theme-ийн ягаан `elevation.*` БИШ (цагаан
  картан дор ягаан сүүдэр хатуу харагдана).
- Идэвхтэй таб: дүрс дүүрэн + ягаан, 4px дээш өргөгдөнө, доор нь зөөлөн ягаан
  туяа (pill хүрээ биш). Идэвхгүй: outline + саарал, хөдөлгөөнгүй.
