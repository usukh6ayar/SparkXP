...
const mn = {
  ...
  heartsLabel: 'Зүрх',
  heartsOutTitle: 'Зүрх дууслаа',
  heartsOutBody: 'Дараагийн зүрхээ хүлээ, эсвэл Sparks-аар дүүргээд үргэлжлүүл.',
  heartsNextIn: 'Дараагийн зүрх: {time}',
  heartsRefillCta: '{n} Sparks-аар дүүргэх',
  heartsNotEnough: 'Sparks хүрэлцэхгүй ({have}/{need})',
  heartsQuit: 'Дараа үргэлжлүүлэх',
...
const en: Record<TranslationKey, string> = {
  ...
  heartsOutBody: 'Wait for your next heart, or refill with Sparks to keep going.',
  heartsNextIn: 'Next heart in {time}',
  heartsRefillCta: 'Refill for {n} Sparks',
  heartsNotEnough: 'Not enough Sparks ({have}/{need})',
  heartsQuit: 'Continue later',
  correctPraise1: 'Nice!',
