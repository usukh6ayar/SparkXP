...
const mn = {
  ...
  assignBankPill: 'Даалгаврын сан',
  assignAllQuestions: 'Бүх асуултыг сонгох',
  assignPickedSummary: '{q} асуулт · {t} сэдэв',
  assignPickHint: 'Сэдвээ сонгоод асуултуудаа тэмдэглэ. Өөр сэдэв рүү шилжихэд сонголт хэвээр үлдэнэ.',
  ...
  assignmentArrived: 'Ирсэн:',
  submissionsPending: 'Хийгээгүй',
  submissionsDone: 'Хийсэн',
  submissionsSummary: '{total} сурагчаас {done} нь хийсэн',
  ...
  assignmentScore: 'Дүн',
  assignmentMaxScore: '100 оноотой',
  assignmentLessonNoScore: 'Үзэхэд хангалттай',
...
const en: Record<TranslationKey, string> = {
  ...
  assignBankPill: 'Assignment bank',
  assignAllQuestions: 'Select all questions',
  assignPickedSummary: '{q} questions · {t} topics',
  assignPickHint: 'Pick a topic and tick the questions. Your picks stay when you switch topics.',
  ...
  assignmentArrived: 'Arrived:',
  submissionsPending: 'Not done',
  submissionsDone: 'Done',
  submissionsSummary: '{done} of {total} students done',
  ...
  assignmentMaxScore: 'Out of 100',
  assignmentLessonNoScore: 'Just watch it through',
