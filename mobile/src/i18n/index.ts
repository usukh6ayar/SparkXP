...
const mn = {
  ...
  noDictionaryWordsHint: 'Толь бичгээс үг хайгаад ⭐ дээр дарж энд хадгална.',
  ...
  streakCelebrationExtended: 'Дараалал сунгагдлаа!',
...
const en: Record<TranslationKey, string> = {
  ...
  noDictionaryWordsHint: 'Search a word in the dictionary and tap ⭐ to keep it here.',
  ...
  streakCelebrationExtended: 'Streak extended!',
