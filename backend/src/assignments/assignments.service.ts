...
export class AssignmentsService {
  ...
  /** List a class's assignments. Any member of the class (or admin) may read. */
  async findForClass(classId: string, user: User): Promise<Assignment[]> {
    // Reuse the class access check (throws if the user isn't a member).
