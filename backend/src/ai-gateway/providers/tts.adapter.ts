...
export interface TtsAdapter {
  ...
  /**
   * Тухайн voice-оор ярих бэлтгэлийг УРЬДЧИЛАН хийх (сонголттой).
   *
   * Зарим провайдер turn эхлэхээс өмнө төлж болох тогтмол зардалтай — Azure-ийн
   * хувьд synthesizer бүрийн WebSocket handshake (хэмжсэн: эхний аудио хүртэл
   * 799 → 159мс). Session эхлэх агшинд түүнийг төлөх нь ҮНЭГҮЙ: хэрэглэгч
   * хараахан юу ч хэлээгүй байна.
   *
   * **Синтез хийхгүй** — зөвхөн холболт нээнэ, тиймээс төлбөр нэмэгдэхгүй.
   * Хийх зүйлгүй провайдер үүнийг тодорхойлохгүй; дуудагч нь сонголттой
   * гэдгийг нь хүндэтгэнэ. Хэзээ ч алдаа шиднэ гэж найдаж болохгүй —
   * бэлтгэл амжилтгүй болох нь turn-ийг зогсоох шалтгаан биш.
   */
