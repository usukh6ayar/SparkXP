...
export const aiProviders: Provider[] = [
  ...
  },
  {
    ...
    useFactory: (
      ...
      switch (provider) {
        case 'azure':
          // Azure нь ~1.2 сек хурдан (p50 286 vs 1451мс) ба нарийвчлал ижил,
          // ХАРИН **F0 үнийн багц** дээр 20 хүсэлт/60сек (хэмжсэн) —
          // ойролцоогоор 5–6 сурагч зэрэг ярихад л дүүрнэ. Тиймээс **S0 (төлбөрт)
          // болтол анхдагч БИШ**, мөн Gemini рүү унах хамгаалалттай: 429/5xx
          // дээр turn алдагдахгүй. Тасалгуур нь хязгаар дүүрсэн үед Azure руу
          // огт хандахаа больдог тул хязгаар нь turn-д НЭМЭЛТ хугацаа
          // нэмэхгүй (эс бөгөөс цэвэр Gemini-ээс удаан болно).
