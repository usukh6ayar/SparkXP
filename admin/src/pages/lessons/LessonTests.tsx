          ...
          <div className="mt-3">
            ...
            {!transcript && (
              <p className="mt-2 text-xs text-amber-600">
                {/* Хичээлд видео байхгүй үед «Видеоны бичвэр» самбар огт
                    харагдахгүй тул "дээрээс гарга" гэж зааж болохгүй. */}
                ⚠️ Видеоны бичвэр байхгүй тул AI зөвхөн гарчгаас үүсгэнэ.
                Хичээлд видео оруулаад «Видеоны бичвэр» гаргавал тест
                хичээлийн агуулгад тулгуурлана.
              </p>
            )}
          </div>
        </>
